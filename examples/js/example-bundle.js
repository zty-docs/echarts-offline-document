...
(() => {
  var e = {
      9569: (e, t, n) => {
        ...
        var r = {
          ...
          s = ["UniversalTransition", "LabelLayout"],
          l = { bmap: "bmap/bmap" },
          c = {},
          u = {},
          d = {},
          p = {},
          f = { SVGRenderer: "svg", CanvasRenderer: "canvas" },
          h = ["markLine", "markArea", "markPoint"],
          m = [].concat(h, ["grid", "axisPointer", "aria"]),
          g = ["xAxis", "yAxis", "angleAxis", "radiusAxis", "xAxis3D", "yAxis3D", "zAxis3D"];
        function C(e, t) {
          Object.keys(e).forEach(function (n) {
            g.includes(n) || (t[e[n]] = n);
          });
        }
        function y(e, t) {
          var n = [],
          ...
          e.forEach(function (e) {
            e.endsWith("Renderer")
              ? f.push(e)
              : u[e]
              ? (n.push(e), t && n.push(e.replace(/Chart$/, "SeriesOption")))
              : c[e]
              ? (r.push(e), t && r.push(e.replace(/Component$/, "ComponentOption")))
          ...
          var m = [].concat(r, n, a, i, f, o),
            g = "\ntype EChartsOption = echarts.ComposeOption<\n    ".concat(
              m
                .filter(function (e) {
                  return e.endsWith("Option");
                })
                .join(" | "),
              "\n>"
            ),
            C = [
              [r, "echarts/components"],
              [n, "echarts/charts"],
              [o, "echarts/features"],
              [f, "echarts/renderers"],
              [i, "echarts-gl/charts"],
              [a, "echarts-gl/components"],
            ]
              .filter(function (e) {
                return e[0].length > 0;
              })
          ...
          return (
            w(h, t).forEach(function (e) {
              C.push("import '".concat(e, "';"));
            }),
        ...
        function v(e, t) {
          ...
          return (
            e.forEach(function (e) {
              e.endsWith("Renderer") && "CanvasRenderer" !== e
                ? n.push("zrender/lib/".concat(f[e], "/").concat(f[e]))
                : u[e]
                ? n.push("echarts/lib/chart/".concat(u[e]))
                : c[e]
                ? n.push("echarts/lib/component/".concat(c[e]))
                : d[e]
                ? n.push("echarts-gl/lib/chart/".concat(d[e]))
                : p[e]
                ? n.push("echarts-gl/lib/component/".concat(p[e]))
                : l[e] && n.push(w([e], !1)[0]);
            }),
            t
        ...
        function w(e, t) {
          return e
            ...
            .map(function (e) {
              return "echarts/extension".concat(t ? "-src" : "", "/").concat(l[e]);
            });
        }
        function _(e) {
          return "// "
            ...
            .concat(e ? "你申请的AK" : "YOUR_APP_KEY", "\n");
        }
        C(r, c),
          C(i, u),
          C(a, p),
          C(o, d),
          (e.exports.collectDeps = function e(t) {
            var n = [];
            if (t.options)
              return (
                ...
                t.baseOption && (n = n.concat(e(t.baseOption))),
                Array.from(new Set(n))
              );
            Object.keys(t).forEach(function (e) {
              if (!m.includes(e)) {
                var i = t[e];
                (Array.isArray(i) && !i.length) || (r[e] && n.push(r[e]), a[e] && n.push(a[e]), l[e] && n.push(e));
              }
            });
            var s = t.series;
            return (
              ...
              s.forEach(function (e) {
                i[e.type] && n.push(i[e.type]),
                  o[e.type] && n.push(o[e.type]),
                  "map" === e.type && n.push(r.geo),
                  "bmap" === e.coordinateSystem && n.push("bmap"),
                  h.forEach(function (t) {
                    e[t] && n.push(r[t]);
                  }),
                  e.labelLayout && n.push("LabelLayout"),
                  e.universalTransition && n.push("UniversalTransition");
              }),
              t.dataset &&
                Array.isArray(t.dataset) &&
                t.dataset.forEach(function (e) {
                  e.transform && n.push("TransformComponent");
                }),
              Array.from(new Set(n))
            );
          }),
          (e.exports.buildMinimalBundleCode = y),
          (e.buildLegacyMinimalBundleCode = v),
          (e.exports.buildExampleCode = function (e, t, n) {
            var r = n.minimal,
              i = n.esm,
              a = void 0 === i || i,
              o = n.legacy,
              ...
              f = n.isZHLang;
            s && (a = !0), r && !a && (o = !0);
            var h = e.indexOf("ecStat") >= 0,
              m = e.indexOf("graph") >= 0 && e.indexOf("modularity") >= 0,
              g = e.indexOf("ROOT_PATH") >= 0,
              C = e.indexOf("app") >= 0,
              L = [
                h ? (a ? "import ecStat from 'echarts-stat';" : "var ecStat = require('echarts-stat');") : "",
                m ? (a ? "import 'echarts-graph-modularity';" : "require('echarts-graph-modularity');") : "",
              ]
                .filter(Boolean)
                .join("\n"),
              x = [
                r
                  ? o
                    ...
                    : y(t, s)
                  : a
                  ? "import * as echarts from 'echarts';".concat(b(t) ? "\nimport 'echarts-gl';" : "").concat(
                      w(t, s).length
                        ? "\n".concat(
                            w(t, s)
                              .map(function (e) {
                  ...
                  : "var echarts = require('echarts');".concat(b(t) ? "\nrequire('echarts-gl');" : "").concat(
                      w(t, s).length
                        ? "\n".concat(
                            w(t, s)
                              .map(function (e) {
                ...
                l && "dark" !== l ? (a ? "import 'echarts/theme/".concat(l, "'") : "require('echarts/theme/".concat(l, "')")) : "",
                p,
              ]
                .filter(function (e) {
                  return !!e;
                ...
                .join("\n"),
              A = [
                g ? "var ROOT_PATH = '".concat(d, "';") : "",
                C ? "var app".concat(s ? ": any" : "", " = {};") : "",
                s && !r ? "type EChartsOption = echarts.EChartsOption" : "",
              ]
                .filter(function (e) {
                  return !!e;
                })
                .join("\n"),
              E = w(["bmap"], s)[0],
              S = [x.trim().replace(new RegExp("((?:import|require)\\s*\\(?'".concat(E, "'\\)?;)")), _(f) + "$1"), L.trim(), A.trim()]
                .filter(function (e) {
                  return !!e;
                })
                .join("\n\n"),
            ...
            return ""
              ...
              .concat(k ? ", '".concat(l, "'") : T ? ", null" : "")
              .concat(
                T
                  ? ", {\n".concat(
                      [N && "renderer: '".concat(c, "'"), O && "useDirtyRect: true"]
                        .filter(Boolean)
                        .map(function (e) {
                          return "  " + e;
                        })
      ...
      7817: (e, t, n) => {
        ...
        t.getParameters = function (e) {
          return (t = JSON.stringify(e)), r.compressToBase64(t).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/, "");
        };
      },
      4777: (e, t, n) => {
        "use strict";
      ...
      2416: (e) => {
        e.exports =
          '<!DOCTYPE html> <html lang="__LANG__"> <head> <meta charset="utf-8"/> <meta http-equiv="Content-Security-Policy" content="__CSP__"/> <style>*{margin:0;padding:0}body{font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Roboto,Oxygen,Ubuntu,Cantarell,\'Open Sans\',\'Helvetica Neue\',sans-serif}#chart-container{position:relative;height:100vh;overflow:hidden}.ec-debug-dirty-rect{background-color:rgba(255,0,0,.2)!important;border:1px solid red!important;box-sizing:border-box}.dg.main *{box-sizing:content-box}.dg.main input{line-height:normal}.dg.main.a{overflow-x:visible}.dg.main .c select{color:#000}</style> <style id="chart-styles"></style> </head> <body> <div id="chart-container"></div> <script>(()=>{const e=()=>{},t={clear:e,setItem:e,removeItem:e,getItem:e,key:e,length:0};Object.defineProperties(window,{localStorage:{value:t},sessionStorage:{value:t}}),Object.defineProperty(document,"cookie",{value:""})})()</script> __SCRIPTS__ </body> </html> ';
      },
      1873: (e, t, n) => {
        var r = n(9325).Symbol;
        e.exports = r;
      ...
      8221: (e, t, n) => {
        ...
        e.exports = function (e, t, n) {
          ...
          function w(e) {
            return (p = void 0), C && l ? y(e) : ((l = c = void 0), d);
          }
          function _() {
            var e = i(),
              n = v(e);
            if (((l = arguments), (c = this), (f = e), n)) {
              if (void 0 === p)
                return (function (e) {
                  return (h = e), (p = setTimeout(b, t)), m ? y(e) : d;
                })(f);
              if (g) return clearTimeout(p), (p = setTimeout(b, t)), y(f);
            }
            return void 0 === p && (p = setTimeout(b, t)), d;
          }
          return (
            (t = a(t) || 0),
            r(n) && ((m = !!n.leading), (u = (g = "maxWait" in n) ? o(a(n.maxWait) || 0, t) : u), (C = "trailing" in n ? !!n.trailing : C)),
            (_.cancel = function () {
          ...
          i = (function () {
            ...
            var a = {
              ...
              _compress: function (e, t, n) {
                  ...
                  if (
                    ...
                    if (Object.prototype.hasOwnProperty.call(s, u)) {
                      if (u.charCodeAt(0) < 256) {
                        for (r = 0; r < f; r++) (m <<= 1), g == t - 1 ? ((g = 0), h.push(n(m)), (m = 0)) : g++;
                        for (i = u.charCodeAt(0), r = 0; r < 8; r++)
                          (m = (m << 1) | (1 & i)), g == t - 1 ? ((g = 0), h.push(n(m)), (m = 0)) : g++, (i >>= 1);
                      } else {
                        for (i = 1, r = 0; r < f; r++) (m = (m << 1) | i), g == t - 1 ? ((g = 0), h.push(n(m)), (m = 0)) : g++, (i = 0);
                        for (i = u.charCodeAt(0), r = 0; r < 16; r++)
                          (m = (m << 1) | (1 & i)), g == t - 1 ? ((g = 0), h.push(n(m)), (m = 0)) : g++, (i >>= 1);
                      }
                      0 == --d && ((d = Math.pow(2, f)), f++), delete s[u];
                    } else
                      for (i = o[u], r = 0; r < f; r++)
                        (m = (m << 1) | (1 & i)), g == t - 1 ? ((g = 0), h.push(n(m)), (m = 0)) : g++, (i >>= 1);
                    0 == --d && ((d = Math.pow(2, f)), f++), (o[c] = p++), (u = String(l));
                  }
                if ("" !== u) {
                  if (Object.prototype.hasOwnProperty.call(s, u)) {
                    if (u.charCodeAt(0) < 256) {
                ...
                for (i = 2, r = 0; r < f; r++) (m = (m << 1) | (1 & i)), g == t - 1 ? ((g = 0), h.push(n(m)), (m = 0)) : g++, (i >>= 1);
                for (;;) {
                  if (((m <<= 1), g == t - 1)) {
                    h.push(n(m));
                    break;
              ...
              _decompress: function (t, n, r) {
                var i,
                  ...
                  m = "",
                  g = [],
                  C = { val: r(0), position: n, index: 1 };
                for (i = 0; i < 3; i += 1) d[i] = i;
                for (o = 0, l = Math.pow(2, 2), c = 1; c != l; )
                  (s = C.val & C.position),
                    (C.position >>= 1),
                    0 == C.position && ((C.position = n), (C.val = r(C.index++))),
                    (o |= (s > 0 ? 1 : 0) * c),
                    (c <<= 1);
                switch (o) {
                  case 0:
                ...
                for (d[3] = u, a = u, g.push(u); ; ) {
                  if (C.index > t) return "";
                  for (o = 0, l = Math.pow(2, h), c = 1; c != l; )
                    (s = C.val & C.position),
                      (C.position >>= 1),
                      0 == C.position && ((C.position = n), (C.val = r(C.index++))),
                      (o |= (s > 0 ? 1 : 0) * c),
                  ...
                  if ((0 == p && ((p = Math.pow(2, h)), h++), d[u])) m = d[u];
                  else {
                    if (u !== f) return null;
                    m = a + a.charAt(0);
                  }
                  g.push(m), (d[f++] = a + m.charAt(0)), (a = m), 0 == --p && ((p = Math.pow(2, h)), h++);
                }
              },
            };
            return a;
      ...
      8311: (e, t, n) => {
        class r {
          ...
          parseRange(e) {
            ...
            const r = this.options.loose,
              a = r ? c[u.HYPHENRANGELOOSE] : c[u.HYPHENRANGE];
            (e = e.replace(a, N(this.options.includePrerelease))),
              s("hyphen replace", e),
              (e = e.replace(c[u.COMPARATORTRIM], d)),
              s("comparator trim", e),
              (e = e.replace(c[u.TILDETRIM], p)),
              s("tilde trim", e),
            ...
            const C = new Map(),
              y = l.map((e) => new o(e, this.options));
            for (const e of y) {
              if (g(e)) return [e];
              C.set(e.value, e);
            }
        ...
        const i = new (n(8794))(),
          ...
          s = n(7272),
          l = n(3908),
          { safeRe: c, t: u, comparatorTrimReplace: d, tildeTrimReplace: p, caretTrimReplace: f } = n(9718),
          { FLAG_INCLUDE_PRERELEASE: h, FLAG_LOOSE: m } = n(6874),
          g = (e) => "<0.0.0-0" === e.value,
          C = (e) => "" === e.value,
          y = (e, t) => {
            let n = !0;
            ...
            return e.replace(n, (t, n, r, i, a) => {
              ...
              return (
                ...
                b(n)
                  ...
                  ? (o = `>=${n}.${r}.0 <${n}.${+r + 1}.0-0`)
                  : a
                  ? (s("replaceTilde pr", a), (o = `>=${n}.${r}.${i}-${a} <${n}.${+r + 1}.0-0`))
                  : (o = `>=${n}.${r}.${i} <${n}.${+r + 1}.0-0`),
                s("tilde return", o),
                o
              );
            ...
            return e.replace(n, (t, n, i, a, o) => {
              ...
              return (
                ...
                b(n)
                  ...
                  ? (l = `>=${n}.0.0${r} <${+n + 1}.0.0-0`)
                  : b(a)
                  ? (l = "0" === n ? `>=${n}.${i}.0${r} <${n}.${+i + 1}.0-0` : `>=${n}.${i}.0${r} <${+n + 1}.0.0-0`)
                  : o
                  ? (s("replaceCaret pr", o),
                    (l =
                      "0" === n
          ...
          E = (e, t) => {
            ...
            return e.replace(n, (n, r, i, a, o, l) => {
              s("xRange", e, n, r, i, a, o, l);
              const c = b(i),
                u = c || b(a),
                d = u || b(o),
                p = d;
              return (
                ...
                c
                  ...
                  ? (u && (a = 0),
                    (o = 0),
                    ">" === r
                      ? ((r = ">="), u ? ((i = +i + 1), (a = 0), (o = 0)) : ((a = +a + 1), (o = 0)))
                      : "<=" === r && ((r = "<"), u ? (i = +i + 1) : (a = +a + 1)),
                    "<" === r && (l = "-0"),
                    (n = `${r + i}.${a}.${o}${l}`))
                  : u
                  ? (n = `>=${i}.0.0${l} <${+i + 1}.0.0-0`)
                  : d && (n = `>=${i}.${a}.0${l} <${i}.${+a + 1}.0-0`),
                s("xRange return", n),
                n
              );
            });
          },
          S = (e, t) => (s("replaceStars", e, t), e.trim().replace(c[u.STAR], "")),
          k = (e, t) => (s("replaceGTE0", e, t), e.trim().replace(c[t.includePrerelease ? u.GTE0PRE : u.GTE0], "")),
          N = (e) => (t, n, r, i, a, o, s, l, c, u, d, p) =>
            `${(n = b(r)
              ? ""
              : b(i)
              ? `>=${r}.0.0${e ? "-0" : ""}`
      ...
      3908: (e, t, n) => {
        const r = n(7272),
          { MAX_LENGTH: i, MAX_SAFE_INTEGER: a } = n(6874),
          { safeRe: o, t: s } = n(9718),
          l = n(8587),
          { compareIdentifiers: c } = n(1123);
        class u {
          constructor(e, t) {
          ...
          compareMain(e) {
            return (
              e instanceof u || (e = new u(e, this.options)), c(this.major, e.major) || c(this.minor, e.minor) || c(this.patch, e.patch)
            );
          }
          comparePre(e) {
            ...
            switch (e) {
              ...
              case "pre": {
                ...
                if (t) {
                  let r = [t, e];
                  !1 === n && (r = [t]),
                    0 === c(this.prerelease[0], t) ? isNaN(this.prerelease[1]) && (this.prerelease = r) : (this.prerelease = r);
                }
                break;
              }
              default:
      ...
      6170: (e, t, n) => {
        ...
        e.exports = (e, t) => {
          ...
          let n = null;
          if ((t = t || {}).rtl) {
            const r = t.includePrerelease ? a[o.COERCERTLFULL] : a[o.COERCERTL];
            let i;
            for (; (i = r.exec(e)) && (!n || n.index + n[0].length !== e.length); )
              (n && i.index + i[0].length === n.index + n[0].length) || (n = i), (r.lastIndex = i.index + i[1].length + i[2].length);
            r.lastIndex = -1;
      ...
      9718: (e, t, n) => {
        const { MAX_SAFE_COMPONENT_LENGTH: r, MAX_SAFE_BUILD_LENGTH: i, MAX_LENGTH: a } = n(6874),
          o = n(7272),
          s = ((t = e.exports = {}).re = []),
          l = (t.safeRe = []),
          c = (t.src = []),
        ...
        const p = "[a-zA-Z0-9-]",
          ...
          h = (e, t, n) => {
            const r = ((e) => {
                for (const [t, n] of f) e = e.split(`${t}*`).join(`${t}{0,${n}}`).split(`${t}+`).join(`${t}{1,${n}}`);
                return e;
              })(t),
              i = d++;
            o(e, i, t), (u[e] = i), (c[i] = t), (s[i] = new RegExp(t, n ? "g" : void 0)), (l[i] = new RegExp(r, n ? "g" : void 0));
          };
        h("NUMERICIDENTIFIER", "0|[1-9]\\d*"),
          ...
          h("MAINVERSIONLOOSE", `(${c[u.NUMERICIDENTIFIERLOOSE]})\\.(${c[u.NUMERICIDENTIFIERLOOSE]})\\.(${c[u.NUMERICIDENTIFIERLOOSE]})`),
          ...
          h(
            "XRANGEPLAIN",
            `[v=\\s]*(${c[u.XRANGEIDENTIFIER]})(?:\\.(${c[u.XRANGEIDENTIFIER]})(?:\\.(${c[u.XRANGEIDENTIFIER]})(?:${c[u.PRERELEASE]})?${
              c[u.BUILD]
            }?)?)?`
          ),
          h(
            "XRANGEPLAINLOOSE",
            `[v=\\s]*(${c[u.XRANGEIDENTIFIERLOOSE]})(?:\\.(${c[u.XRANGEIDENTIFIERLOOSE]})(?:\\.(${c[u.XRANGEIDENTIFIERLOOSE]})(?:${
              c[u.PRERELEASELOOSE]
            })?${c[u.BUILD]}?)?)?`
          ),
          h("XRANGE", `^${c[u.GTLT]}\\s*${c[u.XRANGEPLAIN]}$`),
          h("XRANGELOOSE", `^${c[u.GTLT]}\\s*${c[u.XRANGEPLAINLOOSE]}$`),
          h("COERCEPLAIN", `(^|[^\\d])(\\d{1,${r}})(?:\\.(\\d{1,${r}}))?(?:\\.(\\d{1,${r}}))?`),
      ...
      9628: (e, t, n) => {
        ...
        e.exports = (e, t, n) => {
          ...
          return (
            e.forEach((e) => {
              s.test(e) && ((a && -1 !== o.compare(e)) || ((a = e), (o = new r(a, n))));
            }),
            a
          );
        };
            ...
            if (
              (r.forEach((e) => {
                e.semver === a && (e = new i(">=0.0.0")),
                  (o = o || e),
                  (s = s || e),
                  f(e.semver, o.semver, p) ? (o = e) : m(e.semver, s.semver, p) && (s = e);
              }),
              o.operator === g || o.operator === C)
            )
              return !1;
            if ((!s.operator || s.operator === g) && h(e, s.semver)) return !1;
            if (s.operator === C && m(e, s.semver)) return !1;
          }
          return !0;
        };
      },
      2525: (e, t, n) => {
        ...
        e.exports = (e, t, n) => {
          ...
          for (const e of l) r(e, t, n) ? ((s = e), o || (o = e)) : (s && a.push([o, s]), (s = null), (o = null));
          o && a.push([o, null]);
          const c = [];
          for (const [e, t] of a)
            e === t
      ...
      5032: (e, t, n) => {
        const r = n(8311),
          ...
          u = (e, t, n) => {
            ...
            if (i && u) {
              if (((f = s(i.semver, u.semver, n)), f > 0)) return null;
            ...
            for (const e of t) {
              if (((C = C || ">" === e.operator || ">=" === e.operator), (g = g || "<" === e.operator || "<=" === e.operator), i))
                if (
                  (v &&
                    e.semver.prerelease &&
          ...
          (e.exports = (function (e) {
            ...
            function (e, t) {
              ...
              e.exports = function (e, t, r, i) {
                ...
                if (e === t && r === i) return l;
                for (var a = n ? new Float32Array(11) : new Array(11), c = 0; c < 11; ++c) a[c] = o(0.1 * c, e, r);
                function u(t) {
                  for (var n = 0, i = 1; 10 !== i && a[i] <= t; ++i) n += 0.1;
                  --i;
                  var l = n + ((t - a[i]) / (a[i + 1] - a[i])) * 0.1,
                    c = s(l, e, r);
                  return c >= 0.001
                    ? (function (e, t, n, r) {
                        for (var i = 0; i < 4; ++i) {
            ...
            function (e, t, n) {
              ...
              var l = (function (e, t, n, r, i, a, o, s) {
                ...
                if ((t && ((c.render = t), (c.staticRenderFns = []), (c._compiled = !0)), l))
                  if (c.functional) {
                    c._injectStyles = l;
                    var u = c.render;
              ...
              })(
                {
                  ...
                  computed: {
                    ...
                    scrollContainer: function () {
                      var e = window;
                      return this.scrollContainerSelector && (e = document.querySelector(this.scrollContainerSelector) || window), e;
                    },
                  },
                  mounted: function () {
                    ...
                    this.observer ||
                      ...
                      this.observer.observe(this.$refs["scrollactive-nav-wrapper"], { childList: !0, subtree: !0 })),
                  ...
                  methods: {
                    ...
                    getItemInsideWindow: function () {
                      ...
                      return (
                        [].forEach.call(this.items, function (n) {
                          ...
                          if (i) {
                            var a = t.scrollContainer.scrollTop || window.pageYOffset,
                              o = a >= t.getOffsetTop(i) - t.offset,
                              s = a < t.getOffsetTop(i) - t.offset + i.offsetHeight;
                            r && t.highlightFirstItem && s && (e = n), t.exact && o && s && (e = n), !t.exact && o && (e = n);
                          }
                        }),
                        e
                      );
                    ...
                    handleClick: function (e) {
                      ...
                      r
                        ? (this.alwaysTrack ||
                          ...
                          this.scrollTo(r).then(function () {
                            t.alwaysTrack ||
                              (t.scrollContainer.addEventListener("scroll", t.onScroll),
                              (t.currentItem = [].find.call(t.items, function (e) {
                                return decodeURI(e.hash.substr(1)) === r.id;
                              })),
                              t.currentItem !== t.lastActiveItem &&
                                (t.$emit("itemchanged", null, t.currentItem, t.lastActiveItem), (t.lastActiveItem = t.currentItem))),
                    ...
                    scrollTo: function (e) {
                      ...
                      return new Promise(function (n) {
                        var r = t.getOffsetTop(e),
                          i = t.scrollContainer.scrollTop || window.pageYOffset,
                          a = r - i,
                          s = t.bezierEasing.apply(t, o(t.cubicBezierArray)),
                          l = null;
                        window.requestAnimationFrame(function e(r) {
                          l || (l = r);
                          var o = r - l,
                            c = o / t.duration;
                          o >= t.duration && (o = t.duration), c >= 1 && (c = 1);
                          var u = t.scrollOffset || t.offset,
                            d = i + s(c) * (a - u);
                          t.scrollContainer.scrollTo(0, d),
                            o < t.duration ? (t.scrollAnimationFrame = window.requestAnimationFrame(e)) : n();
                        });
                      });
                    },
              ...
              "undefined" != typeof window && window.Vue && u.install(window.Vue), (t.default = u);
            },
          ]));
      },
      5809: (e, t, n) => {
  ...
  (() => {
    ...
    function f() {
      ...
      return (
        1 === e.length
          ? s(e[0]) || Array.isArray(e[0])
            ? (r = e[0])
            : "string" == typeof e[0] && (n = e[0])
          : 2 === e.length && ("string" == typeof e[0] && (n = e[0]), (s(e[1]) || Array.isArray(e[1])) && (r = e[1])),
        { locale: n, params: r }
      );
    }
    function h(e) {
    ...
    function y(e) {
      for (var t = arguments, n = Object(e), r = 1; r < arguments.length; r++) {
        ...
        if (null != i) {
          var a = void 0;
          for (a in i) C(i, a) && (s(i[a]) ? (n[a] = y(n[a], i[a])) : (n[a] = i[a]));
        }
      }
      return n;
    }
        ...
        beforeCreate: function () {
          ...
          if (((e.i18n = e.i18n || (e.__i18n ? {} : null)), e.i18n)) {
            if (e.i18n instanceof J) {
              ...
              i && d(i) && (e.i18n.messages = y(e.i18n.messages, i)),
                (this._i18n = new J(e.i18n)),
            ...
            this.$root && this.$root.$i18n && this.$root.$i18n instanceof J
              ? (this._i18n = this.$root.$i18n)
              : e.parent && e.parent.$i18n && e.parent.$i18n instanceof J && (this._i18n = e.parent.$i18n);
        },
        beforeMount: function () {
          var e = this.$options;
          (e.i18n = e.i18n || (e.__i18n ? {} : null)),
            e.i18n
              ? (e.i18n instanceof J || d(e.i18n)) && (this._i18n.subscribeDataChanging(this), (this._subscribing = !0))
              : ((this.$root && this.$root.$i18n && this.$root.$i18n instanceof J) ||
                  (e.parent && e.parent.$i18n && e.parent.$i18n instanceof J)) &&
              ...
              d = o.i(
                ...
                (function (e) {
                  ...
                  ? (function (e, t) {
                      var n = t
                        ? (function (e) {
                            return Array.isArray(e) ? e.reduce(L, {}) : Object.assign({}, e);
                          })(t)
                        : {};
                      if (!e) return n;
    ...
    var A,
      E = {
        ...
        render: function (e, t) {
          ...
          return h ? e(h, { attrs: a.attrs, class: a.class, staticClass: a.staticClass }, f) : f;
        },
      };
    function S(e, t, n) {
      O(0, n) && T(e, t, n);
    ...
    function k(e, t, n, r) {
      if (O(0, n)) {
        ...
        ((function (e, t) {
          ...
          v(t.value, t.oldValue) &&
          v(e._localeMessage, i.getLocaleMessage(i.locale))) ||
          T(e, t, n);
      }
    }
    function N(e, t, n, r) {
      if (n.context) {
        var i = n.context.$i18n || {};
        t.modifiers.preserve || i.preserveDirectiveContent || (e.textContent = ""),
          (e._vt = void 0),
          delete e._vt,
          (e._locale = void 0),
          delete e._locale,
    ...
    function O(e, t) {
      var n = t.context;
      return n
        ? !!n.$i18n || (a("VueI18n instance does not exists in Vue instance"), !1)
    ...
    function T(e, t, n) {
      var r,
        ...
        o = (function (e) {
          var t, n, r, i;
          return (
            l(e) ? (t = e) : d(e) && ((t = e.path), (n = e.locale), (r = e.args), (i = e.choice)),
      ...
      if (s || c || u)
        if (s) {
          var f = n.context;
          (e._vt = e.textContent =
            null != p ? (r = f.$i18n).tc.apply(r, [s, p].concat(M(c, u))) : (i = f.$i18n).t.apply(i, [s].concat(M(c, u)))),
    ...
    function P(e) {
      (P.installed = !0),
        ...
        A.mixin(b),
        A.directive("t", { bind: S, update: k, unbind: N }),
        A.component(w.name, w),
        A.component(E.name, E),
        (A.config.optionMergeStrategies.i18n = function (e, t) {
          return void 0 === t ? e : t;
        });
    }
    var R = function () {
    ...
    R.prototype.interpolate = function (e, t) {
      ...
      return (
          ...
          ((n = (function (e) {
            for (var t = [], n = 0, r = ""; n < e.length; ) {
              ...
              if ("{" === i) {
                ...
                var o = "}" === i,
                  s = D.test(a) ? "list" : o && I.test(a) ? "named" : "unknown";
        ...
        (function (e, t) {
          var n = [],
            r = 0,
            i = Array.isArray(t) ? "list" : s(t) ? "named" : "unknown";
    ...
    var D = /^(?:\d)+/,
      I = /^(?:\w)+/,
      j = [];
    (j[0] = { ws: [0], ident: [3, 0], "[": [4], eof: [7] }),
      (j[1] = { ws: [1], ".": [2], "[": [4], eof: [7] }),
      (j[2] = { ws: [2], ident: [3, 0], 0: [3, 0], number: [3, 0] }),
      (j[3] = { ident: [3, 0], 0: [3, 0], number: [3, 0], ws: [1, 1], ".": [2, 1], "[": [4, 1], eof: [7, 1] }),
      (j[4] = { "'": [5, 0], '"': [6, 0], "[": [4, 2], "]": [1, 3], eof: 8, else: [4, 0] }),
      (j[5] = { "'": [4, 0], eof: 8, else: [5, 0] }),
      (j[6] = { '"': [4, 0], eof: 8, else: [6, 0] });
    ...
    (G.prototype.parsePath = function (e) {
      var t = this._cache[e];
      return (
        t ||
          ((t = (function (e) {
            ...
            for (
              ...
              if ((c++, "\\" !== (t = e[c]) || !f())) {
                if (((i = B(t)), 8 === (a = (s = j[u])[i] || s.else || 8))) return;
      ...
      (G.prototype.getPathValue = function (e, t) {
        if (!s(e)) return null;
    ...
    var U,
      ...
      J = function (e) {
        var t = this;
        void 0 === e && (e = {}), !A && "undefined" != typeof window && window.Vue && P(window.Vue);
        ...
        (this._vm = null),
          ...
          (this.getChoiceIndex = function (e, n) {
            ...
            return a && a.getChoiceIndex
              ? a.getChoiceIndex.call(t, e, n)
              : t.locale in t.pluralizationRules
              ? t.pluralizationRules[t.locale].apply(t, [e, n])
              : ((r = e), (i = n), (r = Math.abs(r)), 2 === i ? (r ? (r > 1 ? 1 : 0) : 1) : r ? Math.min(r, 2) : 0);
          }),
    ...
    (J.prototype._checkLocaleMessage = function (e, t, n) {
      ...
      (J.prototype._initVM = function (e) {
        ...
        (A.config.silent = !0), (this._vm = new A({ data: e })), (A.config.silent = t);
      }),
      ...
      (J.prototype.onComponentInstanceCreated = function (e) {
      ...
      (J.prototype._warnDefault = function (e, t, n, r, i, a) {
        if (!p(n)) return n;
        if (this._missing) {
      ...
      (J.prototype._link = function (e, t, n, r, i, a, o) {
        var s = n,
          l = s.match(z);
        for (var c in l)
          if (l.hasOwnProperty(c)) {
            var u = l[c],
              ...
              p = d[0],
              f = d[1],
              h = u.replace(p, "").replace(W, "");
            if (m(o, h)) return s;
            o.push(h);
            var g = this._interpolate(e, t, h, r, "raw" === i ? "string" : i, "raw" === i ? void 0 : a, o);
            if (this._isFallbackRoot(g)) {
              if (!this._root) throw Error("unexpected error");
              var C = this._root.$i18n;
              g = C._translate(C._getMessages(), C.locale, C.fallbackLocale, h, r, i, a);
            }
            (g = this._warnDefault(e, h, g, r, Array.isArray(a) ? a : [a], i)),
              this._modifiers.hasOwnProperty(f) ? (g = this._modifiers[f](g)) : Z.hasOwnProperty(f) && (g = Z[f](g)),
              o.pop(),
              (s = g ? s.replace(u, g) : s);
          }
        return s;
      }),
      (J.prototype._render = function (e, t, n, r) {
        var i = this._formatter.interpolate(e, n, r);
        return i || (i = q.interpolate(e, n, r)), "string" !== t || l(i) ? i : i.join("");
      }),
      (J.prototype._appendItemToChain = function (e, t, n) {
        var r = !1;
        return (
          m(e, t) || ((r = !0), t && ((r = "!" !== t[t.length - 1]), (t = t.replace(/!/g, "")), e.push(t), n && n[t] && (r = n[t]))), r
        );
      }),
      (J.prototype._appendLocaleToChain = function (e, t, n) {
        var r,
          i = t.split("-");
        do {
          var a = i.join("-");
      ...
      (J.prototype._appendBlockToChain = function (e, t, n) {
        for (var r = !0, i = 0; i < t.length && "boolean" == typeof r; i++) {
          var a = t[i];
          l(a) && (r = this._appendLocaleToChain(e, a, n));
        }
        return r;
      }),
      (J.prototype._getLocaleChain = function (e, t) {
        if ("" === e) return [];
        ...
        if (!n) {
          ...
          (i = l((r = o(t) ? t : s(t) ? (t.default ? t.default : null) : t)) ? [r] : r) && this._appendBlockToChain(n, i, null),
            (this._localeChainCache[e] = n);
        }
        return n;
      }),
      (J.prototype._translate = function (e, t, n, r, i, a, o) {
        for (var s, l = this._getLocaleChain(t, n), c = 0; c < l.length; c++) {
          var u = l[c];
          if (!p((s = this._interpolate(u, e[u], r, i, a, o, [r])))) return s;
        }
        return null;
      }),
      (J.prototype._t = function (e, t, n, r) {
        ...
        return (c = this._warnDefault(l, e, c, r, a, "string")), this._postTranslation && null != c && (c = this._postTranslation(c, e)), c;
      }),
      (J.prototype.t = function (e) {
        for (var t, n = [], r = arguments.length - 1; r-- > 0; ) n[r] = arguments[r + 1];
        return (t = this)._t.apply(t, [e, this.locale, this._getMessages(), null].concat(n));
      }),
      (J.prototype._i = function (e, t, n, r, i) {
      ...
      (J.prototype._tc = function (e, t, n, r, i) {
        ...
        return (
          ...
          this.fetchChoice((a = this)._t.apply(a, [e, t, n, r].concat(o)), i)
        );
      }),
      (J.prototype.fetchChoice = function (e, t) {
      ...
      (J.prototype._te = function (e, t, n) {
        ...
        var a = f.apply(void 0, r).locale || t;
      ...
      (J.prototype.mergeLocaleMessage = function (e, t) {
        ("warn" !== this._warnHtmlInMessage && "error" !== this._warnHtmlInMessage) ||
          this._checkLocaleMessage(e, this._warnHtmlInMessage, t),
          this._vm.$set(this._vm.messages, e, y({}, this._vm.messages[e] || {}, t));
      }),
      ...
      (J.prototype._clearDateTimeFormat = function (e, t) {
        for (var n in t) {
          var r = e + "__" + n;
          this._dateTimeFormatters.hasOwnProperty(r) && delete this._dateTimeFormatters[r];
        }
      }),
      (J.prototype._localizeDateTime = function (e, t, n, r, i) {
        for (var a = t, o = r[a], s = this._getLocaleChain(t, n), l = 0; l < s.length; l++) {
          var c = s[l];
          if (((a = c), !p((o = r[c])) && !p(o[i]))) break;
        }
        if (p(o) || p(o[i])) return null;
        var u = o[i],
          d = a + "__" + i,
          f = this._dateTimeFormatters[d];
        return f || (f = this._dateTimeFormatters[d] = new Intl.DateTimeFormat(a, u)), f.format(e);
      }),
      ...
      (J.prototype.d = function (e) {
        ...
        return (
          1 === t.length
            ? l(t[0])
              ? (i = t[0])
              : s(t[0]) && (t[0].locale && (r = t[0].locale), t[0].key && (i = t[0].key))
            : 2 === t.length && (l(t[0]) && (i = t[0]), l(t[1]) && (r = t[1])),
          this._d(e, r, i)
        );
      }),
      ...
      (J.prototype._clearNumberFormat = function (e, t) {
        for (var n in t) {
          var r = e + "__" + n;
          this._numberFormatters.hasOwnProperty(r) && delete this._numberFormatters[r];
        }
      }),
      (J.prototype._getNumberFormatter = function (e, t, n, r, i, a) {
        for (var o = t, s = r[o], l = this._getLocaleChain(t, n), c = 0; c < l.length; c++) {
          var u = l[c];
          if (((o = u), !p((s = r[u])) && !p(s[i]))) break;
        }
        if (p(s) || p(s[i])) return null;
        var d,
          f = s[i];
        if (a) d = new Intl.NumberFormat(o, Object.assign({}, f, a));
        else {
          var h = o + "__" + i;
          (d = this._numberFormatters[h]) || (d = this._numberFormatters[h] = new Intl.NumberFormat(o, f));
        }
        return d;
      }),
      (J.prototype._n = function (e, t, n, r) {
      ...
      (J.prototype.n = function (e) {
        ...
        return (
          1 === t.length
            ...
            : 2 === t.length && (l(t[0]) && (a = t[0]), l(t[1]) && (r = t[1])),
          this._n(e, r, a, o)
        );
      }),
      (J.prototype._ntp = function (e, t, n, r) {
        if (!J.availabilities.numberFormat) return [];
      ...
      K = {
        en: {
          editor: {
            ...
            codeChangedConfirm: "Modified code will be lost. Do you want to continue?",
            ...
            share: {
              ...
              urlTooLong: "The generated URL may be too long to be sharable. Please try to shorten the code.",
            },
            pr: {
        ...
        zh: {
          editor: {
            ...
            share: {
              ...
              urlTooLong: "当前代码生成的分享 URL 过长，可能导致他人无法打开，请尝试缩减非必要代码后再试。",
            },
            pr: {
    ...
    var Y = function () {
      ...
      return n(
        "div",
        { class: { "is-dragging": e.draggingMouseDown }, attrs: { id: "main-container" } },
        [
          e.shared.isMobile
            ? e._e()
            : n(
                "div",
                { style: { width: e.leftContainerSize + "%" }, attrs: { id: "editor-left-container" } },
                [
                  n(
                    "el-tabs",
                    {
                    ...
                    [
                      n(
                        "el-tab-pane",
                        { attrs: { name: "code-editor" } },
                        [
                          n("span", { attrs: { slot: "label" }, slot: "label" }, [e._v(e._s(e.$t("editor.tabEditor")))]),
                          e._v(" "),
                          n(
                            "el-container",
                            [
                              n("el-header", { attrs: { id: "editor-control-panel" } }, [
                                n(
                                  "div",
                                  { staticClass: "languages" },
                                  [
                                    n("el-tooltip", { attrs: { content: e.$t("editor.tooltip.jsMode"), placement: "bottom" } }, [
                                      n(
                                        "a",
                                        {
                                          class: { js: !0, active: !e.shared.typeCheck },
                                          on: {
                                            click: function (t) {
                                              return e.changeLang("js");
                                            },
                                          },
                                        },
                                        [e._v("JS")]
                                    ...
                                    n(
                                      "el-tooltip",
                                      { attrs: { content: e.$t("editor.tooltip." + (e.hasTs ? "tsMode" : "noTs")), placement: "bottom" } },
                                      [
                                        n(
                                          "a",
                                          {
                                            class: { ts: !0, active: e.shared.typeCheck, disabled: !e.hasTs },
                                            on: {
                                              click: function (t) {
                                                e.hasTs && e.changeLang("ts");
                                              },
                                            },
                                          },
                                          [e._v("TS")]
                                ...
                                e._v(" "),
                                n("div", { staticClass: "editor-controls" }, [
                                  e.shared.isPR
                                    ? n(
                                        "a",
                                        {
                                          staticClass: "btn btn-default btn-sm pull-request",
                                          attrs: {
                                            target: "_blank",
                                            href: "https://github.com/apache/echarts/pull/" + e.shared.prNumber,
                                            title: (e.pr && e.pr.title ? e.pr.title + "\n" : "") + e.$t("editor.pr.tooltip"),
                                          },
                                        },
                                        [
                                          n("svg", { attrs: { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24" } }, [
                                            n("path", {
                                              attrs: {
                                                fill: "currentColor",
                                          ...
                                          e._v(" "),
                                          n("span", [e._v("#" + e._s(e.shared.prNumber))]),
                                        ]
                                      )
                                    : e._e(),
                                  e._v(" "),
                                  n(
                                    "a",
                                    {
                                      staticClass: "btn btn-sm codepen",
                                      attrs: { title: e.$t("editor.openWithCodePen") },
                                      on: {
                                        click: function (t) {
                                          return e.toExternalEditor("CodePen");
                                        },
                                      },
                                    },
                                    [
                                  ...
                                  n(
                                    "a",
                                    {
                                      staticClass: "btn btn-sm codesandbox",
                                      attrs: { title: e.$t("editor.openWithCodeSandbox") },
                                      on: {
                                        click: function (t) {
                                          return e.toExternalEditor("CodeSandbox");
                                        },
                                      },
                                    },
                                    [
                                  ...
                                  n(
                                    "a",
                                    {
                                      staticClass: "btn btn-sm format",
                                      style: { cursor: e.formatterReady ? "" : "progress" },
                                      attrs: { title: e.$t("editor.format"), disabled: !e.formatterReady },
                                      on: { click: e.format },
                                    },
                                    [
                                      n(
                                  ...
                                  e._v(" "),
                                  n("a", { staticClass: "btn btn-default btn-sm run", on: { click: e.disposeAndRun } }, [
                                    n(
                                      "svg",
                                      {
                                        attrs: {
                                    ...
                                    e._v(" "),
                                    n("span", [e._v(e._s(e.$t("editor.run")))]),
                                  ]),
                                ]),
                              ]),
                              e._v(" "),
                              n(
                                ...
                                [
                                  e.shared.typeCheck
                                    ? n("CodeMonaco", {
                                        attrs: { id: "code-panel", initialCode: e.initialCode },
                                        on: { ready: e.prepareFormatter },
                                      })
                                    : n("CodeAce", { attrs: { id: "code-panel", initialCode: e.initialCode } }),
                                ],
                                1
                              ),
                            ],
                      ...
                      n(
                        "el-tab-pane",
                        { attrs: { label: e.$t("editor.tabFullCodePreview"), name: "full-code", lazy: !0 } },
                        [
                          n(
                            "el-container",
                            ...
                            [
                              n(
                                ...
                                [
                                  n("span", { staticClass: "full-code-generate-config-label" }),
                                  e._v(" "),
                                  n("el-switch", {
                                    attrs: { "active-text": e.$t("editor.minimalBundle"), "inactive-text": "" },
                                    model: {
                                      value: e.fullCodeConfig.minimal,
                                      callback: function (t) {
                                        e.$set(e.fullCodeConfig, "minimal", t);
                                      },
                                  ...
                                  e.shared.typeCheck
                                    ? e._e()
                                    : n("el-switch", {
                                        attrs: { "active-text": "ES Modules", "inactive-text": "" },
                                        model: {
                                          value: e.fullCodeConfig.esm,
                                          callback: function (t) {
                                            e.$set(e.fullCodeConfig, "esm", t);
                                          },
                              ...
                              e._v(" "),
                              n("el-main", [n("FullCodePreview", { attrs: { code: e.fullCode } })], 1),
                            ],
                            1
                          ),
                        ],
                      ...
                      e._v(" "),
                      n("el-tab-pane", { attrs: { label: e.$t("editor.tabOptionPreview"), name: "full-option" } }, [
                        n("div", { ref: "optionOutline", attrs: { id: "option-outline" } }),
                      ]),
                      e._v(" "),
                      e.shared.isPR
                        ? n(
                            "el-tab-pane",
                            {
                              directives: [{ name: "loading", rawName: "v-loading", value: e.isPRLoading, expression: "isPRLoading" }],
                              attrs: { label: e.$t("editor.prPreview.title"), name: "pr-preview" },
                            },
                            [
                              e.pr
                                ? n(
                                    "div",
                                    { ref: "prPreview", attrs: { id: "pr-preview" } },
                                    [
                                      n(
                                        "el-descriptions",
                                        { staticClass: "pr-info", attrs: { direction: "vertical", size: "small", column: 4, border: "" } },
                                        [
                                          n(
                                            "a",
                                            {
                                              ref: "prTitle",
                                              staticClass: "pr-title",
                                              attrs: { slot: "title", target: "_blank", href: e.pr.html_url },
                                              slot: "title",
                                            },
                                            [e._v("(#" + e._s(e.pr.number) + ") " + e._s(e.pr.title))]
                                          ),
                                          e._v(" "),
                                          n("el-descriptions-item", { attrs: { label: e.$t("editor.prPreview.author") } }, [
                                            n(
                                              "a",
                                              { staticClass: "pr-author-avatar", attrs: { target: "_blank", href: e.pr.user.html_url } },
                                              [
                                                n("el-avatar", { attrs: { src: e.pr.user.avatar_url, size: 20 } }),
                                                e._v(" "),
                                                n("span", [e._v(e._s(e.pr.user.login))]),
                                              ],
                                              1
                                            ),
                                          ]),
                                          e._v(" "),
                                          n("el-descriptions-item", { attrs: { label: e.$t("editor.prPreview.fromBranch") } }, [
                                            n(
                                              "a",
                                              {
                                                attrs: {
                                                  target: "_blank",
                                                  href: e.pr.head.repo.html_url + "/tree/" + e.pr.head.ref,
                                                  title: e.pr.head.label,
                                                },
                                              },
                                              [e._v("\n                " + e._s(e.pr.head.ref) + "\n              ")]
                                            ),
                                          ...
                                          e._v(" "),
                                          n("el-descriptions-item", { attrs: { label: e.$t("editor.prPreview.toBranch") } }, [
                                            n(
                                              "a",
                                              {
                                                attrs: {
                                                  target: "_blank",
                                                  href: e.pr.base.repo.html_url + "/tree/" + e.pr.base.ref,
                                                  title: e.pr.base.label,
                                                },
                                              },
                                              [e._v("\n                " + e._s(e.pr.base.ref) + "\n              ")]
                                            ),
                                          ...
                                          n(
                                            ...
                                            { attrs: { label: e.$t("editor.prPreview.milestone") } },
                                            [
                                              e.pr.milestone
                                                ? n("a", { attrs: { target: "_blank", href: e.pr.milestone.html_url } }, [
                                          ...
                                          n(
                                            "el-descriptions-item",
                                            { attrs: { label: e.$t("editor.prPreview.labels"), span: 4 } },
                                            e._l(e.pr.labels, function (t) {
                                              return n(
                                                "el-tag",
                                                {
                                                  key: t.id,
                                                  staticClass: "pr-label",
                                                  attrs: { size: "small", color: "#" + t.color, title: t.description },
                                                },
                                                [e._v(e._s(t.name))]
                                              );
                                            }),
                                          ...
                                          n(
                                            "el-descriptions-item",
                                            { attrs: { label: e.$t("editor.prPreview.changes"), span: 4 } },
                                            [
                                              n(
                                                "el-descriptions",
                                                { attrs: { size: "small", direction: "vertical", column: 5, colon: !1 } },
                                                [
                                                  n("el-descriptions-item", { attrs: { label: e.$t("editor.prPreview.addedLines") } }, [
                                                    n("span", [
                                                      e._v("\n                    " + e._s(e.pr.additions) + "\n                  "),
                                                    ]),
                                                  ]),
                                                  e._v(" "),
                                                  n("el-descriptions-item", { attrs: { label: e.$t("editor.prPreview.removedLines") } }, [
                                                    n("span", [
                                                      e._v("\n                    " + e._s(e.pr.deletions) + "\n                  "),
                                                    ]),
                                                  ]),
                                                  e._v(" "),
                                                  n("el-descriptions-item", { attrs: { label: e.$t("editor.prPreview.changedFiles") } }, [
                                                    n("a", { attrs: { href: e.pr.html_url + "/files", target: "_blank" } }, [
                                                      e._v("\n                    " + e._s(e.pr.changed_files) + "\n                  "),
                                                    ]),
                                                  ]),
                                                  e._v(" "),
                                                  n("el-descriptions-item", { attrs: { label: e.$t("editor.prPreview.commits") } }, [
                                                    n("a", { attrs: { href: e.pr.html_url + "/commits", target: "_blank" } }, [
                                                      e._v("\n                    " + e._s(e.pr.commits) + "\n                  "),
                                                    ]),
                                                  ]),
                                                  e._v(" "),
                                                  n("el-descriptions-item", { attrs: { label: e.$t("editor.prPreview.latestCommit") } }, [
                                                    n(
                                                      "a",
                                                      { attrs: { href: e.pr.html_url + "/commits/" + e.pr.head.sha, target: "_blank" } },
                                                      [
                                                        e._v(
                                                          "\n                    " +
                                          ...
                                          n(
                                            ...
                                            [
                                              n("span", { attrs: { slot: "label" }, slot: "label" }, [
                                                ...
                                                e.isPRReviewLoading
                                                  ? n("i", { staticClass: "el-icon-loading", staticStyle: { "margin-left": "5px" } })
                                                  : e._e(),
                                              ]),
                                              e._v(" "),
                                              e.isPRReviewLoading
                                                ? n("span", [e._v(e._s(e.$t("editor.prPreview.loadingReview")))])
                                                : !1 === e.isPRReviewLoading
                                                ? n("span", [e._v(e._s(e.$t("editor.prPreview.reviewLoadFailed")))])
                                                : e.prLatestReview
                                                ? n(
                                                    "el-descriptions",
                                                    { attrs: { size: "small", direction: "vertical", column: 3, colon: !1 } },
                                                    [
                                                      n("el-descriptions-item", { attrs: { label: e.$t("editor.prPreview.reviewedBy") } }, [
                                                        n(
                                                          "a",
                                                          {
                                                            staticClass: "pr-author-avatar",
                                                            attrs: { target: "_blank", href: e.prLatestReview.user.html_url },
                                                          },
                                                          [
                                                            n("el-avatar", { attrs: { src: e.prLatestReview.user.avatar_url, size: 20 } }),
                                                            e._v(" "),
                                                            n("span", [e._v(e._s(e.prLatestReview.user.login))]),
                                                          ],
                                                          1
                                                        ),
                                                      ]),
                                                      e._v(" "),
                                                      n("el-descriptions-item", { attrs: { label: e.$t("editor.prPreview.reviewedAt") } }, [
                                                        e._v(
                                                          "\n                  " +
                                                      ...
                                                      n(
                                                        "el-descriptions-item",
                                                        { attrs: { label: e.$t("editor.prPreview.reviewState") } },
                                                        [e._v("\n                  " + e._s(e.prLatestReview.state) + "\n                ")]
                                                      ),
                                                      e._v(" "),
                                                      n(
                                                        "el-descriptions-item",
                                                        { attrs: { label: e.$t("editor.prPreview.reviewComment"), span: 3 } },
                                                        [
                                                          n("a", { attrs: { href: e.prLatestReview.html_url, target: "_blank" } }, [
                                                            e._v(
                                                              "\n                    " +
                                                ...
                                                : n("span", [e._v(e._s(e.$t("editor.prPreview.noReview")))]),
                                            ],
                                            1
                                          ),
                                          e._v(" "),
                                          n("el-descriptions-item", { attrs: { label: e.$t("editor.prPreview.diff"), span: 4 } }, [
                                            n(
                                              "details",
                                              {
                                                on: {
                                                  toggle: function (t) {
                                                    t.target.open && e.loadPRDiff();
                                                  },
                                                },
                                              },
                                              [
                                                n("summary", { staticStyle: { display: "revert", cursor: "pointer" } }, [
                                                  e._v(
                                                    "\n                  " +
                                                ...
                                                e._v(" "),
                                                n("pre", { staticClass: "pr-diff" }, [
                                                  e.isPRDiffLoading
                                                    ? n("span", [e._v(e._s(e.$t("editor.prPreview.loadingDiff")))])
                                                    : e._e(),
                                                  !1 === e.isPRDiffLoading
                                                    ? n("span", [e._v(e._s(e.$t("editor.prPreview.diffLoadFailed")))])
                                                    : e._e(),
                                                  n("div", { ref: "prDiff" }),
                                                ]),
                                              ]
          ...
          e.shared.isMobile
            ...
            : n("div", {
                staticClass: "handler",
                style: { left: e.leftContainerSize + "%" },
                attrs: { id: "h-handler" },
                on: {
                  mousedown: function (t) {
                    e.draggingMouseDown = !0;
                  },
                },
              }),
          e._v(" "),
          n("Preview", {
            ...
            style: { width: 100 - e.leftContainerSize + "%", left: e.leftContainerSize + "%" },
            attrs: { inEditor: !0 },
            on: { ready: e.onPreviewReady },
          }),
        ],
        1
      );
    ...
    ee._withStripped = !0;
    var te = [
        { name: "color", count: 1967 },
        { name: "shadowColor", count: 1893 },
        { name: "shadowBlur", count: 1893 },
        { name: "shadowOffsetX", count: 1893 },
        { name: "shadowOffsetY", count: 1893 },
        { name: "borderColor", count: 1559 },
        { name: "borderWidth", count: 1558 },
        { name: "width", count: 1523 },
        { name: "borderType", count: 1487 },
        { name: "borderDashOffset", count: 1475 },
        { name: "height", count: 1209 },
        { name: "backgroundColor", count: 1199 },
        { name: "fontSize", count: 1186 },
        { name: "fontStyle", count: 1168 },
        { name: "fontWeight", count: 1168 },
        { name: "fontFamily", count: 1168 },
        { name: "lineHeight", count: 1168 },
        { name: "textBorderColor", count: 1168 },
        { name: "textBorderWidth", count: 1168 },
        { name: "textBorderType", count: 1168 },
        { name: "textBorderDashOffset", count: 1168 },
        { name: "textShadowColor", count: 1168 },
        { name: "textShadowBlur", count: 1168 },
        { name: "textShadowOffsetX", count: 1168 },
        { name: "textShadowOffsetY", count: 1168 },
        { name: "padding", count: 1165 },
        { name: "borderRadius", count: 1146 },
        { name: "align", count: 980 },
        { name: "verticalAlign", count: 977 },
        { name: "opacity", count: 758 },
        { name: "show", count: 716 },
        { name: "ellipsis", count: 622 },
        { name: "overflow", count: 616 },
        { name: "position", count: 562 },
        { name: "rich", count: 554 },
        { name: "<style_name>", count: 554 },
        { name: "distance", count: 512 },
        { name: "label", count: 496 },
        { name: "type", count: 415 },
        { name: "rotate", count: 398 },
        { name: "offset", count: 388 },
        { name: "itemStyle", count: 377 },
        { name: "formatter", count: 371 },
        { name: "borderCap", count: 369 },
        { name: "borderJoin", count: 369 },
        { name: "borderMiterLimit", count: 369 },
        { name: "miterLimit", count: 322 },
        { name: "lineStyle", count: 319 },
        { name: "dashOffset", count: 299 },
        { name: "cap", count: 299 },
        { name: "join", count: 299 },
        { name: "disabled", count: 198 },
        { name: "emphasis", count: 184 },
        { name: "blur", count: 153 },
        { name: "name", count: 137 },
        { name: "curveness", count: 131 },
        { name: "symbol", count: 127 },
        { name: "symbolSize", count: 127 },
        { name: "x", count: 121 },
        { name: "y", count: 121 },
        { name: "delay", count: 114 },
        { name: "value", count: 106 },
        { name: "duration", count: 101 },
        { name: "easing", count: 101 },
        { name: "symbolKeepAspect", count: 100 },
        { name: "silent", count: 96 },
        { name: "labelLine", count: 84 },
        { name: "rotation", count: 80 },
        { name: "symbolOffset", count: 80 },
        { name: "transition", count: 80 },
        { name: "animationDuration", count: 76 },
        { name: "animationEasing", count: 76 },
        { name: "animationDelay", count: 75 },
        { name: "symbolRotate", count: 74 },
        { name: "data", count: 74 },
        { name: "animation", count: 74 },
        { name: "animationDurationUpdate", count: 73 },
        { name: "animationThreshold", count: 72 },
        { name: "animationEasingUpdate", count: 72 },
        { name: "animationDelayUpdate", count: 72 },
        { name: "id", count: 71 },
        { name: "z", count: 64 },
        { name: "textStyle", count: 60 },
        { name: "style", count: 60 },
        { name: "select", count: 57 },
        { name: "zlevel", count: 52 },
        { name: "tooltip", count: 46 },
        { name: "coord", count: 46 },
        { name: "valueIndex", count: 45 },
        { name: "valueDim", count: 45 },
        { name: "valueFormatter", count: 44 },
        { name: "extraCssText", count: 44 },
        { name: "focus", count: 42 },
        { name: "blurScope", count: 41 },
        { name: "inside", count: 40 },
        { name: "minMargin", count: 35 },
        { name: "interval", count: 34 },
        { name: "left", count: 33 },
        { name: "top", count: 33 },
        { name: "right", count: 33 },
        { name: "bottom", count: 33 },
        { name: "draggable", count: 32 },
        { name: "decal", count: 30 },
        { name: "dashArrayX", count: 30 },
        { name: "dashArrayY", count: 30 },
        { name: "maxTileWidth", count: 30 },
        { name: "maxTileHeight", count: 30 },
        { name: "xAxis", count: 29 },
        { name: "yAxis", count: 29 },
        { name: "0", count: 28 },
        { name: "1", count: 28 },
        { name: "margin", count: 27 },
        { name: "loop", count: 27 },
        { name: "precision", count: 26 },
        { name: "hideOverlap", count: 26 },
        { name: "origin", count: 26 },
        { name: "scaleX", count: 25 },
        { name: "scaleY", count: 25 },
        { name: "originX", count: 25 },
        { name: "originY", count: 25 },
        { name: "enterFrom", count: 25 },
        { name: "leaveTo", count: 25 },
        { name: "enterAnimation", count: 25 },
        { name: "updateAnimation", count: 25 },
        { name: "leaveAnimation", count: 25 },
        { name: "keyframeAnimation", count: 25 },
        { name: "keyframes", count: 25 },
        { name: "info", count: 25 },
        { name: "ignore", count: 25 },
        { name: "textContent", count: 25 },
        { name: "textConfig", count: 25 },
        { name: "layoutRect", count: 25 },
        { name: "local", count: 25 },
        { name: "insideFill", count: 25 },
        { name: "insideStroke", count: 25 },
        { name: "outsideFill", count: 25 },
        { name: "outsideStroke", count: 25 },
        { name: "during", count: 25 },
        { name: "selectedMode", count: 23 },
        { name: "invisible", count: 23 },
        { name: "fill", count: 23 },
        { name: "stroke", count: 23 },
        { name: "lineWidth", count: 23 },
        { name: "lineDash", count: 23 },
        { name: "lineDashOffset", count: 23 },
        { name: "lineCap", count: 23 },
        { name: "lineJoin", count: 23 },
        { name: "smooth", count: 23 },
        { name: "length", count: 22 },
        { name: "areaStyle", count: 20 },
        { name: "shape", count: 20 },
        { name: "splitNumber", count: 18 },
        { name: "cursor", count: 18 },
        { name: "showAbove", count: 18 },
        { name: "labelLayout", count: 18 },
        { name: "moveOverlap", count: 18 },
        { name: "dx", count: 18 },
        { name: "dy", count: 18 },
        { name: "labelLinePoints", count: 18 },
        { name: "progressive", count: 17 },
        { name: "length2", count: 17 },
        { name: "icon", count: 16 },
        { name: "colorBy", count: 16 },
        { name: "minTurnAngle", count: 16 },
        { name: "edgeLabel", count: 16 },
        { name: "min", count: 15 },
        { name: "max", count: 15 },
        { name: "xAxisIndex", count: 15 },
        { name: "yAxisIndex", count: 15 },
        { name: "enabled", count: 15 },
        { name: "scale", count: 14 },
        { name: "areaColor", count: 14 },
        { name: "coordinateSystem", count: 14 },
        { name: "markPoint", count: 14 },
        { name: "markLine", count: 14 },
        { name: "markArea", count: 14 },
        { name: "dataGroupId", count: 13 },
        { name: "universalTransition", count: 13 },
        { name: "seriesKey", count: 13 },
        { name: "divideShape", count: 13 },
        { name: "minAngle", count: 13 },
        { name: "z2", count: 13 },
        { name: "extra", count: 13 },
        { name: "orient", count: 12 },
        { name: "iconStyle", count: 12 },
        { name: "$action", count: 12 },
        { name: "bounding", count: 12 },
        { name: "onclick", count: 12 },
        { name: "onmouseover", count: 12 },
        { name: "onmouseout", count: 12 },
        { name: "onmousemove", count: 12 },
        { name: "onmousewheel", count: 12 },
        { name: "onmousedown", count: 12 },
        { name: "onmouseup", count: 12 },
        { name: "ondrag", count: 12 },
        { name: "ondragstart", count: 12 },
        { name: "ondragend", count: 12 },
        { name: "ondragenter", count: 12 },
        { name: "ondragleave", count: 12 },
        { name: "ondragover", count: 12 },
        { name: "ondrop", count: 12 },
        { name: "legendHoverLink", count: 12 },
        { name: "groupId", count: 12 },
        { name: "childGroupId", count: 12 },
        { name: "upperLabel", count: 12 },
        { name: "emphasisDisabled", count: 12 },
        { name: "dimensions", count: 11 },
        { name: "encode", count: 11 },
        { name: "axisPointer", count: 10 },
        { name: "snap", count: 10 },
        { name: "shadowStyle", count: 10 },
        { name: "r", count: 10 },
        { name: "morph", count: 10 },
        { name: "title", count: 9 },
        { name: "textAlign", count: 9 },
        { name: "triggerEvent", count: 9 },
        { name: "inverse", count: 9 },
        { name: "axisLine", count: 9 },
        { name: "axisTick", count: 9 },
        { name: "axisLabel", count: 9 },
        { name: "center", count: 9 },
        { name: "startAngle", count: 9 },
        { name: "geoIndex", count: 9 },
        { name: "clip", count: 9 },
        { name: "seriesLayoutBy", count: 9 },
        { name: "datasetIndex", count: 9 },
        { name: "boundaryGap", count: 8 },
        { name: "showMinLabel", count: 8 },
        { name: "showMaxLabel", count: 8 },
        { name: "splitLine", count: 8 },
        { name: "size", count: 8 },
        { name: "throttle", count: 8 },
        { name: "polarIndex", count: 8 },
        { name: "clockwise", count: 8 },
        { name: "cx", count: 8 },
        { name: "cy", count: 8 },
        { name: "color0", count: 8 },
        { name: "borderColor0", count: 8 },
        { name: "borderColorDoji", count: 8 },
        { name: "nameGap", count: 7 },
        { name: "minInterval", count: 7 },
        { name: "maxInterval", count: 7 },
        { name: "logBase", count: 7 },
        { name: "alignWithLabel", count: 7 },
        { name: "minorTick", count: 7 },
        { name: "endAngle", count: 7 },
        { name: "text", count: 6 },
        { name: "nameLocation", count: 6 },
        { name: "nameTextStyle", count: 6 },
        { name: "nameRotate", count: 6 },
        { name: "nameTruncate", count: 6 },
        { name: "maxWidth", count: 6 },
        { name: "splitArea", count: 6 },
        { name: "triggerEmphasis", count: 6 },
        { name: "triggerTooltip", count: 6 },
        { name: "status", count: 6 },
        { name: "handle", count: 6 },
        { name: "radius", count: 6 },
        { name: "textPosition", count: 6 },
        { name: "textFill", count: 6 },
        { name: "textBackgroundColor", count: 6 },
        { name: "textBorderRadius", count: 6 },
        { name: "textPadding", count: 6 },
        { name: "zoom", count: 6 },
        { name: "line", count: 6 },
        { name: "layout", count: 6 },
        { name: "r0", count: 6 },
        { name: "progressiveThreshold", count: 6 },
        { name: "calendarIndex", count: 6 },
        { name: "offsetCenter", count: 6 },
        { name: "target", count: 5 },
        { name: "itemGap", count: 5 },
        { name: "minorSplitLine", count: 5 },
        { name: "realtime", count: 5 },
        { name: "bar", count: 5 },
        { name: "stack", count: 5 },
        { name: "roam", count: 5 },
        { name: "valueAnimation", count: 5 },
        { name: "link", count: 4 },
        { name: "inactiveColor", count: 4 },
        { name: "selected", count: 4 },
        { name: "trigger", count: 4 },
        { name: "axis", count: 4 },
        { name: "crossStyle", count: 4 },
        { name: "end", count: 4 },
        { name: "seriesIndex", count: 4 },
        { name: "inRange", count: 4 },
        { name: "outOfRange", count: 4 },
        { name: "nameMap", count: 4 },
        { name: "children", count: 4 },
        { name: "points", count: 4 },
        { name: "smoothConstraint", count: 4 },
        { name: "x1", count: 4 },
        { name: "y1", count: 4 },
        { name: "x2", count: 4 },
        { name: "y2", count: 4 },
        { name: "percent", count: 4 },
        { name: "endLabel", count: 4 },
        { name: "large", count: 4 },
        { name: "largeThreshold", count: 4 },
        { name: "hoverAnimation", count: 4 },
        { name: "textVerticalAlign", count: 3 },
        { name: "itemWidth", count: 3 },
        { name: "itemHeight", count: 3 },
        { name: "filterMode", count: 3 },
        { name: "handleStyle", count: 3 },
        { name: "brushStyle", count: 3 },
        { name: "rect", count: 3 },
        { name: "polygon", count: 3 },
        { name: "map", count: 3 },
        { name: "scaleLimit", count: 3 },
        { name: "image", count: 3 },
        { name: "font", count: 3 },
        { name: "source", count: 3 },
        { name: "config", count: 3 },
        { name: "print", count: 3 },
        { name: "sort", count: 3 },
        { name: "withName", count: 3 },
        { name: "withoutName", count: 3 },
        { name: "roundCap", count: 3 },
        { name: "barWidth", count: 3 },
        { name: "barMaxWidth", count: 3 },
        { name: "barMinWidth", count: 3 },
        { name: "progressiveChunkMode", count: 3 },
        { name: "visualDimension", count: 3 },
        { name: "visualMin", count: 3 },
        { name: "visualMax", count: 3 },
        { name: "colorAlpha", count: 3 },
        { name: "colorSaturation", count: 3 },
        { name: "colorMappingBy", count: 3 },
        { name: "visibleMin", count: 3 },
        { name: "childrenVisibleMin", count: 3 },
        { name: "gapWidth", count: 3 },
        { name: "borderColorSaturation", count: 3 },
        { name: "levels", count: 3 },
        { name: "inactiveWidth", count: 2 },
        { name: "inactiveBorderColor", count: 2 },
        { name: "inactiveBorderWidth", count: 2 },
        { name: "selectorLabel", count: 2 },
        { name: "gridIndex", count: 2 },
        { name: "alignTicks", count: 2 },
        { name: "onZero", count: 2 },
        { name: "onZeroAxisIndex", count: 2 },
        { name: "radar", count: 2 },
        { name: "dataZoom", count: 2 },
        { name: "radiusAxisIndex", count: 2 },
        { name: "angleAxisIndex", count: 2 },
        { name: "start", count: 2 },
        { name: "startValue", count: 2 },
        { name: "endValue", count: 2 },
        { name: "minSpan", count: 2 },
        { name: "maxSpan", count: 2 },
        { name: "minValueSpan", count: 2 },
        { name: "maxValueSpan", count: 2 },
        { name: "zoomLock", count: 2 },
        { name: "rangeMode", count: 2 },
        { name: "handleIcon", count: 2 },
        { name: "handleSize", count: 2 },
        { name: "moveHandleStyle", count: 2 },
        { name: "range", count: 2 },
        { name: "textGap", count: 2 },
        { name: "dimension", count: 2 },
        { name: "hoverLink", count: 2 },
        { name: "controller", count: 2 },
        { name: "categories", count: 2 },
        { name: "triggerOn", count: 2 },
        { name: "toolbox", count: 2 },
        { name: "itemSize", count: 2 },
        { name: "back", count: 2 },
        { name: "option", count: 2 },
        { name: "brush", count: 2 },
        { name: "lineX", count: 2 },
        ...
        { name: "keep", count: 2 },
        { name: "clear", count: 2 },
        { name: "brushType", count: 2 },
        { name: "projection", count: 2 },
        { name: "project", count: 2 },
        { name: "unproject", count: 2 },
        { name: "stream", count: 2 },
        { name: "aspectScale", count: 2 },
        { name: "boundingCoords", count: 2 },
        { name: "nameProperty", count: 2 },
        { name: "layoutCenter", count: 2 },
        { name: "layoutSize", count: 2 },
        { name: "parallel", count: 2 },
        { name: "parallelIndex", count: 2 },
        { name: "checkpointStyle", count: 2 },
        { name: "controlStyle", count: 2 },
        { name: "progress", count: 2 },
        { name: "diffChildrenByName", count: 2 },
        { name: "polyline", count: 2 },
        { name: "cpx1", count: 2 },
        { name: "cpy1", count: 2 },
        { name: "cpx2", count: 2 },
        { name: "cpy2", count: 2 },
        { name: "series", count: 2 },
        { name: "maxCount", count: 2 },
        { name: "prefix", count: 2 },
        { name: "separator", count: 2 },
        { name: "middle", count: 2 },
        { name: "stackStrategy", count: 2 },
        { name: "sampling", count: 2 },
        { name: "barMinHeight", count: 2 },
        { name: "barMinAngle", count: 2 },
        { name: "barGap", count: 2 },
        { name: "barCategoryGap", count: 2 },
        { name: "period", count: 2 },
        { name: "nodeClick", count: 2 },
        { name: "nodes", count: 2 },
        { name: "links", count: 2 },
        { name: "edges", count: 2 },
        { name: "depth", count: 2 },
        { name: "detail", count: 2 },
        { name: "keepAspect", count: 2 },
        { name: "symbolPosition", count: 2 },
        { name: "symbolRepeat", count: 2 },
        { name: "symbolRepeatDirection", count: 2 },
        { name: "symbolMargin", count: 2 },
        { name: "symbolClip", count: 2 },
        { name: "symbolBoundingData", count: 2 },
        { name: "symbolPatternSize", count: 2 },
        { name: "subtext", count: 1 },
        { name: "sublink", count: 1 },
        { name: "subtarget", count: 1 },
        { name: "subtextStyle", count: 1 },
        { name: "legend", count: 1 },
        { name: "scrollDataIndex", count: 1 },
        { name: "pageButtonItemGap", count: 1 },
        { name: "pageButtonGap", count: 1 },
        { name: "pageButtonPosition", count: 1 },
        { name: "pageFormatter", count: 1 },
        { name: "pageIcons", count: 1 },
        { name: "horizontal", count: 1 },
        { name: "vertical", count: 1 },
        { name: "pageIconColor", count: 1 },
        { name: "pageIconInactiveColor", count: 1 },
        { name: "pageIconSize", count: 1 },
        { name: "pageTextStyle", count: 1 },
        { name: "selector", count: 1 },
        { name: "selectorPosition", count: 1 },
        { name: "selectorItemGap", count: 1 },
        { name: "selectorButtonGap", count: 1 },
        { name: "grid", count: 1 },
        { name: "containLabel", count: 1 },
        { name: "alignMinLabel", count: 1 },
        { name: "alignMaxLabel", count: 1 },
        { name: "verticalAlignMinLabel", count: 1 },
        { name: "verticalAlignMaxLabel", count: 1 },
        { name: "polar", count: 1 },
        { name: "radiusAxis", count: 1 },
        { name: "angleAxis", count: 1 },
        { name: "axisName", count: 1 },
        { name: "indicator", count: 1 },
        { name: "zoomOnMouseWheel", count: 1 },
        { name: "moveOnMouseMove", count: 1 },
        { name: "moveOnMouseWheel", count: 1 },
        { name: "preventDefaultMouseMove", count: 1 },
        { name: "slider", count: 1 },
        { name: "dataBackground", count: 1 },
        { name: "selectedDataBackground", count: 1 },
        { name: "fillerColor", count: 1 },
        { name: "moveHandleIcon", count: 1 },
        { name: "moveHandleSize", count: 1 },
        { name: "labelPrecision", count: 1 },
        { name: "labelFormatter", count: 1 },
        { name: "showDetail", count: 1 },
        { name: "showDataShadow", count: 1 },
        { name: "brushSelect", count: 1 },
        { name: "visualMap", count: 1 },
        { name: "continuous", count: 1 },
        { name: "calculable", count: 1 },
        { name: "indicatorIcon", count: 1 },
        { name: "indicatorSize", count: 1 },
        { name: "indicatorStyle", count: 1 },
        { name: "piecewise", count: 1 },
        { name: "pieces", count: 1 },
        { name: "minOpen", count: 1 },
        { name: "maxOpen", count: 1 },
        { name: "showLabel", count: 1 },
        { name: "itemSymbol", count: 1 },
        { name: "showContent", count: 1 },
        { name: "alwaysShowContent", count: 1 },
        { name: "showDelay", count: 1 },
        { name: "hideDelay", count: 1 },
        { name: "enterable", count: 1 },
        { name: "renderMode", count: 1 },
        { name: "confine", count: 1 },
        { name: "appendToBody", count: 1 },
        { name: "appendTo", count: 1 },
        { name: "className", count: 1 },
        { name: "transitionDuration", count: 1 },
        { name: "order", count: 1 },
        { name: "showTitle", count: 1 },
        { name: "feature", count: 1 },
        { name: "saveAsImage", count: 1 },
        { name: "connectedBackgroundColor", count: 1 },
        { name: "excludeComponents", count: 1 },
        { name: "pixelRatio", count: 1 },
        { name: "restore", count: 1 },
        { name: "dataView", count: 1 },
        { name: "readOnly", count: 1 },
        { name: "optionToContent", count: 1 },
        { name: "contentToOption", count: 1 },
        { name: "lang", count: 1 },
        { name: "textareaColor", count: 1 },
        { name: "textareaBorderColor", count: 1 },
        { name: "textColor", count: 1 },
        { name: "buttonColor", count: 1 },
        { name: "buttonTextColor", count: 1 },
        { name: "magicType", count: 1 },
        { name: "tiled", count: 1 },
        { name: "brushLink", count: 1 },
        { name: "brushMode", count: 1 },
        { name: "transformable", count: 1 },
        { name: "throttleType", count: 1 },
        { name: "throttleDelay", count: 1 },
        { name: "removeOnClick", count: 1 },
        { name: "inBrush", count: 1 },
        { name: "outOfBrush", count: 1 },
        { name: "geo", count: 1 },
        { name: "regions", count: 1 },
        { name: "axisExpandable", count: 1 },
        { name: "axisExpandCenter", count: 1 },
        { name: "axisExpandCount", count: 1 },
        { name: "axisExpandWidth", count: 1 },
        { name: "axisExpandTriggerOn", count: 1 },
        { name: "parallelAxisDefault", count: 1 },
        { name: "parallelAxis", count: 1 },
        { name: "dim", count: 1 },
        { name: "areaSelectStyle", count: 1 },
        { name: "singleAxis", count: 1 },
        { name: "timeline", count: 1 },
        { name: "axisType", count: 1 },
        { name: "currentIndex", count: 1 },
        { name: "autoPlay", count: 1 },
        { name: "rewind", count: 1 },
        { name: "playInterval", count: 1 },
        { name: "replaceMerge", count: 1 },
        { name: "controlPosition", count: 1 },
        { name: "showPlayBtn", count: 1 },
        { name: "showPrevBtn", count: 1 },
        { name: "showNextBtn", count: 1 },
        { name: "playIcon", count: 1 },
        { name: "stopIcon", count: 1 },
        { name: "prevIcon", count: 1 },
        { name: "nextIcon", count: 1 },
        { name: "graphic", count: 1 },
        ...
        { name: "sector", count: 1 },
        { name: "arc", count: 1 },
        { name: "bezierCurve", count: 1 },
        { name: "calendar", count: 1 },
        { name: "cellSize", count: 1 },
        { name: "dayLabel", count: 1 },
        { name: "firstDay", count: 1 },
        { name: "monthLabel", count: 1 },
        { name: "yearLabel", count: 1 },
        { name: "dataset", count: 1 },
        { name: "sourceHeader", count: 1 },
        { name: "transform", count: 1 },
        { name: "filter", count: 1 },
        { name: "xxx:xxx", count: 1 },
        { name: "fromDatasetIndex", count: 1 },
        { name: "fromDatasetId", count: 1 },
        { name: "fromTransformResult", count: 1 },
        { name: "aria", count: 1 },
        { name: "description", count: 1 },
        { name: "general", count: 1 },
        { name: "withTitle", count: 1 },
        { name: "withoutTitle", count: 1 },
        { name: "single", count: 1 },
        { name: "multiple", count: 1 },
        { name: "allData", count: 1 },
        { name: "partialData", count: 1 },
        { name: "decals", count: 1 },
        { name: "showSymbol", count: 1 },
        { name: "showAllSymbol", count: 1 },
        { name: "connectNulls", count: 1 },
        { name: "triggerLineEvent", count: 1 },
        { name: "step", count: 1 },
        { name: "smoothMonotone", count: 1 },
        { name: "realtimeSort", count: 1 },
        { name: "showBackground", count: 1 },
        { name: "backgroundStyle", count: 1 },
        { name: "pie", count: 1 },
        { name: "selectedOffset", count: 1 },
        { name: "padAngle", count: 1 },
        { name: "minShowLabelAngle", count: 1 },
        { name: "roseType", count: 1 },
        { name: "avoidLabelOverlap", count: 1 },
        { name: "stillShowZeroSum", count: 1 },
        { name: "percentPrecision", count: 1 },
        { name: "showEmptyCircle", count: 1 },
        { name: "emptyCircleStyle", count: 1 },
        { name: "alignTo", count: 1 },
        { name: "edgeDistance", count: 1 },
        { name: "bleedMargin", count: 1 },
        { name: "distanceToLabelLine", count: 1 },
        { name: "maxSurfaceAngle", count: 1 },
        { name: "scaleSize", count: 1 },
        { name: "animationType", count: 1 },
        { name: "animationTypeUpdate", count: 1 },
        { name: "scatter", count: 1 },
        { name: "effectScatter", count: 1 },
        { name: "effectType", count: 1 },
        { name: "showEffectOn", count: 1 },
        { name: "rippleEffect", count: 1 },
        { name: "number", count: 1 },
        { name: "radarIndex", count: 1 },
        { name: "tree", count: 1 },
        { name: "edgeShape", count: 1 },
        { name: "edgeForkPosition", count: 1 },
        { name: "expandAndCollapse", count: 1 },
        { name: "initialTreeDepth", count: 1 },
        { name: "leaves", count: 1 },
        { name: "collapsed", count: 1 },
        { name: "treemap", count: 1 },
        { name: "squareRatio", count: 1 },
        { name: "leafDepth", count: 1 },
        { name: "drillDownIcon", count: 1 },
        { name: "zoomToNodeRatio", count: 1 },
        { name: "breadcrumb", count: 1 },
        { name: "emptyItemWidth", count: 1 },
        { name: "sunburst", count: 1 },
        { name: "renderLabelForZeroData", count: 1 },
        { name: "boxplot", count: 1 },
        { name: "boxWidth", count: 1 },
        { name: "candlestick", count: 1 },
        { name: "heatmap", count: 1 },
        { name: "pointSize", count: 1 },
        { name: "blurSize", count: 1 },
        { name: "minOpacity", count: 1 },
        { name: "maxOpacity", count: 1 },
        { name: "mapValueCalculation", count: 1 },
        { name: "showLegendSymbol", count: 1 },
        { name: "inactiveOpacity", count: 1 },
        { name: "activeOpacity", count: 1 },
        { name: "lines", count: 1 },
        { name: "effect", count: 1 },
        { name: "constantSpeed", count: 1 },
        { name: "trailLength", count: 1 },
        { name: "roundTrip", count: 1 },
        { name: "coords", count: 1 },
        { name: "graph", count: 1 },
        { name: "circular", count: 1 },
        { name: "rotateLabel", count: 1 },
        { name: "force", count: 1 },
        { name: "initLayout", count: 1 },
        { name: "repulsion", count: 1 },
        { name: "gravity", count: 1 },
        { name: "edgeLength", count: 1 },
        { name: "layoutAnimation", count: 1 },
        { name: "friction", count: 1 },
        { name: "nodeScaleRatio", count: 1 },
        { name: "edgeSymbol", count: 1 },
        { name: "edgeSymbolSize", count: 1 },
        { name: "autoCurveness", count: 1 },
        { name: "fixed", count: 1 },
        { name: "category", count: 1 },
        { name: "ignoreForceLayout", count: 1 },
        { name: "sankey", count: 1 },
        { name: "nodeWidth", count: 1 },
        { name: "nodeGap", count: 1 },
        { name: "nodeAlign", count: 1 },
        { name: "layoutIterations", count: 1 },
        { name: "funnel", count: 1 },
        { name: "minSize", count: 1 },
        { name: "maxSize", count: 1 },
        { name: "gap", count: 1 },
        { name: "funnelAlign", count: 1 },
        { name: "gauge", count: 1 },
        { name: "overlap", count: 1 },
        { name: "pointer", count: 1 },
        { name: "anchor", count: 1 },
        { name: "pictorialBar", count: 1 },
        { name: "themeRiver", count: 1 },
        { name: "singleAxisIndex", count: 1 },
        { name: "date", count: 1 },
        { name: "custom", count: 1 },
        { name: "renderItem", count: 1 },
        { name: "arguments", count: 1 },
        { name: "params", count: 1 },
        { name: "api", count: 1 },
        { name: "styleEmphasis", count: 1 },
        { name: "visual", count: 1 },
        { name: "barLayout", count: 1 },
        { name: "currentSeriesIndices", count: 1 },
        { name: "getWidth", count: 1 },
        { name: "getHeight", count: 1 },
        { name: "getZr", count: 1 },
        { name: "getDevicePixelRatio", count: 1 },
        { name: "return", count: 1 },
        { name: "return_group", count: 1 },
        { name: "return_path", count: 1 },
        { name: "pathData", count: 1 },
        { name: "d", count: 1 },
        { name: "return_image", count: 1 },
        { name: "return_text", count: 1 },
        { name: "return_rect", count: 1 },
        { name: "return_circle", count: 1 },
        { name: "return_ring", count: 1 },
        { name: "return_sector", count: 1 },
        { name: "return_arc", count: 1 },
        { name: "return_polygon", count: 1 },
        { name: "return_polyline", count: 1 },
        { name: "return_line", count: 1 },
        { name: "return_bezierCurve", count: 1 },
        { name: "darkMode", count: 1 },
        { name: "stateAnimation", count: 1 },
        { name: "blendMode", count: 1 },
        { name: "hoverLayerThreshold", count: 1 },
        { name: "useUTC", count: 1 },
        { name: "options", count: 1 },
        { name: "media", count: 1 },
        { name: "query", count: 1 },
        { name: "minWidth", count: 1 },
        { name: "maxHeight", count: 1 },
        { name: "minAspectRatio", count: 1 },
      ],
      ne = [
        "line",
        "bar",
      ...
      re = (function (e) {
        ...
        return location.href.indexOf("github.io") >= 0 ? {} : t;
      })([
        "effectScatter-map",
        "geo-lines",
        "geo-map-scatter",
    ...
    var oe = "/examples/js/",
      ...
      ce = {
        ...
        echartsWorldMapJS: "".concat(oe, "world.js"),
        echartsStatJS: "".concat(oe, "ecStat.min.js"),
        echartsGLJS: "".concat(oe, "echarts-gl.min.js"),
        datGUIMinJS: "".concat(oe, "dat.gui.min.js"),
        monacoDir: "".concat(oe, "monaco-editor@0.27.0/min/vs"),
        aceDir: "".concat(oe, ""),
        prettierDir: "".concat(oe, ""),
        highlightjsDir: "https://fastly.jsdelivr.net/gh/highlightjs/cdn-release@11.8.0/build",
        seedrandomJS: "".concat(oe, "seedrandom.min.js"),
        jQueryJS: "".concat(oe, "jquery.min.js"),
        acornJS: "".concat(oe, "acorn.min.js"),
        bmapLibJS: "https://api.map.baidu.com/api?v=3.0&ak=KOmVjPVUAey1G2E8zNhPiuQ6QiEmAwZu",
        echartsBMapJS: "".concat(oe, "bmap.min.js"),
        echartsGraphModularityJS: "".concat(oe, "echarts-graph-modularity.min.js"),
      },
      ue = {
        echartsDir: "".concat(le, "echarts/{{version}}/files"),
        echartsNightlyDir: "".concat(le, "echarts-nightly/{{version}}/files"),
        echartsJS: ce.echartsJS,
        localEChartsDir: ce.localEChartsDir,
        localEChartsGLDir: ce.localEChartsGLDir,
        prPreviewEChartsDir: ce.prPreviewEChartsDir,
        echartsWorldMapJS: "".concat(le, "world.js"),
        echartsStatJS: "".concat(le, "ecStat.min.js"),
        echartsGLJS: "".concat(le, "echarts-gl.min.js"),
        datGUIMinJS: "".concat(se, "dat.gui.min.js"),
        monacoDir: "".concat(le, "monaco-editor/0.27.0/files/min/vs"),
        aceDir: "".concat(le, ""),
        prettierDir: "".concat(se, ""),
        highlightjsDir: "".concat(le, "@highlightjs/cdn-assets/11.8.0/files"),
        seedrandomJS: "".concat(se, "seedrandom.min.js"),
        jQueryJS: "".concat(le, "jquery.min.js"),
        acornJS: "".concat(le, "acorn.min.js"),
        bmapLibJS: ce.bmapLibJS,
        echartsBMapJS: ce.echartsBMapJS,
        echartsGraphModularityJS: "".concat(le, "echarts-graph-modularity/2/files/dist/echarts-graph-modularity.min.js"),
      };
    const de = [
        {
          category: ["custom"],
        ...
        { category: ["bar"], id: "bar-simple", ts: !0, tags: [], title: "Basic Bar", titleCN: "基础柱状图", difficulty: 0 },
        {
          category: ["bar"],
          id: "bar-tick-align",
          ts: !0,
        ...
        { category: ["calendar"], id: "calendar-simple", ts: !0, tags: [], title: "Simple Calendar", titleCN: "基础日历图", difficulty: 0 },
        {
        ...
        { category: ["line"], id: "line-simple", ts: !0, tags: [], title: "Basic Line Chart", titleCN: "基础折线图", difficulty: 0 },
        { category: ["line"], id: "line-smooth", ts: !0, tags: [], title: "Smoothed Line Chart", titleCN: "基础平滑折线图", difficulty: 0 },
        {
          category: ["pie"],
          id: "pie-simple",
          ts: !0,
        ...
        { category: ["radar"], id: "radar", ts: !0, tags: [], title: "Basic Radar Chart", titleCN: "基础雷达图", difficulty: 0 },
        { category: ["sankey"], id: "sankey-simple", ts: !0, tags: [], title: "Basic Sankey", titleCN: "基础桑基图", difficulty: 0 },
        {
          category: ["scatter"],
          id: "scatter-simple",
          ts: !0,
        ...
        { category: ["line"], id: "area-basic", ts: !0, tags: [], title: "Basic area chart", titleCN: "基础面积图", difficulty: 1 },
        {
          category: ["bar"],
          id: "bar-background",
          ts: !0,
        ...
        { category: ["custom"], id: "custom-profit", ts: !0, tags: [], title: "Profit", titleCN: "利润分布直方图", difficulty: 1 },
        {
        ...
        { category: ["gauge"], id: "gauge", ts: !0, tags: [], title: "Gauge Basic chart", titleCN: "基础仪表盘", difficulty: 1 },
        {
          category: ["gauge"],
          id: "gauge-simple",
          ts: !0,
        ...
        { category: ["graph"], id: "graph-force2", ts: !0, tags: [], title: "Force Layout", titleCN: "力引导布局", difficulty: 1 },
        { category: ["line"], id: "line-stack", ts: !0, tags: [], title: "Stacked Line Chart", titleCN: "折线图堆叠", difficulty: 1 },
        {
          category: ["parallel"],
          id: "parallel-simple",
          ts: !0,
        ...
        { category: ["pie"], id: "pie-doughnut", ts: !0, tags: [], title: "Doughnut Chart", titleCN: "环形图", difficulty: 1 },
        { category: ["pie"], id: "pie-half-donut", ts: !0, tags: [], title: "Half Doughnut Chart", titleCN: "半环形图", difficulty: 1 },
        { category: ["pie"], id: "pie-padAngle", ts: !0, tags: [], title: "Pie with padAngle", titleCN: "饼图扇区间隙", difficulty: 1 },
        { category: ["radar"], id: "radar-aqi", ts: !0, tags: [], title: "AQI - Radar Chart", titleCN: "AQI - 雷达图", difficulty: 1 },
        {
          category: ["sankey"],
          id: "sankey-vertical",
          ts: !0,
        ...
        { category: ["sunburst"], id: "sunburst-simple", ts: !0, tags: [], title: "Basic Sunburst", titleCN: "基础旭日图", difficulty: 1 },
        { category: ["line"], id: "area-stack", ts: !0, tags: [], title: "Stacked Area Chart", titleCN: "堆叠面积图", difficulty: 2 },
        {
          category: ["line"],
        ...
        { category: ["line"], id: "bump-chart", ts: !0, tags: [], title: "Bump Chart (Ranking)", titleCN: "凹凸图", difficulty: 2 },
        {
          category: ["calendar"],
        ...
        { category: ["candlestick"], id: "candlestick-sh", ts: !0, tags: [], title: "ShangHai Index", titleCN: "上证指数", difficulty: 2 },
        {
        ...
        { category: ["gauge"], id: "gauge-speed", ts: !0, tags: [], title: "Speed Gauge", titleCN: "速度仪表盘", difficulty: 2 },
        {
          category: ["graph"],
          id: "graph-grid",
          ts: !0,
        ...
        { category: ["graph"], id: "graph-simple", ts: !0, tags: [], title: "Simple Graph", titleCN: "Graph 简单示例", difficulty: 2 },
        {
          category: ["heatmap"],
          id: "heatmap-large",
          ts: !0,
        ...
        { category: ["pie"], id: "pie-custom", ts: !0, tags: [], title: "Customized Pie", titleCN: "饼图自定义样式", difficulty: 2 },
        { category: ["pie"], id: "pie-pattern", ts: !0, tags: [], title: "Texture on Pie Chart", titleCN: "饼图纹理", difficulty: 2 },
        { category: ["pie"], id: "pie-roseType", ts: !0, tags: [], title: "Nightingale Chart", titleCN: "南丁格尔玫瑰图", difficulty: 2 },
        {
          category: ["pie"],
        ...
        { category: ["bar"], id: "polar-endAngle", ts: !0, tags: [], title: "Polar endAngle", titleCN: "极坐标系 endAngle", difficulty: 2 },
        {
          category: ["radar"],
          id: "radar-custom",
          ts: !0,
        ...
        { category: ["bar"], id: "bar-stack", ts: !0, tags: [], title: "Stacked Column Chart", titleCN: "堆叠柱状图", difficulty: 3 },
        {
          category: ["bar"],
        ...
        { category: ["custom"], id: "custom-profile", ts: !1, tags: [], title: "Profile", titleCN: "性能分析图", difficulty: 3 },
        { category: ["custom"], id: "cycle-plot", ts: !1, tags: [], title: "Cycle Plot", titleCN: "Cycle Plot", difficulty: 3 },
        {
          category: ["line"],
        ...
        { category: ["gauge"], id: "gauge-progress", ts: !0, tags: [], title: "Progress Gauge", titleCN: "进度仪表盘", difficulty: 3 },
        { category: ["gauge"], id: "gauge-stage", ts: !0, tags: [], title: "Stage Speed Gauge", titleCN: "阶段速度仪表盘", difficulty: 3 },
        { category: ["graph"], id: "graph-force", ts: !0, tags: [], title: "Force Layout", titleCN: "力引导布局", difficulty: 3 },
        {
          category: ["graph"],
        ...
        { category: ["heatmap"], id: "heatmap-map", ts: !1, tags: [], title: "Air Qulity", titleCN: "全国主要城市空气质量", difficulty: 3 },
        { category: ["line"], id: "line-gradient", ts: !0, tags: [], title: "Line Gradient", titleCN: "折线图的渐变", difficulty: 3 },
        {
          category: ["line"],
          id: "line-sections",
          ts: !0,
        ...
        { category: ["pie"], id: "pie-alignTo", ts: !0, tags: [], title: "Pie Label Align", titleCN: "饼图标签对齐", difficulty: 3 },
        {
          category: ["pie"],
        ...
        { category: ["radar"], id: "radar2", ts: !0, tags: [], title: "Proportion of Browsers", titleCN: "浏览器占比变化", difficulty: 3 },
        { category: ["sankey"], id: "sankey-energy", ts: !0, tags: [], title: "Gradient Edge", titleCN: "桑基图渐变色边", difficulty: 3 },
        {
          category: ["sankey"],
        ...
        { category: ["calendar"], id: "calendar-lunar", ts: !0, tags: [], title: "Calendar Lunar", titleCN: "农历日历图", difficulty: 4 },
        {
          category: ["candlestick"],
        ...
        { category: ["custom"], id: "flame-graph", ts: !0, tags: [], title: "Flame graph", titleCN: "火焰图", difficulty: 4 },
        { category: ["gauge"], id: "gauge-grade", ts: !0, tags: [], title: "Grade Gauge", titleCN: "等级仪表盘", difficulty: 4 },
        {
          category: ["gauge"],
        ...
        { category: ["graph"], id: "graph", ts: !0, tags: [], title: "Les Miserables", titleCN: "悲惨世界人物关系图", difficulty: 4 },
        {
          category: ["line"],
          id: "grid-multiple",
          ts: !0,
        ...
        { category: ["line"], id: "line-aqi", ts: !0, tags: [], title: "Beijing AQI", titleCN: "北京 AQI 可视化", difficulty: 4 },
        { category: ["bar"], id: "mix-line-bar", ts: !0, tags: [], title: "Mixed Line and Bar", titleCN: "折柱混合", difficulty: 4 },
        {
          category: ["bar"],
        ...
        { category: ["line"], id: "multiple-x-axis", ts: !0, tags: [], title: "Multiple X Axes", titleCN: "多 X 轴", difficulty: 4 },
        { category: ["bar"], id: "multiple-y-axis", ts: !0, tags: [], title: "Multiple Y Axes", titleCN: "多 Y 轴示例", difficulty: 4 },
        {
          category: ["parallel"],
        ...
        { category: ["line"], id: "area-rainfall", ts: !0, tags: [], title: "Rainfall", titleCN: "雨量流量关系图", difficulty: 5 },
        {
          category: ["line"],
          id: "area-time-axis",
          ts: !0,
        ...
        { category: ["bar"], id: "bar-large", ts: !0, tags: [], title: "Large Scale Bar Chart", titleCN: "大数据量柱图", difficulty: 5 },
        { category: ["bar"], id: "bar-race", ts: !0, tags: [], title: "Bar Race", titleCN: "动态排序柱状图", difficulty: 5 },
        {
        ...
        { category: ["gauge"], id: "gauge-ring", ts: !0, tags: [], title: "Ring Gauge", titleCN: "得分环", difficulty: 5 },
        {
          category: ["graph"],
        ...
        { category: ["line"], id: "line-function", ts: !0, tags: [], title: "Function Plot", titleCN: "函数绘图", difficulty: 5 },
        { category: ["line"], id: "line-race", ts: !0, tags: [], title: "Line Race", titleCN: "动态排序折线图", difficulty: 5 },
        { category: ["pie", "rich"], id: "pie-nest", ts: !0, tags: [], title: "Nested Pies", titleCN: "嵌套环形图", difficulty: 5 },
        { category: ["scatter"], id: "scatter-large", ts: !0, tags: [], title: "Large Scatter", titleCN: "大规模散点图", difficulty: 5 },
        {
          category: ["scatter"],
          id: "scatter-nebula",
          ts: !0,
        ...
        { category: ["sunburst"], id: "sunburst-drink", ts: !0, tags: [], title: "Drink Flavors", titleCN: "Drink Flavors", difficulty: 5 },
        { category: ["custom", "dataZoom"], id: "wind-barb", ts: !0, tags: [], title: "Wind Barb", titleCN: "风向图", difficulty: 5 },
        {
          category: ["bar"],
        ...
        { category: ["scatter"], id: "bubble-gradient", ts: !0, tags: [], title: "Bubble Chart", titleCN: "气泡图", difficulty: 6 },
        { category: ["calendar", "pie"], id: "calendar-pie", ts: !0, tags: [], title: "Calendar Pie", titleCN: "日历饼图", difficulty: 6 },
        {
          category: ["custom", "map"],
          id: "custom-hexbin",
          ts: !1,
        ...
        { category: ["bar"], id: "dynamic-data", ts: !0, tags: [], title: "Dynamic Data", titleCN: "动态数据", difficulty: 6 },
        { category: ["gauge"], id: "gauge-barometer", ts: !0, tags: [], title: "Gauge Barometer chart", titleCN: "气压表", difficulty: 6 },
        {
          category: ["graph"],
        ...
        { category: ["sunburst"], id: "sunburst-book", ts: !1, tags: [], title: "Book Records", titleCN: "书籍分布", difficulty: 6 },
        {
          category: ["bar"],
          id: "watermark",
          ts: !0,
        ...
        { category: ["bar"], id: "bar-polar-real-estate", ts: !0, tags: [], title: "Bar Chart on Polar", difficulty: 7 },
        {
          category: ["bar"],
          id: "bar-polar-stack",
          ts: !0,
        ...
        { category: ["gauge"], id: "gauge-clock", ts: !0, tags: [], title: "Clock", titleCN: "时钟仪表盘", difficulty: 7 },
        {
          category: ["graph"],
        ...
        { category: ["line"], id: "line-log", ts: !0, tags: [], title: "Log Axis", titleCN: "对数轴示例", difficulty: 7 },
        { category: ["line"], id: "line-step", ts: !0, tags: [], title: "Step Line", titleCN: "阶梯折线图", difficulty: 7 },
        { category: ["bar"], id: "polar-roundCap", ts: !0, tags: [], title: "Rounded Bar on Polar", titleCN: "圆角环形图", difficulty: 7 },
        {
          category: ["scatter"],
        ...
        { category: ["gauge"], id: "gauge-car", ts: !0, tags: [], title: "Gauge Car", titleCN: "Gauge Car", difficulty: 8 },
        {
          category: ["graph"],
          id: "graph-webkit-dep",
          ts: !0,
        ...
        { category: ["custom"], id: "custom-gauge", ts: !1, tags: [], title: "Custom Gauge", titleCN: "自定义仪表", difficulty: 9 },
        { category: ["graph"], id: "graph-npm", ts: !0, tags: [], title: "NPM Dependencies", titleCN: "NPM 依赖关系图", difficulty: 9 },
        {
        ...
        { category: [], id: "calendar-effectscatter", ts: !0, tags: [], difficulty: 10 },
        {
          category: ["candlestick"],
        ...
        { category: ["funnel"], id: "funnel", ts: !0, tags: [], title: "Funnel Chart", titleCN: "漏斗图", difficulty: 10 },
        { category: ["funnel"], id: "funnel-align", ts: !0, tags: [], title: "Funnel Compare", titleCN: "漏斗图(对比)", difficulty: 10 },
        { category: ["funnel"], id: "funnel-customize", ts: !0, tags: [], title: "Customized Funnel", titleCN: "漏斗图", difficulty: 10 },
        { category: ["funnel"], id: "funnel-mutiple", ts: !0, tags: [], title: "Multiple Funnels", titleCN: "Funnel", difficulty: 10 },
        { category: ["map"], id: "geo-beef-cuts", ts: !0, tags: [], title: "GEO Beef Cuts", titleCN: "庖丁解牛", difficulty: 10 },
        { category: ["map"], id: "geo-lines", ts: !1, tags: [], title: "Migration", titleCN: "模拟迁徙", difficulty: 10 },
        {
          category: ["map"],
          id: "geo-map-scatter",
          ts: !1,
        ...
        { category: ["map"], id: "geo-organ", ts: !1, tags: [], title: "Organ Data with SVG", titleCN: "内脏数据（SVG）", difficulty: 10 },
        {
          category: ["map"],
        ...
        { category: ["map"], id: "geo-svg-lines", ts: !0, tags: [], title: "GEO SVG Lines", titleCN: "GEO 路径图（SVG）", difficulty: 10 },
        { category: ["map"], id: "geo-svg-map", ts: !0, tags: [], title: "GEO SVG Map", titleCN: "地图（SVG）", difficulty: 10 },
        {
          category: ["map"],
        ...
        { category: ["map"], id: "geo-svg-traffic", ts: !0, tags: [], title: "GEO SVG Traffic", titleCN: "交通（SVG）", difficulty: 10 },
        { category: ["graphic"], id: "graphic-wave-animation", ts: !1, tags: [], title: "Wave Animation", titleCN: null, difficulty: 10 },
        {
          category: ["line"],
          id: "line-polar",
          ts: !0,
        ...
        { category: ["map"], id: "map-bin", ts: !1, tags: ["bmap"], title: "Binning on Map", titleCN: "Binning on Map", difficulty: 10 },
        {
          category: ["map"],
          id: "map-HK",
          ts: !0,
        ...
        { category: ["pictorialBar"], id: "pictorialBar-spirit", ts: !0, tags: [], title: "Spirits", titleCN: "精灵", difficulty: 10 },
        {
          category: ["pictorialBar"],
        ...
        { category: ["radar"], id: "radar-multiple", ts: !0, tags: [], title: "Multiple Radar", titleCN: "多雷达图", difficulty: 10 },
        {
          category: ["scatter"],
          id: "scatter-map",
          ts: !1,
        ...
        { category: ["themeRiver"], id: "themeRiver-basic", ts: !0, tags: [], title: "ThemeRiver", titleCN: "主题河流图", difficulty: 10 },
        {
          category: ["themeRiver"],
        ...
        { category: ["tree"], id: "tree-legend", ts: !0, tags: [], title: "Multiple Trees", titleCN: "多棵树", difficulty: 10 },
        {
          category: ["tree"],
        ...
        { category: ["tree"], id: "tree-radial", ts: !0, tags: [], title: "Radial Tree", titleCN: "径向树状图", difficulty: 10 },
        {
          category: ["tree"],
          id: "tree-vertical",
          ts: !0,
        ...
        { category: ["treemap"], id: "treemap-disk", ts: !0, tags: [], title: "Disk Usage", titleCN: "磁盘占用", difficulty: 10 },
        {
          category: ["treemap"],
        ...
        { category: ["treemap"], id: "treemap-simple", ts: !0, tags: [], title: "Basic Treemap", titleCN: "基础矩形树图", difficulty: 10 },
        {
          category: ["treemap"],
          id: "treemap-visual",
          ts: !0,
      ...
      pe = [
        ...
        { category: ["bar3D"], id: "bar3d-myth", ts: !1, tags: [], title: "Bar3D - Myth", titleCN: "星云", difficulty: 10 },
        {
          category: ["bar3D"],
        ...
        { category: ["geo3D"], id: "geo3d", ts: !1, tags: [], title: "Geo3D", titleCN: "Geo3D", difficulty: 10 },
        {
          category: ["geo3D"],
        ...
        { category: ["globe"], id: "globe-layers", ts: !1, tags: [], title: "Globe Layers", titleCN: "Globe Layers", difficulty: 10 },
        { category: ["globe"], id: "globe-moon", ts: !1, tags: [], title: "Moon", titleCN: "Moon", difficulty: 10 },
        {
          category: ["globe"],
        ...
        { category: ["bar3D"], id: "image-to-bar3d", ts: !1, tags: [], title: "Image to Bar3D", titleCN: "Image to Bar3D", difficulty: 10 },
        { category: ["globe"], id: "iron-globe", ts: !1, tags: [], title: "Iron globe", titleCN: "Iron globe", difficulty: 10 },
        {
          category: ["line3D"],
        ...
        { category: ["lines3D"], id: "lines3d-flights", ts: !1, tags: [], title: "Flights", titleCN: "Flights", difficulty: 10 },
        { category: ["lines3D"], id: "lines3d-flights-gl", ts: !1, tags: [], title: "Flights GL", titleCN: "Flights GL", difficulty: 10 },
        {
          category: ["lines3D"],
        ...
        { category: ["map3D"], id: "map3d-buildings", ts: !1, tags: [], title: "Buildings", titleCN: "Buildings", difficulty: 10 },
        { category: ["map3D"], id: "map3d-wood-city", ts: !1, tags: [], title: "Wood City", titleCN: "Wood City", difficulty: 10 },
        { category: ["map3D"], id: "map3d-wood-map", ts: !1, tags: [], title: "木质世界地图", titleCN: "木质世界地图", difficulty: 10 },
        { category: ["bar3D"], id: "metal-bar3d", ts: !1, tags: [], title: "Metal Bar3D", titleCN: "Metal Bar3D", difficulty: 10 },
        { category: ["surface"], id: "metal-surface", ts: !1, tags: [], title: "Metal Surface", titleCN: "Metal Surface", difficulty: 10 },
        {
          category: ["surface"],
        ...
        { category: ["bar3D"], id: "stacked-bar3d", ts: !1, tags: [], title: "Stacked Bar3D", titleCN: "Stacked Bar3D", difficulty: 10 },
        { category: ["surface"], id: "surface-breather", ts: !1, tags: [], title: "Breather", titleCN: "Breather", difficulty: 10 },
        {
          category: ["surface"],
        ...
        { category: ["surface"], id: "surface-leather", ts: !1, tags: [], title: "Leather Material", titleCN: "皮革材质", difficulty: 10 },
        {
          category: ["surface"],
        ...
        { category: ["surface"], id: "surface-wave", ts: !1, tags: [], title: "Surface Wave", titleCN: "Surface Wave", difficulty: 10 },
        {
          category: ["bar3D"],
    ...
    let fe = (e) => crypto.getRandomValues(new Uint8Array(e));
    var he,
      me = ((e, t = 21) =>
        ((e, t, n) => {
        ...
        })("1234567890abcdefghijklmnopqrstuvwxyz", t, fe))(0, 10),
      ge = /PR-(\d+)(?:@(\w+))?/i,
      Ce = ie.version && ie.version.match(ge),
      ye = {
        echartsVersion: ie.version || "5",
        isPR: !!Ce,
        prNumber: Ce && Ce[1],
        prLatestCommit: Ce && Ce[2],
        cdnRoot: "",
        version: "",
        locale: "",
        theme: "light" === ie.theme ? null : ie.theme,
        darkMode: "dark" === ie.theme,
        enableDecal: "decal" in ie,
        renderer: ((he = ie.renderer && ie.renderer.toLowerCase()), he && ["canvas", "svg"].includes(he) ? he : "canvas"),
        typeCheck: be() && be().ts && "ts" === (ie.lang || "").toLowerCase(),
        useDirtyRect: "useDirtyRect" in ie,
        initialCode: "",
        runCode: "",
        sourceCode: "",
        isSharedCode: !1,
        ...
        randomSeed: ie.random || "echarts",
      };
    function ve(e) {
      return ie.c === e.id;
    }
    function be() {
      return de.concat(pe).find(ve);
    }
    var we = "echarts-examples-code",
      _e = "__CODE_CHANGED__";
    function Le() {
      var e = (function () {
        try {
          return JSON.parse(Te(localStorage.getItem(we)));
        } catch (e) {
          return null;
        }
      })();
      return e
        ? (localStorage.removeItem(we), e.codeModified && (ye.initialCode = _e), Promise.resolve(e.code))
        : new Promise(function (e, t) {
            ...
            if (r)
              try {
                return (
                  (r = "base64" === ie.enc ? ((n = r), decodeURIComponent(escape(window.atob(n)))) : Te(r)),
                  (ye.isSharedCode =
                    !(function () {
                      try {
                        return window.opener && "https://echarts.apache.org" === window.opener.origin;
                      } catch (e) {}
                    })() && !!r),
                  (window.opener = null),
                  r ? e(r) : t("code was decompressed but got nothing")
                );
              } catch (e) {
                return console.error(e), t("failed to decompress code");
              }
            var i = "gl" in ie ? "gl/" : "",
    ...
    function ke(e) {
      return Promise.all(
        e.map(function (e) {
          if (("string" == typeof e && (e = { url: e, type: e.match(/\.css$/) ? "css" : "js" }), Se[e.url])) return Se[e.url];
    ...
    function Ne(e) {
      return (function () {
        if ("undefined" == typeof prettier || "undefined" == typeof prettierPlugins) {
          var e = ae(ye.locale);
          return ke([e.prettierDir + "/standalone.js", e.prettierDir + (ye.typeCheck ? "/parser-typescript.js" : "/parser-babel.js")]);
        }
        return Promise.resolve();
      })().then(function () {
        return prettier.format(e, {
          singleQuote: !0,
          tabWidth: 2,
          printWidth: 80,
          semi: !0,
          trailingComma: "none",
          parser: ye.typeCheck ? "typescript" : "babel",
          plugins: prettierPlugins,
        });
      });
    }
    function Oe(e) {
      if (e && (e = e.trim())) return (0, Ee.compressToBase64)(e).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/, "");
    }
    function Te(e) {
      if (e && (e = e.trim())) return (0, Ee.decompressFromBase64)(e.replace(/\-/g, "+").replace(/_/g, "/"));
    }
    const Me = {
      props: ["initialCode"],
      data: function () {
        return { shared: ye, loading: !1 };
      },
      mounted: function () {
        var e = this;
        (this.loading = !0),
          (function () {
            if ("undefined" == typeof ace) {
              var e = ae(ye.locale);
              return ke([e.aceDir + "/ace.js", e.aceDir + "/ext-language_tools.js"]).then(function () {
                var e = ace.require("ace/ext/language_tools"),
                  t = [];
                te.forEach(function (e) {
                  t.push({ caption: e.name, value: e.name, score: e.count, metal: "local" });
                }),
                  e.addCompleter({
                    getCompletions: function (e, n, r, i, a) {
                      a(null, t);
                    },
                  });
              });
            ...
            t.getSession().setMode("ace/mode/javascript"),
              t.setOptions({ enableBasicAutocompletion: !0, enableSnippets: !0, tabSize: 2, enableLiveAutocompletion: !0 }),
              (e._editor = t),
              t.on("change", function () {
                ye.sourceCode = ye.runCode = t.getValue();
              }),
              e.initialCode && e.setInitialCode(e.initialCode),
              (e.loading = !1);
          });
      },
      methods: {
        setInitialCode: function (e) {
          this._editor &&
            e &&
            (this._editor.setValue(e || ""),
            this._editor.selection.setSelectionRange({ start: { row: 1, column: 4 }, end: { row: 1, column: 4 } }));
        },
      },
      watch: {
        initialCode: function (e) {
          this.setInitialCode(e);
        },
      },
    };
    ...
    const Re = Pe(Me, ee, [], !1, null, null, null).exports;
    var De = function () {
      var e = this,
        t = e.$createElement;
      return (e._self._c || t)("div", {
    ...
    const Ie = Pe(
      {
        ...
        mounted: function () {
          ...
          (this.loading = !0),
            (function () {
              if ("undefined" == typeof monaco) {
                var e = ae(ye.locale);
                return ke([e.monacoDir + "/loader.js", ye.cdnRoot + "/js/example-transform-ts-bundle.js"]).then(function () {
                  return (
                    window.require.config({
                      paths: { vs: e.monacoDir },
                      "vs/nls": { availableLanguages: { "*": "zh" === ye.locale ? "zh-cn" : void 0 } },
                    }),
                      ...
                      window.require(["vs/editor/editor.main"], function () {
                        (function () {
                          ...
                          return fetch(
                            ("local" in ie
                              ? e.localEChartsDir
                              : e[ye.echartsVersion.indexOf("dev") > -1 ? "echartsNightlyDir" : "echartsDir"].replace(
                                  "{{version}}",
                                  ye.echartsVersion
                            ...
                            .then(function (e) {
                              var t = monaco.languages.typescript,
                                n = t.typescriptDefaults;
                              n.setDiagnosticsOptions({ noSemanticValidation: !1, noSyntaxValidation: !1 }),
                                n.setCompilerOptions({ target: t.ScriptTarget.ES6, allowNonTsExtensions: !0, noResolve: !1 }),
                                n.addExtraLib(e, "file:///node_modules/@types/echarts/echarts.d.ts"),
                                n.addExtraLib(
              ...
              var t = monaco.editor.createModel(e.initialCode || "", "typescript", monaco.Uri.parse("file:///main.ts")),
                n = monaco.editor.create(e.$el, {
                  model: t,
              ...
              (e._editor = n),
                e.initialCode && ((ye.sourceCode = e.initialCode), (ye.runCode = echartsExampleTransformTs(ye.sourceCode))),
                n.onDidChangeModelContent(function () {
                  (ye.sourceCode = n.getValue()), (ye.runCode = echartsExampleTransformTs(ye.sourceCode));
                }),
                (e.loading = !1),
                e.$emit("ready");
            });
          ...
          setInitialCode: function (e) {
            this._editor &&
              ...
              (this._editor.executeEdits("replace", [
                { identifier: "delete", range: new monaco.Range(1, 1, 1e4, 1), text: "", forceMoveMarkers: !0 },
              ]),
              this._editor.executeEdits("replace", [
                { identifier: "insert", range: new monaco.Range(1, 1, 1, 1), text: e, forceMoveMarkers: !0 },
              ]),
    ...
    const je = Pe(
      {
        ...
        mounted: function () {
          var e = this;
          (this.loading = !0),
            ("undefined" == typeof ace ? ke([ae(ye.locale).aceDir + "/ace.js"]) : Promise.resolve()).then(function () {
              e.loading = !1;
              var t = ace.edit(e.$el);
              t.getSession().setMode(ye.typeCheck ? "ace/mode/typescript" : "ace/mode/javascript"),
                t.setOptions({ readOnly: !0, showLineNumbers: !1, showFoldWidgets: !1, highlightActiveLine: !1, highlightGutterLine: !1 }),
    ...
    var Fe = function () {
      var e = this,
        t = e.$createElement,
        n = e._self._c || t;
      return n("div", { class: [e.inEditor && !e.shared.isMobile ? "" : "full"] }, [
        n("div", {
          directives: [{ name: "loading", rawName: "v-loading", value: e.loading, expression: "loading" }],
          ref: "chartPanel",
        ...
        n("div", { attrs: { id: "tool-panel" } }, [
          n(
            ...
            [
              n("el-switch", {
                ...
                attrs: { "active-color": "#181432", "active-text": e.$t("editor.darkMode"), "inactive-text": "" },
                model: {
                  value: e.shared.darkMode,
                  callback: function (t) {
                    e.$set(e.shared, "darkMode", t);
                  },
              ...
              e.isGL
                ...
                : n("el-switch", {
                    ...
                    attrs: { "active-text": e.$t("editor.enableDecal"), "inactive-text": "" },
                    model: {
                      value: e.shared.enableDecal,
                      callback: function (t) {
                        e.$set(e.shared, "enableDecal", t);
                      },
                      expression: "shared.enableDecal",
                    },
                  }),
              e._v(" "),
              e.isGL || (e.shared.isMobile && e.hasRandomData)
                ? e._e()
                : n("el-popover", { attrs: { placement: "bottom", trigger: "click" } }, [
                    n(
                      "div",
                      ...
                      [
                        n(
                          "div",
                          { staticClass: "cfg-renderer" },
                          [
                            n("label", { staticClass: "tool-label" }, [e._v(e._s(e.$t("editor.renderer")))]),
                            e._v(" "),
                            n(
                              "el-radio-group",
                              {
                                ...
                                attrs: { size: "mini" },
                                model: {
                                  value: e.shared.renderer,
                                  callback: function (t) {
                                    e.$set(e.shared, "renderer", t);
                                  },
                                  expression: "shared.renderer",
                                },
                              },
                              [
                                n("el-radio-button", { attrs: { label: "svg" } }),
                                e._v(" "),
                                n("el-radio-button", { attrs: { label: "canvas" } }),
                              ],
                              1
                            ),
                          ],
                        ...
                        e._v(" "),
                        "canvas" === e.shared.renderer
                          ? n("el-switch", {
                              attrs: { "active-text": e.$t("editor.useDirtyRect"), "inactive-text": "" },
                              model: {
                                value: e.shared.useDirtyRect,
                                callback: function (t) {
                                  e.$set(e.shared, "useDirtyRect", t);
                                },
                    ...
                    n(
                      "span",
                      { staticClass: "render-config-trigger", attrs: { slot: "reference" }, slot: "reference" },
                      [
                        n("el-button", { attrs: { size: "mini" } }, [
                          e._v("\n            " + e._s(e.$t("editor.renderCfgTitle"))),
                          n("i", { staticClass: "el-icon-setting el-icon--right" }),
                        ]),
                      ],
                      1
                    ),
              ...
              e._v(" "),
              e.hasRandomData
                ? n("el-button", { staticClass: "random", attrs: { size: "mini" }, on: { click: e.changeRandomSeed } }, [
                    e._v(e._s(e.$t("editor.randomData"))),
                  ])
                : e._e(),
              e._v(" "),
              e.shared.echartsVersion && !e.shared.isMobile
                ? n(
                    "el-select",
                    {
                      staticClass: "version-select",
                      class: { "is-nightly": e.nightly, "is-pr": e.shared.isPR || e.hasPRVersion },
                      attrs: { size: "mini", id: "choose-echarts-version" },
                      on: { change: e.changeVersion },
                      model: {
                        value: e.shared.echartsVersion,
                        callback: function (t) {
                          e.$set(e.shared, "echartsVersion", t);
                        },
                        expression: "shared.echartsVersion",
                      },
                    },
                    e._l(e.versionList, function (t) {
                      return n("el-option", { key: t, attrs: { label: t, value: t } }, [e._v("\n          " + e._s(t) + "\n        ")]);
                    }),
                    1
                  )
                : e._e(),
              e._v(" "),
              e.inEditor && !e.shared.isMobile
                ? n(
                    "el-checkbox",
                    {
                      staticClass: "use-nightly",
                      model: {
                        value: e.nightly,
                        callback: function (t) {
                          e.nightly = t;
          ...
          e.inEditor
            ? e._e()
            : n("a", { staticClass: "edit btn btn-sm", attrs: { href: e.editLink, target: "_blank" } }, [e._v(e._s(e.$t("editor.edit")))]),
        ]),
        e._v(" "),
        n("div", { attrs: { id: "preview-status" } }, [
          n(
            "div",
              ...
              e.inEditor && !e.shared.isMobile
                ? [
                    n(
                      "el-button",
                      {
                        attrs: { icon: "el-icon-download", size: "mini", title: e.$t("editor.download") + " (HTML)" },
                        on: { click: e.download },
                      },
                      [e._v("\n          " + e._s(e.$t("editor.download")) + "\n        ")]
                    ),
                    e._v(" "),
                    n("el-button", { attrs: { icon: "el-icon-camera-solid", size: "mini" }, on: { click: e.screenshot } }, [
                      e._v("\n          " + e._s(e.$t("editor.screenshot")) + "\n        "),
                    ]),
                    e._v(" "),
                    n(
                      "el-button",
                      { attrs: { icon: "el-icon-share", size: "mini", title: e.$t("editor.share.tooltip") }, on: { click: e.share } },
          ...
          e._v(" "),
          e.inEditor && !e.shared.isMobile && e.shared.editorStatus.message
            ? n("div", { attrs: { id: "run-log" } }, [
                n("span", { staticClass: "run-log-time" }, [e._v(e._s(e.shared.editorStatus.time))]),
                e._v(" "),
                n("span", { class: "run-log-type-" + e.shared.editorStatus.type }, [e._v(e._s(e.shared.editorStatus.message))]),
              ])
            : e._e(),
        ]),
      ]);
    ...
    function Je(e, t, n, r, i, a, o, s) {
      var l = ae(ye.locale);
      t = [l.jQueryJS, l.seedrandomJS, l.acornJS]
        .map(function (e) {
          return { src: e };
        })
        .concat(
          ...
          (function (e) {
            return [
              ...
              [
                ...
                "("
                  .concat(
                    'function setup(e){var t=function(e){return parent.postMessage(e,"*")},n=document.head.querySelector("#chart-styles"),o=[],r=[],i=window.setTimeout,a=window.setInterval;function c(e,t){var n=i(e,t);return r.push(n),n}function s(e,t){var n=a(e,t);return o.push(n),n}var d,u,l=[];var p,h,f={};e&&(h=["addEventListener","removeEventListener","atob","btoa","fetch","getComputedStyle"].reduce((function(e,t){var n=window[t];return e[t]=echarts.util.isFunction(n)?n.bind(window):n,e}),{location:Object.freeze(JSON.parse(JSON.stringify(location))),document:function(){var e=["script","video","audio","iframe","frame","frameset","embed","object","foreignobject"],t=new RegExp("<(".concat(e.join("|"),").*>")),n={innerHTML:Object.getOwnPropertyDescriptor(Element.prototype,"innerHTML").set,outerHTML:Object.getOwnPropertyDescriptor(Element.prototype,"outerHTML").set,innerText:Object.getOwnPropertyDescriptor(HTMLElement.prototype,"innerText").set,outerText:Object.getOwnPropertyDescriptor(HTMLElement.prototype,"outerText").set};["inner","outer"].forEach((function(e){var o=e+"HTML";Object.defineProperty(Element.prototype,o,{set:function(r){return(t.test(r)?n[e+"Text"]:n[o]).call(this,r)}})}));var o=document.cloneNode();return[["write",document.write,0,!0],["writeln",document.writeln,0,!0],["createElement",document.createElement,0],["createElementNS",document.createElementNS,1]].forEach((function(n){var r=n[1],i=n[2],a=n[3];o[n[0]]=function(){var n=arguments[i];return n&&(n=n.toLowerCase()),n&&(a?n=(n=n.match(t))&&n[1]:e.includes(n))?console.error("Disallowed attempting to create ".concat(n," element!")):r.apply(document,arguments)}})),o}(),history:void 0,parent:void 0,top:void 0,setTimeout:c,setInterval:s}),["innerHeight","outerHeight","innerWidth","outerWidth","devicePixelRatio","screen"].forEach((function(e){Object.defineProperty(h,e,{get:function(){return window[e]}})})),h.self=h.window=h.globalThis=h);var m={dispose:function(){u&&(u.dispose(),u=null,d=null)},screenshot:function(e){var t=e.filename,n=u.getDataURL({excludeComponents:["toolbox"]}),o=document.createElement("a");o.download=t,o.target="_blank",o.href=n,o.click()},run:function(i){var a,m,v,g=i.store;if(i.recreateInstance||!u||u.isDisposed()){if(this.dispose(),u=echarts.init(document.getElementById("chart-container"),g.darkMode?"dark":g.theme,{renderer:g.renderer,useDirtyRect:g.useDirtyRect}),g.useDirtyRect&&"canvas"===g.renderer)try{showDebugDirtyRect(u.getZr(),{autoHideDelay:500})}catch(e){console.error("failed to show debug dirty rect",e)}window.addEventListener("resize",(function(){u.resize(),echarts.util.isFunction(f.onresize)&&f.onresize()})),m=(a=u).on,v=a.setOption,a.on=function(e){var t=m.apply(a,arguments);return l.push(e),t},a.setOption=function(){var e=performance.now(),n=v.apply(this,arguments),o=performance.now();return t({evt:"optionUpdated",option:JSON.stringify(a.getOption(),(function(e,t){return echarts.util.isFunction(t)||"bigint"==typeof t?t.toString():t})),updateTime:o-e}),n}}o.forEach(clearInterval),r.forEach(clearTimeout),o.length=0,r.length=0,function(e){e&&l.forEach(e.off.bind(e)),l.length=0}(u),f={},d=g;try{var w,y=g.runCode.replace(/Math.random\\([^)]*\\)/g,"__ECHARTS_EXAMPLE_RANDOM__()"),E=new Math.seedrandom(g.randomSeed),b="var css, option;"+handleLoop(y)+"\\nreturn [option, css];";w=e?new Function("myChart","app","setTimeout","setInterval","ROOT_PATH","__ECHARTS_EXAMPLE_RANDOM__","top","parent","window","self","globalThis","document","location","history","eval","execScript","Function",b).bind(h)(u,f,c,s,g.cdnRoot,E,void 0,void 0,h,h,h,h.document,h.location,void 0,void 0,void 0,void 0):new Function("myChart","app","setTimeout","setInterval","ROOT_PATH","__ECHARTS_EXAMPLE_RANDOM__",b)(u,f,c,s,g.cdnRoot,E);var T=n.textContent=w[1]||"";t({evt:"cssParsed",css:T});var O=w[0];echarts.util.isObject(O)&&u.setOption(O,!0)}catch(e){u.__flagInMainProcess=!1,console.error("failed to run code",e),t({evt:"codeError",message:e.message})}if(p&&($(p.domElement).remove(),p.destroy(),p=null),f.config){p=new dat.GUI({autoPlace:!1}),$(p.domElement).css({position:"absolute",right:0,top:0,zIndex:1e3}),document.body.append(p.domElement);var _=f.configParameters||{},C=f.config;for(var L in C){var M=C[L];if("onChange"!==L&&"onFinishChange"!==L){var R=void 0,D=void 0,P=_[L];if(P&&(P.options?D=p.add(C,L,P.options):null!=P.min&&(D=p.add(C,L,P.min,P.max))),"string"==typeof M)try{var H=echarts.color.parse(M);(R=!!H)&&(M=echarts.color.stringify(H,"rgba"))}catch(e){}D||(D=p[R?"addColor":"add"](C,L)),C.onChange&&D.onChange(C.onChange),C.onFinishChange&&D.onFinishChange(C.onFinishChange)}}}}};echarts.registerPreprocessor((function(e){d.enableDecal&&(e.aria=e.aria||{},e.aria.decal=e.aria.decal||{},e.aria.decal.show=!0,e.aria.show=e.aria.enabled=!0)})),window.addEventListener("message",(function(e){var t=e.data.action;delete e.data.action,"function"==typeof m[t]&&m[t].apply(m,[e.data])}),!1),window.addEventListener("error",(function(){t({evt:"error"})})),window.addEventListener("unhandledrejection",(function(){t({evt:"unhandledRejection"})}))}',
                    ")("
                  )
                  .concat(e, ")"),
                "})()",
      ...
      var c,
        ...
        p = ["allow-pointer-lock", "allow-scripts", "allow-downloads", "allow-same-origin"];
      function f(e) {
        if (e.source === d.contentWindow) {
          var t = e.data;
          switch (t.evt) {
            case "optionUpdated":
              (d.chartOption = JSON.parse(t.option)), o(t.updateTime);
              break;
            case "codeError":
              a(t.message);
              break;
      ...
      return (
        n || p.push("allow-popups", "allow-popups-to-escape-sandbox", "allow-modals"),
        d.setAttribute("sandbox", p.join(" ")),
        n &&
          ((c = {
            "default-src": ["'self'", "'unsafe-inline'", "'unsafe-eval'", "data:", "blob:"].concat(
              ((u = [
                "*.apache.org",
                "*.jsdelivr.net",
                "*.jsdelivr.com",
              ...
              ye.isPR && u.push("echarts-pr-".concat(ye.prNumber, ".surge.sh")),
              u).map(function (e) {
                return "https://" + e;
              })
            ),
        ...
        (d.srcdoc = Ge()
          ...
          .replace(
            ...
            t
              .map(function (e) {
                return e.content ? "<script>".concat(e.content, "</script>") : '<script src="'.concat(e.src, '"></script>');
              })
              .join("")
          )),
        (d.style.cssText = "width:100%;height:100%;border:none;background:none"),
        (d.onload = function () {
          if (d.__loaded__ && n) {
            var e = "potential redirection from the code was blocked";
            return console.error(e), a(e), void i();
          }
          (d.__loaded__ = !0), r();
        }),
        (d.onerror = i),
        ...
        {
          dispose: function () {
            h("dispose"), window.removeEventListener("message", f), e.removeChild(d);
          },
          run: function (e, t) {
            h("run", { store: e, recreateInstance: t });
          },
          screenshot: function (e) {
            h("screenshot", { filename: e });
          },
          getOption: function () {
            return d.chartOption;
          },
        }
      );
    }
      ...
      return (
        Object.entries(e).forEach(function (e) {
          var t = (function (e, t) {
            ...
            r = t[0],
            i = t[1];
          return null == i ? n.searchParams.delete(r) : n.searchParams.set(r, i);
        }),
        t ? n : n.toString()
      );
    }
    function et(e, t) {
      t ? history.pushState({}, "", Ye(e)) : (location.href = Ye(e));
    }
    var tt = n(9589);
    function nt(e, t) {
      var n = Object.keys(e);
    ...
    var st = be(),
      lt = "gl" in ie || pe.find(ve),
      ct = "local" in ie,
      ut = "debug" in ie,
      dt = st && st.tags.indexOf("bmap") >= 0;
    function pt(e) {
      return ut || ct ? e.replace(".min.", ".") : e;
    }
    function ft(e, t) {
      "warn" !== t && "error" !== t && (t = "info");
      var n = new Date();
      (ye.editorStatus.time = [n.getHours(), n.getMinutes(), n.getSeconds()]
        .map(function (e) {
          return (e + "").padStart(2, "0");
        })
        .join(":")),
        (ye.editorStatus.message = e),
        (ye.editorStatus.type = t);
    }
    const ht = {
        props: { inEditor: { type: Boolean } },
        data: function () {
          return {
            shared: ye,
        ...
        mounted: function () {
          this.run(), this.fetchVersionList();
        },
        computed: {
          hasRandomData: function () {
            return this.shared.runCode && this.shared.runCode.indexOf("Math.random()") >= 0;
          },
          editLink: function () {
            return "./editor.html" + this.getSharableURL(!0).search;
          },
          versionList: function () {
            return this.nightly ? this.nightlyVersions : this.allEChartsVersions;
          },
          isNightlyVersion: function () {
            return ye.echartsVersion && ye.echartsVersion.indexOf("dev") > -1;
          },
          toolOptions: function () {
            var e = "canvas" === ye.renderer;
            return {
              renderer: e ? null : ye.renderer,
              useDirtyRect: ye.useDirtyRect && e ? 1 : null,
              decal: ye.enableDecal ? 1 : null,
              theme: ye.darkMode ? "dark" : ye.theme || null,
            };
          },
        },
        watch: {
          "shared.runCode": function () {
            (!this.autoRun && this.sandbox) ||
              (this.debouncedRun
                ? this.debouncedRun()
                : (this.run(),
                  ye.isSharedCode && this.showShareHint(),
                  ye.isPR && !this.prHintTimer && (this.prHintTimer = setTimeout(this.showPRHint, ye.isSharedCode ? 1e3 : 0))));
          },
          toolOptions: { handler: "refresh", deep: !0 },
          isNightlyVersion: {
            handler: function (e) {
              this.nightly = e;
            },
        ...
        methods: {
          run: function e(t) {
            ...
            if (ye.runCode) {
              var r = function () {
                  n.sandbox.run(ye, t), (ye.runHash = Ae++);
                },
                i = (function (e) {
                  var t = ae(ye.locale),
                  ...
                  return ["/examples/js/" + pt(t.echartsJS) + (ye.isPR ? "?_=" + (ye.prLatestCommit || Date.now()) : "")]
                    .concat(
                      ...
                      at(dt || /coordinateSystem.*:.*['"]bmap['"]/g.test(i) ? [t.bmapLibJS, pt(t.echartsBMapJS)] : []),
                      at(i.indexOf("ecStat") > -1 ? [pt(t.echartsStatJS)] : []),
                      at(i.indexOf("graph") > -1 && i.indexOf("modularity") > -1 ? [pt(t.echartsGraphModularityJS)] : []),
                      at(/map.*:.*['"]world['"]/g.test(i) ? [t.echartsWorldMapJS] : []),
                      at(i.indexOf("app.config") > -1 ? [t.datGUIMinJS] : [])
                    )
                    .map(function (e) {
                      return { src: e };
                    });
                ...
                o =
                  ...
                  i.some(function (e) {
                    return (
                      !a.test(e.src) &&
                      -1 ===
                        n.scripts.findIndex(function (t) {
                          return t.src === e.src;
                        })
                    );
                  });
              if (!this.sandbox || o) {
                ...
                this.dispose(),
                  (this.sandbox = Je(
                    ...
                    function () {
                      console.error("failed to run sandbox"), (n.loading = !1), n.dispose();
                    },
                    function (e) {
                      var t = e && e.indexOf("loop executes") > -1,
                        r = e && e.indexOf("potential redirection") > -1;
                      ft(
                        n.$t("editor.".concat(t ? "infiniteLoopInEditor" : r ? "potentialRedirectionInEditor" : "errorInEditor")),
                        "error"
                      );
                    },
                    function (t) {
                      var r = n.getOption();
                      "string" == typeof r.backgroundColor && "transparent" !== r.backgroundColor
                        ? (n.backgroundColor = r.backgroundColor)
                        : (n.backgroundColor = "#fff"),
                        ft(n.$t("editor.chartOK") + t.toFixed(2) + "ms");
                      for (var i = [0, 500, 2e3, 5e3, 1e4], a = i.length - 1; a >= 0; a--) {
                        var o = i[a + 1] || 1e6;
                        if (t >= i[a] && n.debouncedTime !== o) {
                          (n.debouncedRun = Xe()(e, o, { trailing: !0 })), (n.debouncedTime = o);
                          break;
                        }
                      }
                      s && (n.$emit("ready"), (s = !1));
          ...
          refreshAll: function () {
            (this.scripts = null), this.run(!0);
          },
          dispose: function () {
            this.sandbox && (this.sandbox.dispose(), (this.sandbox = null));
          },
          download: function () {
            var e = this.getSharableURL(!0),
              t = ye.isSharedCode || e.searchParams.has("code"),
              n = ["\t".concat(this.$t("editor.downloadSourceTip"), " ").concat(e.toString())];
            t && n.push("\t⚠ " + this.$t("editor.share.hint")),
              (function (e) {
                var t = ae(ye.locale),
                  n = ye.sourceCode.indexOf("ROOT_PATH") > -1 ? "var ROOT_PATH = '".concat(ye.cdnRoot, "';") : "",
                  r = !1 === ye.locale ? "zh-CN" : "en",
                  i = /\$[\.\(]+/g.test(ye.sourceCode) ? '<script type="text/javascript" src="'.concat(t.jQueryJS, '"></script>') : "",
                  a = t[ye.echartsVersion.indexOf("dev") > -1 ? "echartsNightlyDir" : "echartsDir"].replace(
                    "{{version}}",
                    ye.echartsVersion
                  ),
                  o = t.echartsDir.replace("{{version}}", "4.9.0"),
                  s =
                    !ye.darkMode && ye.theme
                      ? '\x3c!-- theme --\x3e\n  <script type="text/javascript" src="'
                          .concat(a, "/theme/")
                          .concat(ye.theme, '.js"></script>')
                      : "",
                  l = "\x3c!--\n"
                    .concat(e, '\n--\x3e\n<!DOCTYPE html>\n<html lang="')
                    .concat(
                    ...
                    .concat(ye.darkMode ? "'dark'" : ye.theme ? "'".concat(ye.theme, "'") : "null", ", {\n      renderer: '")
                    .concat(ye.renderer, "',\n      useDirtyRect: ")
                    .concat(ye.useDirtyRect, "\n    });\n    var app = {};\n    ")
                    .concat(n, "\n    var option;\n\n    ")
                    .concat(
                      ye.sourceCode,
                ...
                !(function (e, t) {
                  if ("function" == typeof window.navigator.msSaveBlob) window.navigator.msSaveOrOpenBlob(e, t);
                  else {
                    var n = document.createElement("a");
                    (n.href = URL.createObjectURL(e)), (n.download = t), n.click(), URL.revokeObjectURL(n.href);
                  }
                })(new Blob([l], { type: "text/html;charset=UTF-8", encoding: "UTF-8" }), (ie.c || Date.now()) + ".html");
              })(n.join("\n"));
          },
          screenshot: function () {
            this.sandbox && this.sandbox.screenshot((ie.c || Date.now()) + "." + ("svg" === ye.renderer ? "svg" : "png"));
          },
          showPRHint: function () {
            this.$message({
              type: "warning",
              message: this.$t("editor.pr.hint").replace("{{PR}}", ye.prNumber),
          ...
          getSharableURL: function (e) {
            var t = {};
            return (
              ye.initialCode !== ye.sourceCode && ((t.code = Oe(ye.sourceCode)), (t.enc = null)), Ye(rt(rt({}, this.toolOptions), t), e)
            );
          },
          share: function () {
            var e = this;
            if (!e.isShareBusy) {
              e.isShareBusy = !0;
              var t = e.getSharableURL();
              if (t.length < 1e4) return n(t);
              $.ajax({
                url: t,
                method: "HEAD",
                complete: function (r) {
                  ...
                  413 === i || 414 === i || 431 === i
                    ? ((e.isShareBusy = !1),
                      e.$message.closeAll(),
                      e.$message({ type: "error", message: e.$t("editor.share.urlTooLong"), customClass: "toast-declaration" }))
                    : n(t);
                },
              });
            }
            function n(t) {
              navigator.clipboard
                ...
                .then(function () {
                  e.$message.closeAll(),
                    e.$message({ type: "success", message: e.$t("editor.share.success"), customClass: "toast-declaration" });
                })
                .catch(function (e) {
                  console.error("failed to write share url to the clipboard", e), window.open(t, "_blank");
                })
                .finally(function () {
                  e.isShareBusy = !1;
                });
          ...
          changeVersion: function () {
            ...
            localStorage.setItem(
              we,
              Oe(JSON.stringify({ code: ye.sourceCode, codeModified: ye.initialCode !== ye.sourceCode, lang: ye.typeCheck ? "ts" : "js" }))
            ),
              setTimeout(function () {
                (window.__EDITOR_NO_LEAVE_CONFIRMATION__ = !0),
                  et(rt({ version: ye.echartsVersion, pv: ye.isPR ? ie.version : void 0 }, e.toolOptions));
              });
          },
          changeRandomSeed: function () {
            (ye.randomSeed = me()), et({ random: ye.randomSeed }, !0), this.run();
          },
          fetchVersionList: function () {
            var e,
              ...
              r = function (e) {
                return n
                  ? "https://registry.npmmirror.com/-/v1/search?text=".concat(e, "&size=1")
                  : "https://data.jsdelivr.com/v1/package/npm/".concat(e);
              },
              i =
                n &&
                function (e) {
                  return { versions: (e = e.objects[0].package).versions.sort(tt.rcompare), tags: e["dist-tags"] };
                },
              a = ie.pv,
              o = (this.hasPRVersion = ((e = a), ge.test(e)));
            $.getJSON(r("echarts")).done(function (e) {
              n && (e = i(e)), ut && console.log("echarts version data", e);
              var r = e.versions.filter(function (e) {
                return e.indexOf("beta") < 0 && e.indexOf("rc") < 0 && e.indexOf("alpha") < 0 && e.startsWith("5");
              });
              (t.allEChartsVersions = r),
                (ye.echartsVersion && "5" !== ye.echartsVersion && "latest" !== ye.echartsVersion) || (ye.echartsVersion = r[0]),
                (0, tt.gt)(e.tags.rc.split("-")[0], e.tags.latest) &&
                  (r.unshift(e.tags.rc), "rc" === ye.echartsVersion && (ye.echartsVersion = r[0])),
                o && r.unshift(a);
            }),
              $.getJSON(r("echarts-nightly")).done(function (e) {
                n && (e = i(e)), ut && console.log("echarts-nightly version data", e);
                var r = e,
                  s = r.tags,
                  l = s.latest,
                  c = s.next,
                  ...
                  d = u.indexOf(c),
                  p = u.indexOf(l);
                (t.nightlyVersions = u.slice(d, Math.min(d + 10, p)).concat(u.slice(p, p + 10))), o && t.nightlyVersions.unshift(a);
              }),
              ut && console.log("echarts versions", this.allEChartsVersions, "nightly versions", this.nightlyVersions);
          },
          getAssets: function () {
            return { scripts: this.scripts, css: this.css };
          },
        },
      },
      mt = Pe(ht, Fe, [], !1, null, null, null).exports;
    var gt = n(9569);
    function Ct(e, t) {
    ...
    const yt = Ct(
      ...
      vt = Ct("itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly");
    function bt(e) {
      if (jt(e)) {
        const t = {};
        for (let n = 0; n < e.length; n++) {
    ...
    function xt(e) {
      let t = "";
      if (Ut(e)) t = e;
      else if (jt(e)) for (let n = 0; n < e.length; n++) t += xt(e[n]) + " ";
      else if (zt(e)) for (const n in e) e[n] && (t += n + " ");
      return t.trim();
    }
    const At = (e) => (null == e ? "" : zt(e) ? JSON.stringify(e, Et, 2) : String(e)),
      Et = (e, t) =>
        Ft(t)
      ...
      $t = (e, t) => It.call(e, t),
      jt = Array.isArray,
      Ft = (e) => "[object Map]" === Zt(e),
      Bt = (e) => "[object Set]" === Zt(e),
      Gt = (e) => "function" == typeof e,
      Ut = (e) => "string" == typeof e,
      Vt = (e) => "symbol" == typeof e,
      zt = (e) => null !== e && "object" == typeof e,
      Ht = (e) => zt(e) && Gt(e.then) && Gt(e.catch),
      Wt = Object.prototype.toString,
      Zt = (e) => Wt.call(e),
      qt = (e) => "[object Object]" === Zt(e),
      Jt = (e) => Ut(e) && "NaN" !== e && "-" !== e[0] && "" + parseInt(e, 10) === e,
      Qt = Ct(",key,ref,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),
      Xt = (e) => {
        const t = Object.create(null);
        return (n) => t[n] || (t[n] = e(n));
      },
      Kt = /-(\w)/g,
      Yt = Xt((e) => e.replace(Kt, (e, t) => (t ? t.toUpperCase() : ""))),
      en = /\B([A-Z])/g,
      tn = Xt((e) => e.replace(en, "-$1").toLowerCase()),
      nn = Xt((e) => e.charAt(0).toUpperCase() + e.slice(1)),
      rn = Xt((e) => (e ? `on${nn(e)}` : "")),
      an = (e, t) => e !== t && (e == e || t == t),
      on = (e, t) => {
      ...
      const n = (function (e, t) {
        const n = function () {
          ...
          if (!pn.includes(n)) {
            vn(n);
            try {
              return wn.push(bn), (bn = !0), pn.push(n), (fn = n), e();
            } finally {
              pn.pop(), Ln(), (fn = pn[pn.length - 1]);
            }
          }
        };
        return (
    ...
    function Cn(e) {
      e.active && (vn(e), e.options.onStop && e.options.onStop(), (e.active = !1));
    }
    let yn = 0;
    function vn(e) {
      const { deps: t } = e;
    ...
    function xn(e, t, n) {
      if (!bn || void 0 === fn) return;
      let r = dn.get(e);
      r || dn.set(e, (r = new Map()));
      let i = r.get(n);
      i || r.set(n, (i = new Set())), i.has(fn) || (i.add(fn), fn.deps.push(i));
    }
    function An(e, t, n, r, i, a) {
      ...
      const s = new Set(),
        l = (e) => {
          e &&
            e.forEach((e) => {
              (e !== fn || e.allowRecurse) && s.add(e);
            });
        };
      if ("clear" === t) o.forEach(l);
      else if ("length" === n && jt(e))
        o.forEach((e, t) => {
          ("length" === t || t >= r) && l(e);
        });
      else
        switch ((void 0 !== n && l(o.get(n)), t)) {
          case "add":
            jt(e) ? Jt(n) && l(o.get("length")) : (l(o.get(hn)), Ft(e) && l(o.get(mn)));
            break;
          case "delete":
            jt(e) || (l(o.get(hn)), Ft(e) && l(o.get(mn)));
            break;
          case "set":
            Ft(e) && l(o.get(hn));
        }
    ...
    function Mn(e = !1, t = !1) {
      return function (n, r, i) {
        ...
        if ("__v_raw" === r && i === (e ? ar : ir).get(n)) return n;
        const a = jt(n);
        if (!e && a && $t(Tn, r)) return Reflect.get(Tn, r, i);
        const o = Reflect.get(n, r, i);
        return (Vt(r) ? En.has(r) : "__proto__" === r || "__v_isRef" === r)
          ? o
          : (e || xn(n, 0, r), t ? o : hr(o) ? (a && Jt(r) ? o : o.value) : zt(o) ? (e ? sr(o) : or(o)) : o);
      };
    }
    function Pn(e = !1) {
      return function (t, n, r, i) {
        const a = t[n];
        if (!e && ((r = pr(r)), !jt(t) && hr(a) && !hr(r))) return (a.value = r), !0;
        const o = jt(t) && Jt(n) ? Number(n) < t.length : $t(t, n),
          s = Reflect.set(t, n, r, i);
        return t === pr(i) && (o ? an(r, a) && An(t, "set", n, r) : An(t, "add", n, r)), s;
      };
    }
    ["includes", "indexOf", "lastIndexOf"].forEach((e) => {
      ...
      Tn[e] = function (...e) {
        const n = pr(this);
        for (let e = 0, t = this.length; e < t; e++) xn(n, 0, e + "");
        const r = t.apply(n, e);
        return -1 === r || !1 === r ? t.apply(n, e.map(pr)) : r;
      };
    }),
    ...
    const Rn = {
        ...
        deleteProperty: function (e, t) {
          ...
          return r && n && An(e, "delete", t, void 0), r;
        },
        has: function (e, t) {
          const n = Reflect.has(e, t);
          return (Vt(t) && En.has(t)) || xn(e, 0, t), n;
        },
        ownKeys: function (e) {
          return xn(e, 0, jt(e) ? "length" : hn), Reflect.ownKeys(e);
        },
      },
      Dn = { get: Nn, set: (e, t) => !0, deleteProperty: (e, t) => !0 },
      In = Rt({}, Rn, { get: kn, set: Pn(!0) }),
      $n = (Rt({}, Dn, { get: On }), (e) => (zt(e) ? or(e) : e)),
      jn = (e) => (zt(e) ? sr(e) : e),
      Fn = (e) => e,
      Bn = (e) => Reflect.getPrototypeOf(e);
    function Gn(e, t, n = !1, r = !1) {
      const i = pr((e = e.__v_raw)),
        a = pr(t);
      t !== a && !n && xn(i, 0, t), !n && xn(i, 0, a);
      const { has: o } = Bn(i),
        s = n ? jn : r ? Fn : $n;
      return o.call(i, t) ? s(e.get(t)) : o.call(i, a) ? s(e.get(a)) : void 0;
    }
    function Un(e, t = !1) {
      const n = this.__v_raw,
        r = pr(n),
        i = pr(e);
      return e !== i && !t && xn(r, 0, e), !t && xn(r, 0, i), e === i ? n.has(e) : n.has(e) || n.has(i);
    }
    function Vn(e, t = !1) {
      return (e = e.__v_raw), !t && xn(pr(e), 0, hn), Reflect.get(e, "size", e);
    }
    function zn(e) {
      e = pr(e);
      const t = pr(this),
        n = Bn(t).has.call(t, e);
      return t.add(e), n || An(t, "add", e, e), this;
    }
    function Hn(e, t) {
      t = pr(t);
      const n = pr(this),
        { has: r, get: i } = Bn(n);
      let a = r.call(n, e);
      a || ((e = pr(e)), (a = r.call(n, e)));
      const o = i.call(n, e);
      return n.set(e, t), a ? an(t, o) && An(n, "set", e, t) : An(n, "add", e, t), this;
    }
    function Wn(e) {
      const t = pr(this),
        { has: n, get: r } = Bn(t);
      let i = n.call(t, e);
      i || ((e = pr(e)), (i = n.call(t, e))), r && r.call(t, e);
      const a = t.delete(e);
      return i && An(t, "delete", e, void 0), a;
    }
    function Zn() {
      const e = pr(this),
        t = 0 !== e.size,
    ...
    function qn(e, t) {
      return function (n, r) {
        const i = this,
          ...
          o = pr(a),
          s = e ? jn : t ? Fn : $n;
        return !e && xn(o, 0, hn), a.forEach((e, t) => n.call(r, s(e), s(t), i));
      };
    }
    function Jn(e, t, n) {
      return function (...r) {
    ...
    function er(e, t) {
      const n = t ? Kn : e ? Yn : Xn;
      return (t, r, i) =>
        "__v_isReactive" === r ? !e : "__v_isReadonly" === r ? e : "__v_raw" === r ? t : Reflect.get($t(n, r) && r in t ? n : t, r, i);
    }
    ["keys", "values", "entries", Symbol.iterator].forEach((e) => {
      (Xn[e] = Jn(e, !1, !1)), (Yn[e] = Jn(e, !0, !1)), (Kn[e] = Jn(e, !1, !0));
    });
    const tr = { get: er(!1, !1) },
      nr = { get: er(!1, !0) },
      rr = { get: er(!0, !1) },
      ...
      ar = new WeakMap();
    function or(e) {
      return e && e.__v_isReadonly ? e : lr(e, !1, Rn, tr);
    }
    function sr(e) {
      return lr(e, !0, Dn, rr);
    }
    ...
    function cr(e) {
      return ur(e) ? cr(e.__v_raw) : !(!e || !e.__v_isReactive);
    }
    function ur(e) {
    ...
    function pr(e) {
      return (e && pr(e.__v_raw)) || e;
    }
    const fr = (e) => (zt(e) ? or(e) : e);
    function hr(e) {
      return Boolean(e && !0 === e.__v_isRef);
    }
    function mr(e) {
      return (function (e, t = !1) {
        return hr(e) ? e : new gr(e, t);
      })(e);
    }
    class gr {
      constructor(e, t = !1) {
        (this._rawValue = e), (this._shallow = t), (this.__v_isRef = !0), (this._value = t ? e : fr(e));
      }
      get value() {
        return xn(pr(this), 0, "value"), this._value;
      }
      set value(e) {
        an(pr(e), this._rawValue) && ((this._rawValue = e), (this._value = this._shallow ? e : fr(e)), An(pr(this), "set", "value", e));
      }
    }
    const Cr = {
      get: (e, t, n) =>
        (function (e) {
          return hr(e) ? e.value : e;
        })(Reflect.get(e, t, n)),
      set: (e, t, n, r) => {
        const i = e[t];
        return hr(i) && !hr(n) ? ((i.value = n), !0) : Reflect.set(e, t, n, r);
      },
    };
    function yr(e) {
      return cr(e) ? e : new Proxy(e, Cr);
    }
    class vr {
      constructor(e, t) {
      ...
      constructor(e, t, n) {
        (this._setter = t),
          ...
          (this.effect = gn(e, {
            lazy: !0,
            scheduler: () => {
              this._dirty || ((this._dirty = !0), An(pr(this), "set", "value"));
            },
          })),
          (this.__v_isReadonly = n);
      }
      get value() {
        return this._dirty && ((this._value = this.effect()), (this._dirty = !1)), xn(pr(this), 0, "value"), this._value;
      }
      set value(e) {
        this._setter(e);
      }
    ...
    function Lr(e, t, n, r = !0) {
      if ((t && t.vnode, t)) {
        ...
        if (o) return void wr(o, null, 10, [e, i, a]);
      }
      !(function (e, t, n, r = !0) {
        console.error(e);
      })(e, 0, 0, r);
    ...
    function jr(e) {
      (Er.length && Er.includes(e, xr && e.allowRecurse ? Sr + 1 : Sr)) || e === Ir || (Er.push(e), Fr());
    }
    function Fr() {
      xr || Ar || ((Ar = !0), (Dr = Rr.then(zr)));
    }
    function Br(e, t, n, r) {
      jt(e) ? n.push(...e) : (t && t.includes(e, e.allowRecurse ? r + 1 : r)) || n.push(e), Fr();
    }
    function Gr(e, t = null) {
      if (kr.length) {
        for (Ir = t, Nr = [...new Set(kr)], kr.length = 0, Or = 0; Or < Nr.length; Or++) Nr[Or]();
        (Nr = null), (Or = 0), (Ir = null), Gr(e, t);
      }
    }
    function Ur(e) {
      if (Tr.length) {
        const e = [...new Set(Tr)];
        if (((Tr.length = 0), Mr)) return void Mr.push(...e);
        for (Mr = e, Mr.sort((e, t) => Vr(e) - Vr(t)), Pr = 0; Pr < Mr.length; Pr++) Mr[Pr]();
        (Mr = null), (Pr = 0);
      }
    }
    const Vr = (e) => (null == e.id ? 1 / 0 : e.id);
    function zr(e) {
      (Ar = !1), (xr = !0), Gr(e), Er.sort((e, t) => Vr(e) - Vr(t));
      try {
        ...
        (Sr = 0), (Er.length = 0), Ur(), (xr = !1), (Dr = null), (Er.length || Tr.length) && zr(e);
      }
    }
    function Hr(e, t, ...n) {
      ...
      if (o && o in r) {
        const e = `${"modelValue" === o ? "model" : o}Modifiers`,
          { number: t, trim: a } = r[e] || St;
        a ? (i = n.map((e) => e.trim())) : t && (i = n.map(ln));
      }
      __VUE_PROD_DEVTOOLS__;
      let s = rn(Yt(t)),
        l = r[s];
      !l && a && ((s = rn(tn(t))), (l = r[s])), l && _r(l, e, 6, i);
      const c = r[s + "Once"];
      if (c) {
        if (e.emitted) {
    ...
    function Wr(e, t, n = !1) {
      ...
      let i = {},
        a = !1;
      if (__VUE_OPTIONS_API__ && !Gt(e)) {
        const r = (e) => {
          (a = !0), Rt(i, Wr(e, t, !0));
        };
        !n && t.mixins.length && t.mixins.forEach(r), e.extends && r(e.extends), e.mixins && e.mixins.forEach(r);
      }
      return r || a ? (jt(r) ? r.forEach((e) => (i[e] = null)) : Rt(i, r), (e.__emits = i)) : (e.__emits = null);
    }
    function Zr(e, t) {
      return !(!e || !Mt(t)) && ((t = t.slice(2).replace(/Once$/, "")), $t(e, t[0].toLowerCase() + t.slice(1)) || $t(e, tn(t)) || $t(e, t));
    }
    let qr = null;
    function Jr(e) {
      qr = e;
    ...
    function Qr(e) {
      ...
      try {
        ...
        if (4 & n.shapeFlag) {
          const t = i || r;
          (m = pa(u.call(t, t, d, a, f, p, h))), (e = l);
        } else {
          const n = t;
          (m = pa(n.length > 1 ? n(a, { attrs: l, slots: s, emit: c }) : n(a, null))), (e = t.props ? l : Xr(l));
        }
        let g = m;
        if (!1 !== t.inheritAttrs && e) {
          const t = Object.keys(e),
            { shapeFlag: n } = g;
          t.length && (1 & n || 6 & n) && (o && t.some(Pt) && (e = Kr(e, o)), (g = ca(g, e)));
        }
    ...
    const Xr = (e) => {
        let t;
        for (const n in e) ("class" === n || "style" === n || Mt(n)) && ((t || (t = {}))[n] = e[n]);
        return t;
      },
      Kr = (e, t) => {
        const n = {};
        for (const r in e) (Pt(r) && r.slice(9) in t) || (n[r] = e[r]);
        return n;
      };
    function Yr(e, t, n) {
    ...
    function ri(e, t, n, r) {
      ...
      if (t)
        for (const a in t) {
          ...
          if (Qt(a)) continue;
          let s;
          i && $t(i, (s = Yt(a))) ? (n[s] = o) : Zr(e.emitsOptions, a) || (r[a] = o);
        }
      if (a) {
        const t = pr(n);
    ...
    function ii(e, t, n, r, i) {
      ...
      if (null != a) {
        ...
        if (e && void 0 === r) {
          const e = a.default;
          a.type !== Function && Gt(e) ? (Ma(i), (r = e(t)), Ma(null)) : (r = e);
        }
        a[0] && ($t(t, n) || e ? !a[1] || ("" !== r && r !== tn(n)) || (r = !0) : (r = !1));
      }
      return r;
    }
    function ai(e, t, n = !1) {
      ...
      if (jt(r))
        ...
        for (const e in r) {
          ...
          if (oi(t)) {
            const n = r[e],
              o = (i[t] = jt(n) || Gt(n) ? { type: n } : n);
            if (o) {
              const e = ci(Boolean, o.type),
                n = ci(String, o.type);
              (o[0] = e > -1), (o[1] = n < 0 || e < n), (e > -1 || $t(o, "default")) && a.push(t);
            }
          }
        }
      return (e.__props = [i, a]);
    }
    function oi(e) {
      return "$" !== e[0];
    }
    ...
    function ci(e, t) {
      if (jt(t)) {
        for (let n = 0, r = t.length; n < r; n++) if (li(t[n], e)) return n;
      } else if (Gt(t)) return li(t, e) ? 0 : -1;
      return -1;
    }
    function ui(e, t, n = Ta, r = !1) {
      if (n) {
        const i = n[e] || (n[e] = []),
          a =
            t.__weh ||
    ...
    function _i(e, t, { immediate: n, deep: r, flush: i, onTrack: a, onTrigger: o } = St, s = Ta) {
      let l,
        c,
        u = !1;
      if (
        (hr(e)
          ...
          ? ((l = () => e), (r = !0))
          : (l = jt(e)
              ? () => e.map((e) => (hr(e) ? e.value : cr(e) ? xi(e) : Gt(e) ? wr(e, s, 2) : void 0))
              : Gt(e)
              ? t
                ? () => wr(e, s, 2)
                : () => {
                    if (!s || !s.isUnmounted) return c && c(), wr(e, s, 3, [d]);
                  }
              : Nt),
        t && r)
      ) {
      ...
      const f = () => {
        if (m.active)
          if (t) {
            const e = m();
            (r || u || an(e, p)) && (c && c(), _r(t, s, 3, [e, p === bi ? void 0 : p, d]), (p = e));
          } else m();
      };
      let h;
      (f.allowRecurse = !!t),
      ...
      const m = gn(l, { lazy: !0, onTrack: a, onTrigger: o, scheduler: h });
      return (
        Ia(m, s),
        t ? (n ? f() : (p = m())) : "post" === i ? Fi(m, s && s.suspense) : m(),
        () => {
          Cn(m), s && Dt(s.effects, m);
        }
      );
    }
    function Li(e, t, n) {
      const r = this.proxy;
      return _i(Ut(e) ? () => r[e] : e.bind(r), t.bind(r), n, this);
    }
    function xi(e, t = new Set()) {
      if (!zt(e) || t.has(e)) return e;
      if ((t.add(e), hr(e))) xi(e.value, t);
      else if (jt(e)) for (let n = 0; n < e.length; n++) xi(e[n], t);
      else if (Bt(e) || Ft(e))
        e.forEach((e) => {
          xi(e, t);
        });
      else for (const n in e) xi(e[n], t);
      return e;
    }
    const Ai = (e) => e.type.__isKeepAlive;
    function Ei(e, t, n = Ta) {
      const r =
        e.__wdc ||
        (e.__wdc = () => {
          let t = n;
      ...
      if ((ui(t, r, n), n)) {
        let e = n.parent;
        for (; e && e.parent; ) Ai(e.parent.vnode) && Si(r, t, n, e), (e = e.parent);
      }
    }
    function Si(e, t, n, r) {
      const i = ui(t, e, r, !0);
    ...
    const ki = (e) => "_" === e[0] || "$stable" === e,
      Ni = (e) => (jt(e) ? e.map(pa) : [pa(e)]),
      Oi = (e, t, n) =>
        (function (e, t = qr) {
          if (!t) return e;
          const n = (...n) => {
    ...
    function Pi(e, t) {
      ...
      for (let e = 0; e < t.length; e++) {
        let [i, a, o, s = St] = t[e];
        Gt(i) && (i = { mounted: i, updated: i }), r.push({ dir: i, instance: n, value: a, oldValue: void 0, arg: o, modifiers: s });
      }
      return e;
    }
    function Ri(e, t, n, r) {
    ...
    function $i(e, t) {
      return function (n, r = null) {
        ...
        const s = (i.app = {
          ...
          set config(e) {},
          use: (e, ...t) => (a.has(e) || (e && Gt(e.install) ? (a.add(e), e.install(s, ...t)) : Gt(e) && (a.add(e), e(s, ...t))), s),
          mixin: (e) => (__VUE_OPTIONS_API__ && (i.mixins.includes(e) || (i.mixins.push(e), (e.props || e.emits) && (i.deopt = !0))), s),
          ...
          unmount() {
            o && (e(null, s._container), __VUE_PROD_DEVTOOLS__);
          },
    ...
    const ji = { scheduler: jr, allowRecurse: !0 },
      Fi = function (e, t) {
        t && t.pendingBranch ? (jt(e) ? t.effects.push(...e) : t.effects.push(e)) : Br(e, Mr, Tr, Pr);
      },
      Bi = (e, t, n, r) => {
        if (jt(e)) return void e.forEach((e, i) => Bi(e, t && (jt(t) ? t[i] : t), n, r));
        let i;
        i = !r || r.type.__asyncLoader ? null : 4 & r.shapeFlag ? r.component.exposed || r.component.proxy : r.el;
        const { i: a, r: o } = e,
          s = t && t.r,
          l = a.refs === St ? (a.refs = {}) : a.refs,
          c = a.setupState;
        if ((null != s && s !== o && (Ut(s) ? ((l[s] = null), $t(c, s) && (c[s] = null)) : hr(s) && (s.value = null)), Ut(o))) {
          const e = () => {
            (l[o] = i), $t(c, o) && (c[o] = i);
          };
          i ? ((e.id = -1), Fi(e, n)) : e();
    ...
    function Ui(e, t, n = !1) {
      ...
      if (jt(r) && jt(i))
        for (let e = 0; e < r.length; e++) {
          ...
          1 & a.shapeFlag &&
            !a.dynamicChildren &&
            ((a.patchFlag <= 0 || 32 === a.patchFlag) && ((a = i[e] = fa(i[e])), (a.el = t.el)), n || Ui(t, a));
        }
    }
    const Vi = (e) => e && (e.disabled || "" === e.disabled);
    function zi(e) {
      return Wi("components", e) || e;
    }
    const Hi = Symbol();
    function Wi(e, t, n = !0) {
      const r = qr || Ta;
      if (r) {
        ...
        if ("components" === e) {
          ...
          if (e && (e === t || e === Yt(t) || e === nn(Yt(t)))) return n;
        }
        return Zi(r[e] || n[e], t) || Zi(r.appContext[e], t);
      }
    }
    function Zi(e, t) {
      return e && (e[t] || e[Yt(t)] || e[nn(Yt(t))]);
    }
    const qi = Symbol(void 0),
      Ji = Symbol(void 0),
      Qi = Symbol(void 0),
      Xi = Symbol(void 0),
      Ki = [];
    ...
    function ta() {
      Ki.pop(), (Yi = Ki[Ki.length - 1] || null);
    }
    function na(e, t, n, r, i) {
      const a = la(e, t, n, r, i, !0);
      return (a.dynamicChildren = Yi || kt), ta(), Yi && Yi.push(a), a;
    }
    function ra(e) {
    ...
    const aa = "__vInternal",
      oa = ({ key: e }) => (null != e ? e : null),
      sa = ({ ref: e }) => (null != e ? (Ut(e) || hr(e) || Gt(e) ? { i: qr, r: e } : e) : null),
      la = function (e, t = null, n = null, r = 0, i = null, a = !1) {
        if (((e && e !== Hi) || (e = Qi), ra(e))) {
          const r = ca(e, t, !0);
          return n && ha(r, n), r;
        }
        var o;
        if ((Gt((o = e)) && "__vccOpts" in o && (e = e.__vccOpts), t)) {
          (dr(t) || aa in t) && (t = Rt({}, t));
          let { class: e, style: n } = t;
          e && !Ut(e) && (t.class = xt(e)), zt(n) && (dr(n) && !jt(n) && (n = Rt({}, n)), (t.style = bt(n)));
        }
        const s = Ut(e) ? 1 : ((e) => e.__isSuspense)(e) ? 128 : ((e) => e.__isTeleport)(e) ? 64 : zt(e) ? 4 : Gt(e) ? 2 : 0,
          l = {
            __v_isVNode: !0,
            __v_skip: !0,
            type: e,
        ...
        if ((ha(l, n), 128 & s)) {
          const { content: e, fallback: t } = (function (e) {
            ...
            let r, i;
            return 32 & t ? ((r = ei(n.default)), (i = ei(n.fallback))) : ((r = ei(n)), (i = pa(null))), { content: r, fallback: i };
          })(l);
          (l.ssContent = e), (l.ssFallback = t);
        }
        return !a && Yi && (r > 0 || 6 & s) && 32 !== r && Yi.push(l), l;
      };
    function ca(e, t, n = !1) {
      const { props: r, ref: i, patchFlag: a } = e,
        o = t
          ? (function (...e) {
              const t = Rt({}, e[0]);
              for (let n = 1; n < e.length; n++) {
                const r = e[n];
                for (const e in r)
                  if ("class" === e) t.class !== r.class && (t.class = xt([t.class, r.class]));
                  else if ("style" === e) t.style = bt([t.style, r.style]);
                  else if (Mt(e)) {
                    const n = t[e],
                      i = r[e];
      ...
      return {
        ...
        props: o,
        key: o && oa(o),
        ref: t && t.ref ? (n && i ? (jt(i) ? i.concat(sa(t)) : [i, sa(t)]) : sa(t)) : i,
        scopeId: e.scopeId,
        children: e.children,
        target: e.target,
    ...
    function ua(e = " ", t = 0) {
      return la(Ji, null, e, t);
    }
    function da(e = "", t = !1) {
      return t ? (ea(), na(Qi, null, e)) : la(Qi, null, e);
    }
    function pa(e) {
    ...
    function ha(e, t) {
      ...
      if (null == t) t = null;
        ...
        if (1 & r || 64 & r) {
          const n = t.default;
          return void (n && (n._c && ni(1), ha(e, n()), n._c && ni(-1)));
        }
        {
          n = 32;
          const r = t._;
          r || aa in t ? 3 === r && qr && (1024 & qr.vnode.patchFlag ? ((t._ = 2), (e.patchFlag |= 1024)) : (t._ = 1)) : (t._ctx = qr);
        }
      } else Gt(t) ? ((t = { default: t, _ctx: qr }), (n = 32)) : ((t = String(t)), 64 & r ? ((n = 16), (t = [ua(t)])) : (n = 8));
    ...
    function ma(e, t, n = !1) {
      ...
      if (r) {
        ...
        if (arguments.length > 1) return n && Gt(t) ? t() : t;
      }
    }
    let ga = !1;
    function Ca(e, t, n = [], r = [], i = [], a = !1) {
      const {
          mixins: o,
          extends: s,
          data: l,
      ...
      if (
        (a && E && e.render === Nt && (e.render = E),
        a || ((ga = !0), ya("beforeCreate", "bc", t, e, P), (ga = !1), wa(e, P, n, r, i)),
        s && Ca(e, s, n, r, i, !0),
        o && wa(e, o, n, r, i),
        f)
      )
        if (jt(f))
          ...
          for (const e in f) {
            const t = f[e];
            zt(t) ? (M[e] = ma(t.from || e, t.default, !0)) : (M[e] = ma(t));
          }
      if (u)
        for (const e in u) {
          const t = u[e];
      ...
      if ((a ? l && n.push(l) : (n.length && n.forEach((t) => _a(e, t, T)), l && _a(e, l, T)), c))
        for (const e in c) {
          const t = c[e],
            n = $a({ get: Gt(t) ? t.bind(T, T) : Gt(t.get) ? t.get.bind(T, T) : Nt, set: !Gt(t) && Gt(t.set) ? t.set.bind(T) : Nt });
          Object.defineProperty(M, e, { enumerable: !0, configurable: !0, get: () => n.value, set: (e) => (n.value = e) });
        }
      if (
        (d && r.push(d),
        !a &&
          r.length &&
          r.forEach((e) => {
            for (const t in e) La(e[t], M, T, t);
          }),
        p && i.push(p),
        !a &&
          i.length &&
          i.forEach((e) => {
            const t = Gt(e) ? e.call(T) : e;
            Reflect.ownKeys(t).forEach((e) => {
              !(function (e, t) {
                if (Ta) {
                  let n = Ta.provides;
                  const r = Ta.parent && Ta.parent.provides;
        ...
        a &&
          (h && Rt(e.components || (e.components = Rt({}, e.type.components)), h),
          m && Rt(e.directives || (e.directives = Rt({}, e.type.directives)), m)),
        a || ya("created", "c", t, e, P),
        g && pi(g.bind(T)),
        C && fi(C.bind(T)),
        y && hi(y.bind(T)),
        v && mi(v.bind(T)),
        b && Ei(b.bind(T), "a", void 0),
        w &&
          (function (e, t) {
            Ei(e, "da", void 0);
          })(w.bind(T)),
        ...
        if (O.length) {
          const t = e.exposed || (e.exposed = yr({}));
          O.forEach((e) => {
            t[e] = (function (e, t) {
              return hr(e[t]) ? e[t] : new vr(e, t);
            })(T, e);
          });
        } else e.exposed || (e.exposed = St);
    }
    function ya(e, t, n, r, i) {
      ba(e, t, i, r);
      const { extends: a, mixins: o } = n;
      a && va(e, t, a, r), o && ba(e, t, o, r);
      const s = n[e];
      s && _r(s.bind(r.proxy), r, t);
    }
    function va(e, t, n, r) {
      n.extends && va(e, t, n.extends, r);
      const i = n[e];
      i && _r(i.bind(r.proxy), r, t);
    }
    function ba(e, t, n, r) {
      for (let i = 0; i < n.length; i++) {
        ...
        a && ba(e, t, a, r);
        const o = n[i][e];
        o && _r(o.bind(r.proxy), r, t);
      }
    }
    function wa(e, t, n, r, i) {
      for (let a = 0; a < t.length; a++) Ca(e, t[a], n, r, i, !0);
    }
    function _a(e, t, n) {
      const r = t.call(n, n);
      zt(r) && (e.data === St ? (e.data = or(r)) : Rt(e.data, r));
    }
    function La(e, t, n, r) {
      const i = r.includes(".")
        ? (function (e, t) {
      ...
      if (Ut(e)) {
        const n = t[e];
        Gt(n) && wi(i, n);
      } else if (Gt(e)) wi(i, e.bind(n));
      else if (zt(e))
        if (jt(e)) e.forEach((e) => La(e, t, n, r));
        else {
          const r = Gt(e.handler) ? e.handler.bind(n) : t[e.handler];
          Gt(r) && wi(i, r, e);
        }
    }
    function xa(e, t, n) {
      ...
      a && xa(e, a, n), i && i.forEach((t) => xa(e, t, n));
      for (const i in t) r && $t(r, i) ? (e[i] = r[i](e[i], t[i], n.proxy, i)) : (e[i] = t[i]);
    }
    const Aa = (e) => e && (e.proxy ? e.proxy : Aa(e.parent)),
      Ea = Rt(Object.create(null), {
        $: (e) => e,
        $el: (e) => e.vnode.el,
        $data: (e) => e.data,
        $props: (e) => e.props,
        ...
        $options: (e) =>
          __VUE_OPTIONS_API__
            ? (function (e) {
                const t = e.type,
                  { __merged: n, mixins: r, extends: i } = t;
                if (n) return n;
                const a = e.appContext.mixins;
                if (!a.length && !r && !i) return t;
                const o = {};
                return a.forEach((t) => xa(o, t, e)), xa(o, t, e), (t.__merged = o);
              })(e)
            : e.type,
        $forceUpdate: (e) => () => jr(e.update),
        $nextTick: (e) => $r.bind(e.proxy),
        $watch: (e) => (__VUE_OPTIONS_API__ ? Li.bind(e) : Nt),
      }),
      Sa = {
        get({ _: e }, t) {
          ...
          if ("$" !== t[0]) {
            ...
            if (void 0 !== s)
              ...
              if (r !== St && $t(r, t)) return (o[t] = 0), r[t];
              if (i !== St && $t(i, t)) return (o[t] = 1), i[t];
              if ((c = e.propsOptions[0]) && $t(c, t)) return (o[t] = 2), a[t];
              if (n !== St && $t(n, t)) return (o[t] = 3), n[t];
              (__VUE_OPTIONS_API__ && ga) || (o[t] = 4);
            }
          }
          const u = Ea[t];
          let d, p;
          return u
            ? ("$attrs" === t && xn(e, 0, t), u(e))
            : (d = s.__cssModules) && (d = d[t])
            ? d
            : n !== St && $t(n, t)
            ? ((o[t] = 3), n[t])
            : ((p = l.config.globalProperties), $t(p, t) ? p[t] : void 0);
        },
        set({ _: e }, t, n) {
          const { data: r, setupState: i, ctx: a } = e;
          if (i !== St && $t(i, t)) i[t] = n;
          else if (r !== St && $t(r, t)) r[t] = n;
        ...
        has({ _: { data: e, setupState: t, accessCache: n, ctx: r, appContext: i, propsOptions: a } }, o) {
          ...
          return (
            ...
            $t(r, o) ||
            $t(Ea, o) ||
            $t(i.config.globalProperties, o)
          );
        },
      },
      ka = Rt({}, Sa, {
        get(e, t) {
          if (t !== Symbol.unscopables) return Sa.get(e, t, e);
        },
        has: (e, t) => "_" !== t[0] && !yt(t),
      }),
      Na = Di();
    ...
    let Pa = !1;
    function Ra(e, t, n) {
      Gt(t) ? (e.render = t) : zt(t) && (__VUE_PROD_DEVTOOLS__ && (e.devtoolsRawSetupState = t), (e.setupState = yr(t))), Da(e);
    }
    function Da(e, t) {
      const n = e.type;
      e.render || ((e.render = n.render || Nt), e.render._rc && (e.withProxy = new Proxy(e.ctx, ka))),
        __VUE_OPTIONS_API__ && ((Ta = e), _n(), Ca(e, n), Ln(), (Ta = null));
    }
    function Ia(e, t = Ta) {
    ...
    function $a(e) {
      const t = (function (e) {
        let t, n;
        return Gt(e) ? ((t = e), (n = Nt)) : ((t = e.get), (n = e.set)), new br(t, n, Gt(e) || !e.set);
      })(e);
      return Ia(t.effect), t;
    }
    function ja(e, t) {
      let n;
      if (jt(e) || Ut(e)) {
    ...
    const za = {
        ...
        createElement: (e, t, n) => (t ? Ga.createElementNS(Ba, e) : Ga.createElement(e, n ? { is: n } : void 0)),
        ...
        insertStaticContent(e, t, n, r) {
          const i = r ? Va || (Va = Ga.createElementNS(Ba, "svg")) : Ua || (Ua = Ga.createElement("div"));
          i.innerHTML = e;
          const a = i.firstChild;
          let o = a,
            s = o;
          for (; o; ) (s = o), za.insert(o, t, n), (o = i.firstChild);
          return [a, s];
        },
      },
      Ha = /\s*!important$/;
    function Wa(e, t, n) {
      if (jt(n)) n.forEach((n) => Wa(e, t, n));
        ...
        const r = (function (e, t) {
          ...
          if (n) return n;
          let r = Yt(t);
          if ("filter" !== r && r in e) return (qa[t] = r);
          r = nn(r);
        ...
        Ha.test(n) ? e.setProperty(tn(r), n.replace(Ha, ""), "important") : (e[r] = n);
      }
    }
    ...
    let Qa = Date.now;
    "undefined" != typeof document && Qa() > document.createEvent("Event").timeStamp && (Qa = () => performance.now());
    let Xa = 0;
    const Ka = Promise.resolve(),
      Ya = () => {
        Xa = 0;
      },
      eo = /(?:Once|Passive|Capture)$/,
      to = /^on[a-z]/,
      no = {
        beforeMount(e, { value: t }, { transition: n }) {
          (e._vod = "none" === e.style.display ? "" : e.style.display), n && t ? n.beforeEnter(e) : ro(e, t);
        },
          ...
          switch (t) {
            ...
            case "style":
              !(function (e, t, n) {
                const r = e.style;
                if (n)
                  if (Ut(n)) t !== n && (r.cssText = n);
                  else {
                    for (const e in n) Wa(r, e, n[e]);
                    if (t && !Ut(t)) for (const e in t) null == n[e] && Wa(r, e, "");
                  }
            ...
            default:
              Mt(t)
                  ...
                  (function (e, t, n, r, i = null) {
                    ...
                    if (r && o) o.value = r;
                      ...
                      const [n, s] = (function (e) {
                        ...
                        if (eo.test(e)) {
                          let n;
                          for (t = {}; (n = e.match(eo)); ) (e = e.slice(0, e.length - n[0].length)), (t[n[0].toLowerCase()] = !0);
                        }
                      ...
                      r
                        ? (function (e, t, n, r) {
                            ...
                            (a[t] = (function (e, t) {
                              ...
                              return (n.value = e), (n.attached = Xa || (Ka.then(Ya), (Xa = Qa()))), n;
                            })(r, i)),
                            s
                          )
                        : o &&
                ...
                : (function (e, t, n, r) {
                    return r
                      ? "innerHTML" === t || !!(t in e && to.test(t) && Gt(n))
                      : !(
                          "spellcheck" === t ||
                          "draggable" === t ||
                ...
                : ("true-value" === t ? (e._trueValue = r) : "false-value" === t && (e._falseValue = r),
                  (function (e, t, n, r) {
                    if (r && t.startsWith("xlink:")) null == n ? e.removeAttributeNS(Ja, t.slice(6, t.length)) : e.setAttributeNS(Ja, t, n);
                    else {
                      const r = vt(t);
    ...
    function oo() {
      return (
        ...
        (ao = (function (e) {
          return (function (e, t) {
            "boolean" != typeof __VUE_OPTIONS_API__ && (un().__VUE_OPTIONS_API__ = !0),
              "boolean" != typeof __VUE_PROD_DEVTOOLS__ && (un().__VUE_PROD_DEVTOOLS__ = !1);
            const {
                insert: n,
                remove: r,
                patchProp: i,
              ...
              g = (e, t, n, r = null, i = null, a = null, o = !1, s = !1) => {
                e && !ia(e, t) && ((r = U(e)), $(e, i, a, !0), (e = null)), -2 === t.patchFlag && ((s = !1), (t.dynamicChildren = null));
                ...
                switch (l) {
                  ...
                  default:
                    1 & u
                      ...
                      : 6 & u
                      ? k(e, t, n, r, i, a, o, s)
                      : (64 & u || 128 & u) && l.process(e, t, n, r, i, a, o, s, z);
                }
                null != c && i && Bi(c, e && e.ref, a, t);
              },
              C = (e, t, r, i) => {
                if (null == e) n((t.el = s(t.children)), r, i);
                else {
                  const n = (t.el = e.el);
              ...
              b = (e, t, n, r, i, a, o, s) => {
                (o = o || "svg" === t.type), null == e ? w(t, n, r, i, a, o, s) : x(e, t, i, a, o, s);
              },
              w = (e, t, r, a, s, l, c) => {
                let d, p;
                const { type: f, props: m, shapeFlag: g, transition: C, scopeId: y, patchFlag: v, dirs: b } = e;
                if (e.el && void 0 !== h && -1 === v) d = e.el = h(e.el);
                else {
                  if (
                    ((d = e.el = o(e.type, l, m && m.is)),
                    8 & g ? u(d, e.children) : 16 & g && L(e.children, d, null, a, s, l && "foreignObject" !== f, c || !!e.dynamicChildren),
                    b && Ri(e, null, a, "created"),
                    m)
                  ) {
                    for (const t in m) Qt(t) || i(d, t, null, m[t], l, e.children, a, s, G);
                    (p = m.onVnodeBeforeMount) && Gi(p, a, e);
                  }
                  _(d, y, e, a);
                }
                __VUE_PROD_DEVTOOLS__ &&
                  (Object.defineProperty(d, "__vnode", { value: e, enumerable: !1 }),
                  Object.defineProperty(d, "__vueParentComponent", { value: a, enumerable: !1 })),
                  b && Ri(e, null, a, "beforeMount");
                const w = (!s || (s && !s.pendingBranch)) && C && !C.persisted;
                w && C.beforeEnter(d),
                  n(d, t, r),
                  ((p = m && m.onVnodeMounted) || w || b) &&
                    Fi(() => {
                      p && Gi(p, a, e), w && C.enter(d), b && Ri(e, null, a, "mounted");
                    }, s);
              },
              _ = (e, t, n, r) => {
                if ((t && f(e, t), r)) {
                  const i = r.type.__scopeId;
                  i && i !== t && f(e, i + "-s"), n === r.subTree && _(e, r.vnode.scopeId, r.vnode, r.parent);
                }
              },
              L = (e, t, n, r, i, a, o, s = 0) => {
                for (let l = s; l < e.length; l++) {
                  const s = (e[l] = o ? fa(e[l]) : pa(e[l]));
                  g(null, s, t, n, r, i, a, o);
                }
              },
              x = (e, t, n, r, o, s) => {
                const l = (t.el = e.el);
                ...
                const f = e.props || St,
                  h = t.props || St;
                let m;
                if (((m = h.onVnodeBeforeUpdate) && Gi(m, n, t, e), p && Ri(t, e, n, "beforeUpdate"), c > 0)) {
                  if (16 & c) E(l, t, f, h, n, r, o);
                  else if (
                    (2 & c && f.class !== h.class && i(l, "class", null, h.class, o), 4 & c && i(l, "style", f.style, h.style, o), 8 & c)
                  ) {
                    ...
                    for (let t = 0; t < s.length; t++) {
                      const c = s[t],
                        u = f[c],
                        d = h[c];
                      (d !== u || (a && a(l, c))) && i(l, c, u, d, o, e.children, n, r, G);
                    }
                  }
                  1 & c && e.children !== t.children && u(l, t.children);
                } else s || null != d || E(l, t, f, h, n, r, o);
                const g = o && "foreignObject" !== t.type;
                d ? A(e.dynamicChildren, d, l, n, r, g) : s || P(e, t, l, null, n, r, g),
                  ((m = h.onVnodeUpdated) || p) &&
                    Fi(() => {
                      m && Gi(m, n, t, e), p && Ri(t, e, n, "updated");
                    }, r);
              },
              A = (e, t, n, r, i, a) => {
                for (let o = 0; o < t.length; o++) {
                  const s = e[o],
                    l = t[o],
                    c = s.type === qi || !ia(s, l) || 6 & s.shapeFlag || 64 & s.shapeFlag ? d(s.el) : n;
                  g(s, l, c, null, r, i, a, !0);
                }
              },
              E = (e, t, n, r, o, s, l) => {
                if (n !== r) {
                  for (const c in r) {
                    ...
                    const u = r[c],
                      d = n[c];
                    (u !== d || (a && a(e, c))) && i(e, c, d, u, l, t.children, o, s, G);
                  }
                  if (n !== St) for (const a in n) Qt(a) || a in r || i(e, a, n[a], null, l, t.children, o, s, G);
                }
              },
              S = (e, t, r, i, a, o, l, c) => {
                const u = (t.el = e ? e.el : s("")),
                  d = (t.anchor = e ? e.anchor : s(""));
                let { patchFlag: p, dynamicChildren: f } = t;
                p > 0 && (c = !0),
                  null == e
                    ? (n(u, r, i), n(d, r, i), L(t.children, r, d, a, o, l, c))
                    : p > 0 && 64 & p && f
                    ? (A(e.dynamicChildren, f, r, a, o, l), (null != t.key || (a && t === a.subTree)) && Ui(e, t, !0))
                    : P(e, t, r, d, a, o, l, c);
              },
              k = (e, t, n, r, i, a, o, s) => {
                null == e ? (512 & t.shapeFlag ? i.ctx.activate(t, n, r, o, s) : N(t, n, r, i, a, o, s)) : O(e, t, s);
              },
              N = (e, t, n, r, i, a, o) => {
                const s = (e.component = (function (e, t, n) {
                  ...
                  return (a.ctx = { _: a }), (a.root = t ? t.root : a), (a.emit = Hr.bind(null, a)), __VUE_PROD_DEVTOOLS__, a;
                })(e, r, i));
                if (
                  (Ai(e) && (s.ctx.renderer = z),
                  (function (e, t = !1) {
                    Pa = t;
                    const { props: n, children: r, shapeFlag: i } = e.vnode,
                      a = 4 & i;
                    (function (e, t, n, r = !1) {
                      const i = {},
                        a = {};
                      sn(a, aa, 1),
                        ri(e, t, i, a),
                        n ? (e.props = r ? i : lr(i, !1, In, nr)) : e.type.props ? (e.props = i) : (e.props = a),
                        (e.attrs = a);
                    })(e, n, a, t),
                      ((e, t) => {
                        if (32 & e.vnode.shapeFlag) {
                          const n = t._;
                          n ? ((e.slots = t), sn(t, "_", n)) : Ti(t, (e.slots = {}));
                      ...
                      a &&
                        (function (e, t) {
                          const n = e.type;
                          (e.accessCache = Object.create(null)), (e.proxy = new Proxy(e.ctx, Sa));
                          const { setup: r } = n;
                          if (r) {
                  ...
                  if ((i && i.registerDep(s, T), !e.el)) {
                    const e = (s.subTree = la(Qi));
                    y(null, e, t, n);
                  }
                } else T(s, e, t, n, i, a, o);
              },
              O = (e, t, n) => {
                ...
                if (
                  (function (e, t, n) {
                    ...
                    if (!(n && l >= 0)) return !((!i && !s) || (s && s.$stable)) || (r !== o && (r ? !o || Yr(r, o, c) : !!o));
                    if (1024 & l) return !0;
                    if (16 & l) return r ? Yr(r, o, c) : !!o;
                    if (8 & l) {
                      const e = t.dynamicProps;
                      for (let t = 0; t < e.length; t++) {
                        const n = e[t];
                        if (o[n] !== r[n] && !Zr(c, n)) return !0;
                      }
                    }
                    return !1;
                  })(e, t, n)
              ...
              T = (e, t, n, r, i, a, o) => {
                e.update = gn(function () {
                  if (e.isMounted) {
                    let t,
                      { next: n, bu: r, u: s, parent: l, vnode: c } = e,
                      u = n;
                    n ? ((n.el = c.el), M(e, n, o)) : (n = c), r && on(r), (t = n.props && n.props.onVnodeBeforeUpdate) && Gi(t, l, n, c);
                    const p = Qr(e),
                      f = e.subTree;
                    (e.subTree = p),
                      g(f, p, d(f.el), U(f), e, i, a),
                      (n.el = p.el),
                      null === u &&
                    ...
                    const { el: s, props: l } = t,
                      { bm: c, m: u, parent: d } = e;
                    c && on(c), (o = l && l.onVnodeBeforeMount) && Gi(o, d, t);
                    const p = (e.subTree = Qr(e));
                    g(null, p, n, r, e, i, a),
                      (t.el = p.el),
                      u && Fi(u, i),
                      (o = l && l.onVnodeMounted) &&
                        Fi(() => {
                          Gi(o, d, t);
                        }, i);
                    const { a: f } = e;
                    f && 256 & t.shapeFlag && Fi(f, i), (e.isMounted = !0);
                  }
                }, ji);
              },
              M = (e, t, n) => {
                ...
                (e.vnode = t),
                  ...
                  (function (e, t, n, r) {
                    ...
                    if (!(r || o > 0) || 16 & o) {
                      ...
                      ri(e, t, i, a);
                      for (const a in s)
                        (t && ($t(t, a) || ((r = tn(a)) !== a && $t(t, r)))) ||
                          (l ? !n || (void 0 === n[a] && void 0 === n[r]) || (i[a] = ii(l, t || St, a, void 0, e)) : delete i[a]);
                      if (a !== s) for (const e in a) (t && $t(t, e)) || delete a[e];
                    } else if (8 & o) {
                  ...
                  ((e, t) => {
                    ...
                    if (32 & n.shapeFlag) {
                      const e = t._;
                      e ? (1 === e ? (i = !1) : Rt(r, t)) : ((i = !t.$stable), Ti(t, r)), (a = t);
                    } else t && (Mi(e, t), (a = { default: 1 }));
                    if (i) for (const e in r) ki(e) || e in a || delete r[e];
                  })(e, t.children),
                  Gr(void 0, e.update);
              },
              P = (e, t, n, r, i, a, o, s = !1) => {
                ...
                if (p > 0) {
                  if (128 & p) return void D(l, d, n, r, i, a, o, s);
                  if (256 & p) return void R(l, d, n, r, i, a, o, s);
                }
                8 & f
                  ? (16 & c && G(l, i, a), d !== l && u(n, d))
                  : 16 & c
                  ? 16 & f
                    ? D(l, d, n, r, i, a, o, s)
                    : G(l, i, a, !0)
                  : (8 & c && u(n, ""), 16 & f && L(d, n, r, i, a, o, s));
              },
              R = (e, t, n, r, i, a, o, s) => {
                t = t || kt;
                const l = (e = e || kt).length,
                  c = t.length,
                  u = Math.min(l, c);
                let d;
                for (d = 0; d < u; d++) {
                  const r = (t[d] = s ? fa(t[d]) : pa(t[d]));
                  g(e[d], r, n, null, i, a, o, s);
                }
                l > c ? G(e, i, a, !0, !1, u) : L(t, n, r, i, a, o, s, u);
              },
              D = (e, t, n, r, i, a, o, s) => {
                let l = 0;
                const c = t.length;
                ...
                for (; l <= u && l <= d; ) {
                  const r = e[l],
                    c = (t[l] = s ? fa(t[l]) : pa(t[l]));
                  if (!ia(r, c)) break;
                  g(r, c, n, null, i, a, o, s), l++;
                }
                for (; l <= u && l <= d; ) {
                  const r = e[u],
                    l = (t[d] = s ? fa(t[d]) : pa(t[d]));
                  if (!ia(r, l)) break;
                  g(r, l, n, null, i, a, o, s), u--, d--;
                }
                if (l > u) {
                  if (l <= d) {
                    const e = d + 1,
                      u = e < c ? t[e].el : r;
                    for (; l <= d; ) g(null, (t[l] = s ? fa(t[l]) : pa(t[l])), n, u, i, a, o), l++;
                  }
                } else if (l > d) for (; l <= u; ) $(e[l], i, a, !0), l++;
                else {
                  const p = l,
                    f = l,
                    h = new Map();
                  for (l = f; l <= d; l++) {
                    const e = (t[l] = s ? fa(t[l]) : pa(t[l]));
                  ...
                  for (l = p; l <= u; l++) {
                    ...
                    void 0 === c ? $(r, i, a, !0) : ((w[c - f] = l + 1), c >= b ? (b = c) : (v = !0), g(r, t[c], n, null, i, a, o, s), C++);
                  }
                  const _ = v
                    ? (function (e) {
                        const t = e.slice(),
                        ...
                        for (r = 0; r < l; r++) {
                          ...
                          if (0 !== l) {
                            ...
                            for (a = 0, o = n.length - 1; a < o; ) (s = ((a + o) / 2) | 0), e[n[s]] < l ? (a = s + 1) : (o = s);
                  ...
                  for (m = _.length - 1, l = y - 1; l >= 0; l--) {
                    const e = f + l,
                      s = t[e],
                      u = e + 1 < c ? t[e + 1].el : r;
                    0 === w[l] ? g(null, s, n, u, i, a, o) : v && (m < 0 || l !== _[m] ? I(s, n, u, 2) : m--);
                  }
                }
              },
              I = (e, t, r, i, a = null) => {
                const { el: o, type: s, transition: l, children: c, shapeFlag: u } = e;
                if (6 & u) I(e.component.subTree, t, r, i);
                else if (128 & u) e.suspense.move(t, r, i);
                else if (64 & u) s.move(e, t, r, z);
                else if (s !== qi)
                  if (s !== Xi)
                    if (2 !== i && 1 & u && l)
                      if (0 === i) l.beforeEnter(o), n(o, t, r), Fi(() => l.enter(o), a);
                      else {
                    ...
                    (({ el: e, anchor: t }, r, i) => {
                      let a;
                      for (; e && e !== t; ) (a = p(e)), n(e, r, i), (e = a);
                      n(t, r, i);
                    })(e, t, r);
                else {
                  n(o, t, r);
                  for (let e = 0; e < c.length; e++) I(c[e], t, r, i);
                  n(e.anchor, t, r);
                }
              },
              $ = (e, t, n, r = !1, i = !1) => {
                const { type: a, props: o, ref: s, children: l, dynamicChildren: c, shapeFlag: u, patchFlag: d, dirs: p } = e;
                if ((null != s && Bi(s, null, n, null), 256 & u)) return void t.ctx.deactivate(e);
                const f = 1 & u && p;
                let h;
                if (((h = o && o.onVnodeBeforeUnmount) && Gi(h, t, e), 6 & u)) B(e.component, n, r);
                else {
                  if (128 & u) return void e.suspense.unmount(n, r);
                  f && Ri(e, null, t, "beforeUnmount"),
                    c && (a !== qi || (d > 0 && 64 & d))
                      ? G(c, t, n, !1, !0)
                      : ((a === qi && (128 & d || 256 & d)) || (!i && 16 & u)) && G(l, t, n),
                    64 & u && (r || !Vi(e.props)) && e.type.remove(e, z),
                    r && j(e);
                }
                ((h = o && o.onVnodeUnmounted) || f) &&
                  Fi(() => {
                    h && Gi(h, t, e), f && Ri(e, null, t, "unmounted");
                  }, n);
              },
              j = (e) => {
                const { type: t, el: n, anchor: i, transition: a } = e;
                if (t === qi) return void F(n, i);
                if (t === Xi)
              ...
              B = (e, t, n) => {
                const { bum: r, effects: i, update: a, subTree: o, um: s } = e;
                if ((r && on(r), i)) for (let e = 0; e < i.length; e++) Cn(i[e]);
                a && (Cn(a), $(o, e, t, n)),
                  s && Fi(s, t),
                  Fi(() => {
                    e.isUnmounted = !0;
              ...
              U = (e) => (6 & e.shapeFlag ? U(e.component.subTree) : 128 & e.shapeFlag ? e.suspense.next() : p(e.anchor || e.el)),
              V = (e, t) => {
                null == e ? t._vnode && $(t._vnode, null, null, !0) : g(t._vnode || null, e, t), Ur(), (t._vnode = e);
              },
              z = { p: g, um: $, m: I, r: j, mt: N, mc: L, pc: P, pbc: A, n: U, o: e };
            let H;
            return { render: V, hydrate: H, createApp: $i(V, H) };
          })(e);
        })(io))
      );
    }
    const so = (...e) => Object.prototype.toString.call(...e).slice(8, -1);
    var lo = {
      inheritAttrs: !1,
      props: {
        path: { required: !0, validator: (e) => "Array" === so(e) && e.every((e) => "String" === so(e) || "Number" === so(e)) },
        data: { required: !0, validator: (e) => "Null" === so(e) },
        name: { required: !0, type: String },
        id: { required: !0, type: String },
        ariaLevel: { required: !0, type: Number },
        renderName: { required: !1, type: Function },
      },
    };
    const co = { key: 0, class: "separator" },
      uo = la("span", { class: "value" }, "null", -1);
    (lo.render = function (e, t, n, r, i, a) {
      return (
        ea(),
        na(
          "span",
          { class: "null", role: "treeitem", "aria-level": n.ariaLevel, id: n.id },
          [
            la("span", { class: "key", innerHTML: n.renderName(n.name, n.path) }, null, 8, ["innerHTML"]),
            "" !== n.name ? (ea(), na("span", co, ": ")) : da("v-if", !0),
            uo,
          ],
          8,
          ["aria-level", "id"]
      ...
      (lo.__file = "src/components/NullWrapper.vue");
    var po = {
      inheritAttrs: !1,
      props: {
        path: { required: !0, validator: (e) => "Array" === so(e) && e.every((e) => "String" === so(e) || "Number" === so(e)) },
        data: { required: !0, validator: (e) => "Boolean" === so(e) },
        name: { required: !0, type: String },
        id: { required: !0, type: String },
        ariaLevel: { required: !0, type: Number },
        renderName: { required: !1, type: Function },
    ...
    const fo = { key: 0, class: "separator" },
      ho = { class: "value" };
    (po.render = function (e, t, n, r, i, a) {
      return (
        ea(),
        na(
          "span",
          { class: "boolean", role: "treeitem", "aria-level": n.ariaLevel, id: n.id },
          [
            la("span", { class: "key", innerHTML: n.renderName(n.name, n.path) }, null, 8, ["innerHTML"]),
            "" !== n.name ? (ea(), na("span", fo, ": ")) : da("v-if", !0),
            la("span", ho, At(n.data), 1),
          ],
          8,
          ["aria-level", "id"]
        )
      ...
      (po.__file = "src/components/BooleanWrapper.vue");
    var mo = {
      inheritAttrs: !1,
      props: {
        path: { required: !0, validator: (e) => "Array" === so(e) && e.every((e) => "String" === so(e) || "Number" === so(e)) },
        data: { required: !0, validator: (e) => "Number" === so(e) },
        name: { required: !0, type: String },
        id: { required: !0, type: String },
        ariaLevel: { required: !0, type: Number },
        renderName: { required: !1, type: Function },
    ...
    const go = { key: 0, class: "separator" },
      Co = { class: "value" };
    (mo.render = function (e, t, n, r, i, a) {
      return (
        ea(),
        na(
          "span",
          { class: "number", role: "treeitem", "aria-level": n.ariaLevel, id: n.id },
          [
            la("span", { class: "key", innerHTML: n.renderName(n.name, n.path) }, null, 8, ["innerHTML"]),
            "" !== n.name ? (ea(), na("span", go, ": ")) : da("v-if", !0),
            la("span", Co, At(n.data), 1),
          ],
          8,
          ["aria-level", "id"]
        )
      ...
      (mo.__file = "src/components/NumberWrapper.vue");
    var yo = {
      inheritAttrs: !1,
      props: {
        path: { required: !0, validator: (e) => "Array" === so(e) && e.every((e) => "String" === so(e) || "Number" === so(e)) },
        data: { required: !0, validator: (e) => "String" === so(e) },
        name: { required: !0, type: String },
        id: { required: !0, type: String },
        ariaLevel: { required: !0, type: Number },
        renderName: { required: !0, type: Function },
      },
    };
    const vo = { key: 0, class: "separator" },
      bo = la("span", { class: "quotes" }, '"', -1),
      wo = { class: "value" },
      _o = la("span", { class: "quotes" }, '"', -1);
    (yo.render = function (e, t, n, r, i, a) {
      return (
        ea(),
        na(
          "span",
          { class: "string", role: "treeitem", "aria-level": n.ariaLevel, id: n.id },
          [
            la("span", { class: "key", innerHTML: n.renderName(n.name, n.path) }, null, 8, ["innerHTML"]),
            "" !== n.name ? (ea(), na("span", vo, ": ")) : da("v-if", !0),
            bo,
            la("span", wo, At(n.data), 1),
            _o,
          ],
          8,
          ["aria-level", "id"]
      ...
      (yo.__file = "src/components/StringWrapper.vue");
    const Lo = new Set();
    function xo(e = { collapseSignal, expandSignal }) {
      const t = mr(!1),
        n = mr(!1),
        r = () => {
          (t.value = !1), (n.value = !n.value);
        };
      wi(() => e.collapseSignal, r);
      const i = mr(!1),
        a = () => {
          (t.value = !0), (i.value = !i.value);
        };
      return (
        wi(() => e.expandSignal, a),
        wi(
          () => e.data,
          () => {
            e.expandOnCreatedAndUpdated(e.path) ? a() : r();
          },
          { immediate: !0 }
        ),
        {
          ...
          innerExpandSignal: i,
          handleClick: (e) => {
            Lo.clear(), !0 === e.metaKey && !0 === e.shiftKey ? r() : !0 === e.metaKey ? a() : (t.value = !t.value);
          },
        }
      );
    }
    var Ao = {
      ...
      props: {
        path: { required: !0, validator: (e) => "Array" === so(e) && e.every((e) => "String" === so(e) || "Number" === so(e)) },
        data: { required: !0, validator: (e) => "Array" === so(e) },
        name: { required: !0, type: String },
        ...
        renderName: { required: !1, type: Function },
        objectVisualizerUid: { required: !0, type: Number },
        id: { required: !0, type: String },
        role: { required: !0, type: String },
        ariaLevel: { required: !0, type: Number },
      },
      setup(e) {
        const { isExpanding: t, innerExpandSignal: n, innerCollapseSignal: r, handleClick: i } = xo(e),
          a = $a(() => e.getKeys(e.data, e.path)),
          o = Lo.has(e.data);
        return Lo.add(e.data), { keys: a, isExpanding: t, innerExpandSignal: n, innerCollapseSignal: r, handleClick: i, isCircular: o };
      },
      components: {},
    };
    const Eo = { key: 0, class: "value" },
      So = { key: 0, class: "value" };
    (Ao.render = function (e, t, n, r, i, a) {
      const o = zi("wrapper");
      return (
        ea(),
        na(
          "span",
          { class: "array", role: n.role, "aria-expanded": r.isExpanding, "aria-level": n.ariaLevel, id: n.id },
          [
            la(
              "span",
              { class: "indicator", onClick: t[1] || (t[1] = (...e) => r.handleClick && r.handleClick(...e)) },
              At(r.isExpanding ? "▼" : "▶"),
              1
            ),
            la(
              ...
              {
                class: "key",
                onClick: t[2] || (t[2] = (...e) => r.handleClick && r.handleClick(...e)),
                innerHTML: n.renderName(n.name, n.path),
              },
              null,
              8,
              ["innerHTML"]
            ...
            la(
              "span",
              { class: "separator", onClick: t[3] || (t[3] = (...e) => r.handleClick && r.handleClick(...e)) },
              At("" === n.name ? "" : ": "),
              1
            ),
            la(
              "span",
              { class: "count", onClick: t[4] || (t[4] = (...e) => r.handleClick && r.handleClick(...e)) },
              At(!1 === r.isExpanding && n.data.length >= 2 ? "(" + n.data.length + ")" : ""),
              1
            ),
            la(
              "span",
              { class: "preview", onClick: t[5] || (t[5] = (...e) => r.handleClick && r.handleClick(...e)) },
              At(r.isExpanding ? "Array(" + n.data.length + ")" : "[...]"),
              1
            ),
            r.isCircular
              ? (ea(),
                              ...
                              (e) => (
                                ...
                                na(
                                  o,
                                  {
                                    ...
                                    data: n.data[e],
                                    "expand-signal": r.innerExpandSignal,
                                    "collapse-signal": r.innerCollapseSignal,
                                    expandOnCreatedAndUpdated: () => !1,
                                    renderName: n.renderName,
                                    getKeys: n.getKeys,
                                    "object-visualizer-uid": n.objectVisualizerUid,
          ...
          8,
          ["role", "aria-expanded", "aria-level", "id"]
        )
      );
    }),
      (Ao.__file = "src/components/ArrayWrapper.vue");
    var ko = {
      inheritAttrs: !1,
      props: {
        path: { required: !0, validator: (e) => "Array" === so(e) && e.every((e) => "String" === so(e) || "Number" === so(e)) },
        data: { required: !0, validator: (e) => "Object" === so(e) },
        name: { required: !0, type: String },
        collapseSignal: { default: !1, type: Boolean },
        expandSignal: { default: !1, type: Boolean },
        expandOnCreatedAndUpdated: { required: !0, type: Function },
    ...
    const No = { key: 0, class: "value" },
      Oo = { key: 1, class: "value" };
    (ko.render = function (e, t, n, r, i, a) {
      const o = zi("wrapper");
      return (
        ea(),
        na(
          "span",
          { class: "object", role: n.role, "aria-expanded": r.isExpanding, "aria-level": n.ariaLevel, id: n.id },
          [
            la(
              "span",
              { class: "indicator", onClick: t[1] || (t[1] = (...e) => r.handleClick && r.handleClick(...e)) },
            ...
            la(
              "span",
              { class: "preview", onClick: t[4] || (t[4] = (...e) => r.handleClick && r.handleClick(...e)) },
              At(r.isExpanding ? "" : "{...}"),
              1
            ),
            r.isCircular
      ...
      (ko.__file = "src/components/ObjectWrapper.vue");
    const To = {
        Null: "null-wrapper",
      ...
      Mo = {
        ...
        props: {
          ...
          renderName: { required: !1, type: Function },
          objectVisualizerUid: { required: !0, type: Number },
          role: { default: "group", type: String },
          ariaLevel: { required: !0, type: Number },
        },
        setup: () => ({ objectToString: so, TYPE_TO_COMPONENT: To }),
        components: { NullWrapper: lo, BooleanWrapper: po, NumberWrapper: mo, StringWrapper: yo, ArrayWrapper: Ao, ObjectWrapper: ko },
      };
    (Ao.components.Wrapper = Mo),
      (ko.components.Wrapper = Mo),
      (Mo.render = function (e, t, n, r, i, a) {
        return (
          ea(),
          na(
            ((o = e.TYPE_TO_COMPONENT[e.objectToString(e.data)]), Ut(o) ? Wi("components", o, !1) || o : o || Hi),
            {
              name: e.name,
              path: e.path,
              data: e.data,
              ...
              "object-visualizer-uid": e.objectVisualizerUid,
              id: `object-visualizer-${e.objectVisualizerUid}--${0 === e.path.length ? "root" : e.path.join("-")}`,
              role: e.role,
              "aria-level": e.ariaLevel + 1,
            },
            null,
            8,
            [
      ...
      (Mo.__file = "src/components/Wrapper.vue");
    const Po = Object.freeze({ expandOnCreatedAndUpdated: (e) => !1, getKeys: (e, t) => Object.keys(e), renderName: (e) => e });
    let Ro = 0;
    function Do(e, t, n) {
      var r = ae(ye.locale);
      (e = "".concat(e ? e + " - " : "", "Apache ECharts Demo")), (t = (t && t.slice()) || []);
      var i = ye.locale && ye.locale.indexOf("zh") > -1 ? "zh-CN" : "en",
        a = ye.sourceCode.indexOf("ROOT_PATH") > -1 ? "var ROOT_PATH = '".concat(ye.cdnRoot, "';") : "";
      return (
        /\$[\.\(]+/g.test(ye.sourceCode) && t.unshift({ src: r.jQueryJS }),
        {
          title: e,
          html: '<!DOCTYPE html>\n<html lang="'
            .concat(i, '">\n<head>\n  <meta charset="utf-8">\n  <title>')
            ...
            .concat(
              t
                .filter(function (e) {
                  return !e.src || e.src.indexOf("dat.gui") < 0;
                })
                .map(function (e) {
                  return e.content
                    ? "<script>".concat(e.content, "</script>")
                    : '<script src="'.concat(
                        e.src.indexOf("api.map.baidu.com/api") > -1 ? e.src.replace(/(ak=)(\S+)$/, "$1YOUR_API_KEY") : e.src,
                        '"></script>'
                      );
                })
                .join("\n  "),
          ...
          js: "var dom = document.getElementById('chart-container');\nvar myChart = echarts.init(dom, "
            .concat(ye.darkMode ? "'dark'" : ye.theme ? "'".concat(ye.theme, "'") : "null", ", {\n  renderer: '")
            .concat(ye.renderer, "',\n  useDirtyRect: ")
            .concat(ye.useDirtyRect, "\n});\nvar app = {};\n")
            .concat(a, "\nvar option;\n\n")
    ...
    function Io(e, t, n) {
      ...
      (i.method = "POST"), (i.action = "https://codepen.io/pen/define/"), (i.target = "_blank"), (i.style.display = "none");
      var a = document.createElement("input");
      a.setAttribute("name", "data"),
        a.setAttribute("type", "hidden"),
        a.setAttribute("value", JSON.stringify(r)),
        i.appendChild(a),
        document.body.appendChild(i),
        i.submit(),
    ...
    function jo(e, t, n) {
      ...
      var i = (0, $o.b)({
          ...
          files: {
            ...
            "index.js": { content: r.js },
            "style.css": { content: r.css },
            "package.json": { content: { name: e[0], description: e[1] || "", keywords: ["echarts", "apache"], main: "index.html" } },
            "sandbox.config.json": { content: { template: "static" } },
          },
        }),
        a = document.createElement("form");
      (a.method = "POST"), (a.action = "https://codesandbox.io/api/v1/sandboxes/define"), (a.target = "_blank"), (a.style.display = "none");
      var o = document.createElement("input");
      o.setAttribute("name", "parameters"),
    ...
    const Bo = {
        components: { CodeAce: Re, CodeMonaco: Ie, FullCodePreview: je, Preview: mt },
        data: function () {
          return {
            ...
            fullCode: "",
            exampleConfig: be(),
            fullCodeConfig: { minimal: !1, esm: !0, node: !1 },
            formatterReady: !1,
            pr: null,
            isPRLoading: !1,
            prLatestReview: null,
        ...
        mounted: function () {
          ...
          ye.isMobile
            ...
            : (Le().then(function (t) {
                (e.initialCode = xe(t)), ye.initialCode !== _e && (ye.initialCode = e.initialCode);
              }),
              window.addEventListener("mousemove", function (t) {
                if (e.draggingMouseDown) {
                  var n = t.clientX / window.innerWidth;
                  (n = Math.min(0.9, Math.max(0.1, n))), (e.leftContainerSize = 100 * n);
                }
              }),
              window.addEventListener("mouseup", function () {
                e.draggingMouseDown = !1;
              }),
              window.addEventListener("keydown", function (t) {
                if ((t.ctrlKey || t.metaKey) && "s" === t.key) {
                  var n = e.$refs.preview;
                  n && n.share(), t.preventDefault();
                }
              }),
              window.addEventListener("beforeunload", function (t) {
                window.__EDITOR_NO_LEAVE_CONFIRMATION__ || ye.sourceCode === e.initialCode || (t.preventDefault(), (t.returnValue = ""));
              }),
              ye.typeCheck || this.prepareFormatter());
        },
        methods: {
          toExternalEditor: function (e) {
            var t = this.$refs.preview;
            if (t) {
              var n = t.getAssets();
              ({ CodePen: Io, CodeSandbox: jo })[e](this.exampleConfig && this.exampleConfig.title, n.scripts, n.css);
            }
          },
          ...
          updateFullCode: function () {
            var e = this,
              t = this.$refs.preview.getOption();
            if (t) {
              var n = (0, gt.collectDeps)(t);
              n.push("svg" === ye.renderer ? "SVGRenderer" : "CanvasRenderer"),
                (this.fullCode = (0, gt.buildExampleCode)(ye.sourceCode, n, {
                  minimal: this.fullCodeConfig.minimal,
                  ts: ye.typeCheck,
                  esm: this.fullCodeConfig.esm,
                  theme: ye.darkMode ? "dark" : ye.theme,
                  renderer: ye.renderer,
                  useDirtyRect: ye.useDirtyRect,
                  ROOT_PATH: ye.cdnRoot,
                  isZHLang: "zh" === this.$i18n.locale,
                })),
                Ne(this.fullCode).then(function (t) {
                  e.fullCode = t;
                });
            }
          },
          updateOptionOutline: function () {
            var e = Object.freeze(this.$refs.preview.getOption());
            if (e) {
              var t = this.$t("editor.tooltip.gotoDoc"),
                n = this.$i18n.locale;
              ((e, t, n = {}) => {
                void 0 === n.rootName && (n.rootName = ""),
                  void 0 === n.getKeys && (n.getKeys = Po.getKeys),
                  void 0 === n.renderName && (n.renderName = Po.renderName),
                  void 0 === n.expandOnCreatedAndUpdated && (n.expandOnCreatedAndUpdated = Po.expandOnCreatedAndUpdated),
                  t.classList.add("object-visualizer"),
                  ((...e) => {
                    oo().render(...e);
                  })(null, t),
                  ((...e) => {
                    ...
                    return (
                      (t.mount = (e) => {
                        ...
                        Gt(i) || i.render || i.template || (i.template = r.innerHTML), (r.innerHTML = "");
                        const a = n(r);
                        return r.removeAttribute("v-cloak"), r.setAttribute("data-v-app", ""), a;
                      }),
                      t
                    );
                  })(Mo, {
                    ...
                    getKeys: n.getKeys,
                    renderName: n.renderName,
                    objectVisualizerUid: Ro++,
                    role: "tree",
                    ariaLevel: 0,
                  }).mount(t);
              })(e, this.$refs.optionOutline, {
                getKeys: function (e) {
                  return Object.keys(e).filter(function (t) {
                    return !(Array.isArray(e[t]) && !e[t].length);
                  });
                },
                renderName: function (r, i) {
                  for (var a = e, o = [], s = 0; s < i.length; s++) {
                    var l = i[s];
                    if (null == (a = a[l])) {
                      o.push(l);
                      break;
                    ...
                    if (Array.isArray(a)) {
                      var c = a[i[s + 1]],
                        u = c && c.type;
                      u && ((l += "-" + u), s++, (a = c));
                    } else if (!isNaN(l)) continue;
                    o.push(l);
                  }
                  var d = "object" === Fo(a) && null != a,
                    p = o.includes("bmap")
                      ? "https://github.com/apache/echarts/blob/release/extension-src/bmap/README.md"
                      : "https://echarts.apache.org/".concat(n, "/option.html#").concat(o.join("."));
                  return d
                    ? "".concat(r, '<a href="').concat(p, '" target="_blank" title="').concat(t, '"><i class="el-icon-document"></i></a>')
                    : '<a href="'.concat(p, '" target="_blank" title="').concat(t, '">').concat(r, "</a>");
                },
                expandOnCreatedAndUpdated: function (e) {
                  return 0 === e.length || ("series" === e[0] && e.length <= 1);
                },
              });
            }
          },
          updateTabContent: function (e) {
            "full-code" === e
              ...
              : "pr-preview" === e && this.preparePRPreview();
          },
          changeLang: function (e) {
            (ie.lang || "js").toLowerCase() !== e &&
              (this.initialCode && ye.sourceCode !== this.initialCode
                ? this.$confirm(this.$t("editor.codeChangedConfirm"), "", {
                    ...
                    .then(function () {
                      (window.__EDITOR_NO_LEAVE_CONFIRMATION__ = !0), et({ lang: e });
                    })
                    .catch(function () {})
                : et({ lang: e }));
          },
          format: function () {
            var e = this;
            this.formatterReady
              ? Ne(ye.sourceCode).then(function (t) {
                  t === e.initialCode && ye.sourceCode !== e.initialCode && (e.initialCode = ye.sourceCode),
                    e.$nextTick(function () {
                      e.initialCode = t;
                    });
                })
          ...
          preparePRPreview: function () {
            var e = this;
            if (ye.isPR && !this.isPRLoading && !this.pr) {
              this.isPRLoading = !0;
              var t = "https://api.github.com/repos/apache/echarts/pulls/".concat(ye.prNumber);
              $.ajax({
                url: t,
                ...
                success: function (n) {
                  (e.pr = n),
                    (e.isPRReviewLoading = !0),
                    $.ajax({
                      url: t + "/reviews?per_page=100",
                      headers: { Accept: "application/json" },
                      dataType: "json",
                      success: function (n) {
                        var r = (e.prLatestReview = n[n.length - 1]);
                        r && "COMMENTED" === r.state && !r.body
                          ? $.ajax({
                              url: t + "/reviews/" + r.id + "/comments?direction=desc&sort=created&per_page=100",
                              headers: { Accept: "application/json" },
                              dataType: "json",
                              success: function (e) {
                                var t = e[0];
                                (r.body = t.body), (r.submitted_at = t.created_at), (r.html_url = t.html_url);
                              },
                              error: function (e, t, n) {
                                console.error("failed to fetch PR review comment", n);
                              },
                              complete: function () {
                                e.isPRReviewLoading = 0;
                              },
                      ...
                      error: function (t, n, r) {
                        (e.isPRReviewLoading = !1), console.error("failed to fetch PR reviews", r);
                      },
                    });
                },
                error: function (e, t, n) {
                  console.error("failed to fetch PR info", n);
                },
                complete: function () {
                  e.isPRLoading = !1;
                },
          ...
          loadPRDiff: function () {
            var e = this;
            this.isPRDiffLoading ||
              0 === this.isPRDiffLoading ||
              ((this.isPRDiffLoading = !0),
              $.ajax({
                url: "https://api.github.com/repos/apache/echarts/pulls/".concat(ye.prNumber),
                headers: { Accept: "application/vnd.github.v3.diff" },
                dataType: "text",
                success: function (t) {
                  var n = ae(ye.locale).highlightjsDir;
                  ke([n + "/styles/github.min.css", n + "/highlight.min.js", n + "/languages/diff.min.js"])
                    .then(function () {
                      return hljs.highlight(t, { language: "diff" }).value;
                    })
                    .catch(function (e) {
                      console.error("failed to load PR diff", e);
                    })
                    .then(function (t) {
                      (e.isPRDiffLoading = !!t && 0), t && (e.$refs.prDiff.innerHTML = t);
                    });
                },
                error: function (t, n, r) {
                  (e.isPRDiffLoading = !1), console.error("failed to fetch PR diff", r);
                },
              }));
          },
        },
      ...
      Go = Pe(Bo, Y, [], !1, null, null, null).exports;
    var Uo = function () {
      var e = this,
        t = e.$createElement,
        n = e._self._c || t;
      return n("div", { attrs: { id: "example-explore" } }, [
        n("div", { ref: "leftContainer", attrs: { id: "left-container" } }, [
          n(
            "div",
            ...
            [
              n(
                "scrollactive",
                {
                  ...
                  on: { itemchanged: e.onActiveNavChanged },
                },
                [
                  n(
                    "ul",
                    e._l(e.EXAMPLE_CATEGORIES, function (t) {
                      return n("li", { key: t }, [
                        n(
                          "a",
                          {
                            staticClass: "left-chart-nav-link scrollactive-item",
                            attrs: { id: "left-chart-nav-" + t, href: "#chart-type-" + t },
                          },
                          [
                            n("span", { staticClass: "chart-icon", domProps: { innerHTML: e._s(e.icons[t]) } }),
                            e._v(" "),
                            n("span", { staticClass: "chart-name" }, [e._v(e._s(e.$t("chartTypes." + t)))]),
                          ]
                        ),
                      ]);
                    }),
        ...
        e._v(" "),
        n("div", { attrs: { id: "explore-container" } }, [
          n(
            "div",
            { staticClass: "example-list-panel" },
            e._l(e.exampleList, function (t) {
              return n("div", { key: t.category }, [
                n("h3", { staticClass: "chart-type-head", attrs: { id: "chart-type-" + t.category } }, [
                  e._v("\n          " + e._s(e.$t("chartTypes." + t.category)) + "\n          "),
                  n("span", [e._v(e._s(t.category))]),
                ]),
                e._v(" "),
                n(
                  "div",
                  { staticClass: "row", attrs: { id: "chart-row-" + t.category } },
                  e._l(t.examples, function (e) {
                    return n(
                      "div",
                      { key: e.id, staticClass: "col-xl-2 col-lg-3 col-md-4 col-sm-6" },
                      [n("ExampleCard", { attrs: { example: e } })],
                      1
                    );
                  }),
                  0
    ...
    var Vo = function () {
      var e = this,
        t = e.$createElement,
        r = e._self._c || t;
      return r("div", { staticClass: "example-list-item" }, [
        r("a", { staticClass: "example-link", attrs: { target: "_blank", href: e.exampleLink } }, [
          r("picture", [
            r("source", { attrs: { "data-srcset": e.screenshotURLWebP, type: "image/webp" } }),
            e._v(" "),
            r("source", { attrs: { "data-srcset": e.screenshotURLPNG, type: "image/png" } }),
            e._v(" "),
            r("img", { staticClass: "chart-area", attrs: { src: n(6732) } }),
          ]),
        ]),
        e._v(" "),
        r("div", [
          r("div", { staticClass: "example-langs" }, [
            r("a", { staticClass: "js", attrs: { href: e.exampleLink, target: "_blank" } }, [e._v("JS")]),
            e._v(" "),
            e.example.ts
              ? r("a", { staticClass: "ts", attrs: { href: e.exampleLink + "&lang=ts", target: "_blank" } }, [e._v("TS")])
              : e._e(),
          ]),
          e._v(" "),
          r("div", [
            r("div", { staticClass: "example-title", attrs: { title: e.title } }, [e._v(e._s(e.title))]),
            e._v(" "),
            e.showSubtitle ? r("div", { staticClass: "example-subtitle" }, [e._v(e._s(e.subtitle))]) : e._e(),
          ]),
        ]),
      ]);
    };
    ...
    const zo = {
        ...
        computed: {
          title: function () {
            return ("zh" === ye.locale ? this.example.titleCN : this.example.title) || this.example.title || "";
          },
          ...
          exampleTheme: function () {
            return this.example.theme || (ye.darkMode ? "dark" : "");
          },
          exampleLink: function () {
            ...
            return (
              e.isGL && t.push("gl=1"),
              n && t.push("theme=" + n),
              "local" in ie && t.push("local=1"),
              "debug" in ie && t.push("debug=1"),
              "useDirtyRect" in ie && t.push("useDirtyRect=1"),
              ie.renderer && t.push("renderer=" + ie.renderer),
              "./editor.html?" + t.join("&")
            );
          },
          exampleThumbFilePath: function () {
            var e = this.example,
              t = this.exampleTheme ? "-" + this.exampleTheme : "",
              n = e.isGL ? "data-gl" : "data";
            return "".concat(n, "/thumb").concat(t, "/").concat(e.id);
          },
          screenshotURLWebP: function () {
            return "".concat(ye.cdnRoot, "/").concat(this.exampleThumbFilePath, ".webp?_v_=").concat(ye.version);
          },
          screenshotURLPNG: function () {
            return "".concat(ye.cdnRoot, "/").concat(this.exampleThumbFilePath, ".png?_v_=").concat(ye.version);
          },
        },
      },
      Ho = Pe(zo, Vo, [], !1, null, null, null).exports,
      Wo = "undefined" != typeof window,
      Zo =
        (Wo && !("onscroll" in window)) || ("undefined" != typeof navigator && /(gle|ing|ro)bot|crawl|spider/i.test(navigator.userAgent)),
      qo = Wo && "IntersectionObserver" in window,
      Jo = Wo && "classList" in document.createElement("p"),
      Qo = Wo && window.devicePixelRatio > 1,
      Xo = {
        elements_selector: ".lazy",
        container: Zo || Wo ? document : null,
        threshold: 300,
        thresholds: null,
        data_src: "src",
        data_srcset: "srcset",
      ...
      Yo = function (e, t) {
        ...
        try {
          ...
          (n = document.createEvent("CustomEvent")), n.initCustomEvent(r, !1, !1, { instance: i });
        }
      ...
      ws = (e, t) => {
        Jo ? e.classList.add(t) : (e.className += (e.className ? " " : "") + t);
      },
      _s = (e, t) => {
        Jo
      ...
      Ss = (e) => {
        let t = [];
        for (let n, r = 0; (n = e.children[r]); r += 1) "SOURCE" === n.tagName && t.push(n);
        return t;
      },
      ks = (e, t) => {
        const n = e.parentNode;
        n && "PICTURE" === n.tagName && Ss(n).forEach(t);
      },
      Ns = (e, t) => {
        Ss(e).forEach(t);
      },
      ...
      Fs = (e, t, n) => {
        ws(e, t.class_applied), ms(e, ls), n && (t.unobserve_completed && xs(e, t), bs(t.callback_applied, e, n));
      },
      Bs = (e, t, n) => {
        ws(e, t.class_loading), ms(e, os), n && (As(n, 1), bs(t.callback_loading, e, n));
      },
      Gs = (e, t, n) => {
        n && e.setAttribute(t, n);
      },
      Us = (e, t) => {
        Gs(e, ns, fs(e, t.data_sizes)), Gs(e, ts, fs(e, t.data_srcset)), Gs(e, es, fs(e, t.data_src));
      },
      Vs = {
        IMG: (e, t) => {
          ks(e, (e) => {
        ...
        IFRAME: (e, t) => {
          $s(e, Os), Gs(e, es, fs(e, t.data_src));
        },
        VIDEO: (e, t) => {
          Ns(e, (e) => {
            $s(e, Os), Gs(e, es, fs(e, t.data_src));
            ...
            $s(e, Ts),
            Gs(e, rs, fs(e, t.data_poster)),
            Gs(e, es, fs(e, t.data_src)),
            e.load();
        },
        OBJECT: (e, t) => {
          $s(e, Ps), Gs(e, as, fs(e, t.data_src));
        },
      },
      zs = ["IMG", "IFRAME", "VIDEO", "OBJECT"],
      Hs = (e, t) => {
        !t || ((e) => e.loadingCount > 0)(t) || ((e) => e.toLoadCount > 0)(t) || bs(e.callback_finish, t);
      },
      Ws = (e, t, n) => {
      ...
      Qs = (e, t, n) => {
        ((e) => {
          ...
          _s(e, t.class_loading),
          t.unobserve_completed && xs(e, n);
      },
      Xs = (e, t, n) => {
        const r = Ls(e) || e;
        qs(r) ||
          ((e, t, n) => {
            qs(e) || (e.llEvLisnrs = {});
            const r = "VIDEO" === e.tagName ? "loadeddata" : "load";
            Ws(e, r, t), Ws(e, "error", n);
          })(
            r,
            (i) => {
              ((e, t, n, r) => {
                const i = ys(t);
                Qs(t, n, r), ws(t, n.class_loaded), ms(t, ss), bs(n.callback_loaded, t, r), i || Hs(n, r);
              })(0, e, t, n),
                Js(r);
            },
            (i) => {
              ((e, t, n, r) => {
                const i = ys(t);
                Qs(t, n, r), ws(t, n.class_error), ms(t, cs), bs(n.callback_error, t, r), n.restore_on_error && js(t, Ms), i || Hs(n, r);
              })(0, e, t, n),
                Js(r);
            }
          );
      ...
      Ks = (e, t, n) => {
        ((e) => zs.indexOf(e.tagName) > -1)(e)
          ? ((e, t, n) => {
              Xs(e, t, n),
                ((e, t, n) => {
                  const r = Vs[e.tagName];
                  r && (r(e, t), Bs(e, t, n));
                })(e, t, n);
            })(e, t, n)
          : ((e, t, n) => {
              ((e) => {
                ...
                Xs(e, t, n),
                ((e) => {
                  Rs(e) || (e[is] = { backgroundImage: e.style.backgroundImage });
                })(e),
                ((e, t, n) => {
                  const r = fs(e, t.data_bg),
                    i = fs(e, t.data_bg_hidpi),
                    a = Qo && i ? i : r;
                  a && ((e.style.backgroundImage = `url("${a}")`), Ls(e).setAttribute(es, a), Bs(e, t, n));
                })(e, t, n),
                ((e, t, n) => {
                  const r = fs(e, t.data_bg_multi),
                    i = fs(e, t.data_bg_multi_hidpi),
                    a = Qo && i ? i : r;
                  a && ((e.style.backgroundImage = a), Fs(e, t, n));
                })(e, t, n),
                ((e, t, n) => {
                  const r = fs(e, t.data_bg_set);
                  if (!r) return;
                  const i = r.split("|");
                  let a = i.map((e) => `image-set(${e})`);
                  (e.style.backgroundImage = a.join()),
                    "" === e.style.backgroundImage && ((a = i.map((e) => `-webkit-image-set(${e})`)), (e.style.backgroundImage = a.join())),
                    Fs(e, t, n);
                })(e, t, n);
            })(e, t, n);
      },
      Ys = (e) => {
        e.removeAttribute(es), e.removeAttribute(ts), e.removeAttribute(ns);
      },
      el = (e) => {
        ks(e, (e) => {
          js(e, Ms);
      ...
      nl = (e, t) => {
        ((e) => {
          ...
          ((e, t) => {
            Cs(e) ||
              ys(e) ||
              (_s(e, t.class_entered),
              _s(e, t.class_exited),
              _s(e, t.class_applied),
              _s(e, t.class_loading),
              _s(e, t.class_loaded),
              _s(e, t.class_error));
          })(e, t),
      ...
      rl = ["IMG", "IFRAME", "VIDEO"],
      il = (e) => e.use_native && "loading" in HTMLImageElement.prototype,
      al = (e, t, n) => {
        e.forEach((e) =>
          ((e) => e.isIntersecting || e.intersectionRatio > 0)(e)
            ? ((e, t, n, r) => {
                const i = ((e) => vs.indexOf(hs(e)) >= 0)(e);
                ms(e, "entered"),
                  ws(e, n.class_entered),
                  _s(e, n.class_exited),
                  ((e, t, n) => {
                    t.unobserve_entered && xs(e, n);
                  })(e, n, r),
                  bs(n.callback_enter, e, t, r),
                  i || Ks(e, n, r);
              })(e.target, e, t, n)
            : ((e, t, n, r) => {
                Cs(e) ||
                  ...
                  ((e, t, n, r) => {
                    n.cancel_on_exit &&
                      ...
                      el(e),
                      _s(e, n.class_loading),
                      As(r, -1),
                      gs(e),
                      bs(n.callback_cancel, e, t, r));
                  })(e, t, n, r),
                  bs(n.callback_exit, e, t, r));
              })(e.target, e, t, n)
        );
      },
      ol = (e) => Array.prototype.slice.call(e),
      sl = (e) => e.container.querySelectorAll(e.elements_selector),
      ll = (e) => ((e) => hs(e) === cs)(e),
      cl = (e, t) => ((e) => ol(e).filter(Cs))(e || sl(t)),
      ul = function (e, t) {
        const n = Ko(e);
        (this._settings = n),
          (this.loadingCount = 0),
          ((e, t) => {
            qo &&
              !il(e) &&
              (t._observer = new IntersectionObserver((n) => {
                al(n, e, t);
          ...
          ((e, t) => {
            Wo &&
              ((t._onlineHandler = () => {
                ((e, t) => {
                  var n;
                  ((n = sl(e)), ol(n).filter(ll)).forEach((t) => {
                    _s(t, e.class_error), gs(t);
                  }),
                    t.update();
                })(e, t);
              }),
    ...
    (ul.prototype = {
        ...
        Es(this, n.length),
          !Zo && qo
            ? il(t)
              ? ((e, t, n) => {
                  e.forEach((e) => {
                    -1 !== rl.indexOf(e.tagName) &&
                      ((e, t, n) => {
                        e.setAttribute("loading", "lazy"),
                          Xs(e, t, n),
                          ((e, t) => {
                            const n = Vs[e.tagName];
                            n && n(e, t);
                          })(e, t),
                          ms(e, us);
                      })(e, t, n);
      ...
      destroy: function () {
        this._observer && this._observer.disconnect(),
          Wo && window.removeEventListener("online", this._onlineHandler),
          sl(this._settings).forEach((e) => {
            Is(e);
          }),
      ...
      Wo &&
        ((e, t) => {
          if (t)
            if (t.length) for (let n, r = 0; (n = t[r]); r += 1) Yo(e, n);
            else Yo(e, t);
        })(ul, window.lazyLoadOptions);
    var dl = {};
    [
      "line",
      "bar",
    ...
    var pl = n(9787);
    ["globe", "bar3D", "scatter3D", "surface", "map3D", "lines3D", "line3D", "scatterGL", "linesGL", "flowGL", "graphGL", "geo3D"].forEach(
      function (e) {
        dl[e] = pl;
      }
    );
    const fl = {
        components: { ExampleCard: Ho },
        data: function () {
          var e = {};
          function t(t, n) {
            var r = 0;
            do {
              for (var i = !1, a = 0; a < t.length; a++) {
                var o = t[a];
                if (!re.hasOwnProperty(o.id)) {
                  "string" == typeof o.category && (o.category = [o.category]);
                  var s = (o.category || [])[r];
                  if (s) {
                    i = !0;
                    var l = e[s];
                    l || ((l = { category: s, examples: [] }), (e[s] = l)), (o.isGL = n), l.examples.push(o);
                  }
                }
              }
              if (!i) break;
          ...
          return t(de, !1), t(pe, !0), { shared: ye, icons: dl, EXAMPLE_CATEGORIES: ne, exampleListByCategory: e };
        },
        watch: {
          "shared.darkMode": function () {
            for (var e = this.$el.querySelectorAll("img.chart-area"), t = 0; t < e.length; t++) ul.resetStatus(e[t]);
        ...
        computed: {
          exampleList: function () {
            for (var e = [], t = 0, n = ne.length; t < n; t++) {
              var r = ne[t],
                i = this.exampleListByCategory[r];
              i && i.examples.length > 0 && e.push({ category: r, examples: i.examples });
            }
            return e;
          },
        },
        mounted: function () {
          var e = this;
          (this._lazyload = new ul({
            elements_selector: ".chart-area",
            load_delay: 400,
            class_loaded: "ec-shot-loaded",
            callback_error: function (e) {
              for (var t = e.src, n = e.parentElement.children, r = 0, i = n.length; r < i; r++) {
                var a = n[r];
                a !== e && (a.srcset = t);
              }
            },
            ...
            setTimeout(function () {
              location.hash && e.onHashChange(), window.addEventListener("hashchange", e.onHashChange);
            }, 0);
        },
        methods: {
          onHashChange: function (e) {
            console.log("onHashChange"), e && e.preventDefault();
            for (var t, n, r = location.hash, i = this.$refs.scrollactive.items, a = 0, o = i.length; a < o; a++)
              if ((n = i[a]).hash === r) {
                t = n;
                break;
              }
            t && (t.click(), this.scrollNav(t));
          },
          onActiveNavChanged: function (e, t) {
            t && (e && "scroll" === e.type && this.scrollNav(t), location.href !== t.href && history.pushState(null, null, t.href));
          },
          scrollNav: function (e) {
            var t = this.$refs.leftContainer,
              n = t.offsetHeight,
              r = e.parentElement.getBoundingClientRect();
            if (r.top < 0 || r.bottom > n) {
              var i = e.offsetTop - n + e.offsetHeight;
              t.scrollTo ? t.scrollTo(0, i) : (t.scrollTop = i);
            }
          },
        },
      },
      hl = Pe(fl, Uo, [], !1, null, null, null).exports;
    var ml = function () {
      var e = this.$createElement;
      return (this._self._c || e)("preview");
    };
    ml._withStripped = !0;
    const gl = Pe(
      {
        ...
        mounted: function () {
          Le().then(function (e) {
            ye.sourceCode = ye.initialCode = ye.runCode = xe(e);
          });
        },
      },
      ml,
    ...
    var Cl = n(7802),
      yl = n.n(Cl);
    function vl(e, n) {
      var r = new X({ locale: n.locale, fallbackLocale: "en", messages: K });
      if (
        ((ye.cdnRoot = n.cdnRoot),
        (ye.version = n.version),
        (ye.locale = n.locale || "en"),
      ...
      var a = n.page;
      if (a && "explore" !== a) {
        var o = document.getElementById("v4-link");
        o && o.remove();
      }
      new (t())({
        i18n: r,
        el: i,
        render: function (e) {
          return e({ editor: Go, explore: hl, view: gl }[a] || hl);
        },
      });
    }
    t().use(yl());
