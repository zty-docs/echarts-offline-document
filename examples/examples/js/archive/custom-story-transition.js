...
difficulty: 11
*/
$.when($.get(ROOT_PATH + "/data/asset/data/life-expectancy-table.json"), $.getScript("/examples/js/ecSimpleTransform.min.js")).done(
  function (res) {
    run(res[0]);
  }
);
...
function run(_rawData) {
    ...
    dataset: [
      ...
      },
      {
        ...
        transform: {
          ...
          config: {
            resultDimensions: [{ from: "Income", method: "sum" }, { from: "Country" }],
            groupBy: "Country",
          },
        },
      },
  ...
  const optionCreators = {
    ...
    Option_CountryAB_Income_Population_Scatter: function (datasetId, specifiedCountry) {
      return {
        xAxis: Object.assign(Object.assign({ name: "Income" }, AXIS_NAME_STYLE), { scale: true, nameLocation: "middle" }),
        yAxis: Object.assign(Object.assign({ name: "Population" }, AXIS_NAME_STYLE), { scale: true }),
        series: {
          type: "custom",
          coordinateSystem: "cartesian2d",
          datasetId: datasetId,
    ...
    Option_CountryAB_Income_Sum_Bar: function (datasetId) {
      return {
        xAxis: Object.assign(Object.assign({ name: "Income" }, AXIS_NAME_STYLE), { nameLocation: "middle" }),
        yAxis: {
          type: "category",
        },
        series: {
