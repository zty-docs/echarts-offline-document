...
difficulty: 11
*/
var PIE_COLORS = ["#e06343", "#37a354", "#b55dba", "#b5bd48", "#8378EA", "#96BFFF"];
var CLUSTER_COLORS = ["#cc5664", "#9bd6ec", "#ea946e", "#8acaaa", "#f1ec64", "#ee8686", "#a48dc1", "#5da6bc", "#b9dcae"];
var Z_TAG_COLORS = ["#5470c6", "#91cc75", "#fac858", "#ee6666", "#73c0de", "#3ba272", "#fc8452", "#9a60b4", "#ea7ccc"];
var Z_TAG_COLORS_2 = ["#51689b", "#ce5c5c", "#fbc357", "#8fbf8f", "#659d84", "#fb8e6a", "#c77288", "#786090", "#91c4c5", "#6890ba"];
var SYMBOL_PATHS = [
      ...
      option: {
        ...
        series: {
          ...
          renderItem: function (params, api) {
            ...
            var pos = api.coord([api.value("CLUSTER_CENTER_STE"), api.value("CLUSTER_CENTER_ATA")]);
...
$.when($.getScript("/examples/js/ecSimpleTransform.min.js"), $.getScript("/examples/js/ecSimpleOptionPlayer.min.js")).done(function () {
  run();
});
function run() {
