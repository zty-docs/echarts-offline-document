window.__EC_DOC_option_series_themeRiver = {
  ...
  coordinateSystem: { desc: "<p>坐标系统，主题河流用的是单个的时间轴。</p>\n" },
  boundaryGap: {
    desc: "<p>图中与坐标轴正交的方向的边界间隙，设置该值是为了调整图的位置，使其尽量处于屏幕的正中间，避免处于屏幕的上方或下方。</p>\n",
  },
  singleAxisIndex: { desc: "<p>单个时间轴的index，默认值为0，因为只有单个轴。</p>\n" },
  label: { desc: '<p><code class="codespan">label</code> 描述了主题河流中每个带状河流分支对应的文本标签的样式。</p>\n' },
  ...
  "label.fontSize": { desc: "\n\n<p>文字的字体大小。</p>\n", uiControl: { type: "number", default: "11", min: "1", step: "1" } },
  "label.lineHeight": {
  ...
  itemStyle: { desc: "<p>主题河流中每个带状河流分支的样式。</p>\n" },
  "itemStyle.color": {
    desc: '\n\n<p>图形的颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  ...
  "data.date": { desc: "<p>时间或主题的时间属性。</p>\n" },
  "data.value": { desc: "<p>事件或主题在某个时间点的值。</p>\n" },
  "data.name": { desc: "<p>事件或主题的名称。</p>\n" },
