window.__EC_DOC_option_xAxis = {
  ...
  gridIndex: { desc: "<p>x 轴所在的 grid 的索引，默认位于第一个 grid。</p>\n" },
  alignTicks: {
  ...
  position: {
    desc: '\n\n<p>x 轴的位置。</p>\n<p>可选：</p>\n<ul>\n<li><code class="codespan">&#39;top&#39;</code></li>\n<li><code class="codespan">&#39;bottom&#39;</code></li>\n</ul>\n<p>默认 grid 中的第一个 x 轴在 grid 的下方（<code class="codespan">&#39;bottom&#39;</code>），第二个 x 轴视第一个 x 轴的位置放在另一侧。<br>注：若未将 <code class="codespan">xAxis.axisLine.onZero</code> 设为 <code class="codespan">false</code> , 则该项无法生效</p>\n',
    uiControl: { type: "enum", options: "top,bottom", default: "bottom" },
  },
  offset: {
    desc: '\n\n<p>X 轴相对于默认位置的偏移，在相同的 <code class="codespan">position</code> 上有多个 X 轴的时候有用。<br>注：若未将 <code class="codespan">xAxis.axisLine.onZero</code> 设为 <code class="codespan">false</code> , 则该项无法生效</p>\n',
  ...
  "axisLine.show": {
    desc: '\n\n<p>是否显示坐标轴轴线。</p>\n<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始，数值轴 (<code class="codespan">type: &#39;value&#39;</code>) 默认不显示轴线，需要显式配置。</p>\n</blockquote>\n',
    uiControl: { type: "boolean", default: "true" },
  },
  "axisLine.onZero": {
  ...
  "axisLine.onZeroAxisIndex": { desc: "<p>当有双轴时，可以用这个属性手动指定，在哪个轴的 0 刻度上。</p>\n" },
  "axisLine.symbol": {
  ...
  "axisTick.show": {
    desc: '\n\n<p>是否显示坐标轴刻度。</p>\n<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始，数值轴 (<code class="codespan">type: &#39;value&#39;</code>) 默认不显示轴刻度，需要显式配置。</p>\n</blockquote>\n',
    uiControl: { type: "boolean", default: "true" },
  },
  ...
  "axisLabel.alignMinLabel": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.5.0</code> 开始支持</p>\n</blockquote>\n<p>最小的坐标刻度标签的对齐方式。如果设置为 <code class="codespan">null</code>，则和其他标签一致。参见 <a href="#xAxis.axisLabel.align">align</a>。</p>\n<p>可选：</p>\n<ul>\n<li><code class="codespan">&#39;left&#39;</code></li>\n<li><code class="codespan">&#39;center&#39;</code></li>\n<li><code class="codespan">&#39;right&#39;</code></li>\n<li><code class="codespan">null</code> (default)</li>\n</ul>\n',
  },
  "axisLabel.alignMaxLabel": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.5.0</code> 开始支持</p>\n</blockquote>\n<p>最大的坐标刻度标签的对齐方式。如果设置为 <code class="codespan">null</code>，则和其他标签一致。参见 <a href="#xAxis.axisLabel.align">align</a>。</p>\n<p>可选：</p>\n<ul>\n<li><code class="codespan">&#39;left&#39;</code></li>\n<li><code class="codespan">&#39;center&#39;</code></li>\n<li><code class="codespan">&#39;right&#39;</code></li>\n<li><code class="codespan">null</code> (default)</li>\n</ul>\n',
  },
