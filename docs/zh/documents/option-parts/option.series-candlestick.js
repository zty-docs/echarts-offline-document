window.__EC_DOC_option_series_candlestick = {
  ...
  coordinateSystem: {
    desc: '<p>该系列使用的坐标系，可选：</p>\n<ul>\n<li><p><code class="codespan">&#39;cartesian2d&#39;</code></p>\n<p>  使用二维的直角坐标系（也称笛卡尔坐标系），通过 <a href="#series-candlestick.xAxisIndex">xAxisIndex</a>, <a href="#series-candlestick.yAxisIndex">yAxisIndex</a>指定相应的坐标轴组件。</p>\n</li>\n</ul>\n',
  },
  ...
  barWidth: {
    ...
    uiControl: { type: "percent", default: "70%", min: "0" },
  },
  barMinWidth: {
  ...
  "emphasis.itemStyle.borderColorDoji": {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.4.1</code> 开始支持</p>\n</blockquote>\n<p>十字星（开盘价等于收盘价）的描边颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  "emphasis.itemStyle.borderWidth": {
    desc: "\n\n<p>candlestick 描边线宽。为 0 时无描边。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5", default: "2" },
  },
  ...
  "blur.itemStyle.borderColorDoji": {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.4.1</code> 开始支持</p>\n</blockquote>\n<p>十字星（开盘价等于收盘价）的描边颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  ...
  "select.itemStyle.borderColorDoji": {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.4.1</code> 开始支持</p>\n</blockquote>\n<p>十字星（开盘价等于收盘价）的描边颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  ...
  largeThreshold: { desc: "\n\n<p>开启绘制优化的阈值。</p>\n", uiControl: { type: "number", min: "1", default: "600" } },
  progressive: {
  ...
  "data.itemStyle": { desc: "<p>单个 K 线图数据的图形样式。</p>\n" },
  ...
  "data.itemStyle.borderColorDoji": {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.4.1</code> 开始支持</p>\n</blockquote>\n<p>十字星（开盘价等于收盘价）的描边颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  "data.itemStyle.borderWidth": {
    desc: "\n\n<p>candlestick 描边线宽。为 0 时无描边。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5", default: "" },
  },
  ...
  "data.emphasis": { desc: "<p>单个 K 线图数据的高亮状态配置。</p>\n" },
  ...
  "data.emphasis.itemStyle.borderColorDoji": {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.4.1</code> 开始支持</p>\n</blockquote>\n<p>十字星（开盘价等于收盘价）的描边颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  ...
  "data.blur.itemStyle.borderColorDoji": {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.4.1</code> 开始支持</p>\n</blockquote>\n<p>十字星（开盘价等于收盘价）的描边颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  ...
  "data.select.itemStyle.borderColorDoji": {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.4.1</code> 开始支持</p>\n</blockquote>\n<p>十字星（开盘价等于收盘价）的描边颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  ...
  "markPoint.data.name": {
    desc: '<p>标注名称。定义后可在 <a href="#series-candlestick.markPoint.data.label.formatter">label formatter</a> 中作为<strong>数据名</strong> <code class="codespan">{b}</code> 模板变量使用。</p>\n',
  },
  "markPoint.data.type": {
  ...
  "markLine.data.0.name": {
    desc: '<p>标注名称。定义后可在 <a href="#series-candlestick.markLine.data.label.formatter">label formatter</a> 中作为<strong>数据名</strong> <code class="codespan">{b}</code> 模板变量使用。</p>\n',
  },
  ...
  "markArea.data.0.name": {
    desc: '<p>标注名称，将会作为文字显示。定义后可在 <a href="#series-candlestick.markArea.data.label.formatter">label formatter</a> 中作为<strong>数据名</strong> <code class="codespan">{b}</code> 模板变量使用。</p>\n',
  },
  "markArea.data.0.x": {
  ...
  animationDuration: {
    desc: '\n\n<p>初始动画的时长，支持回调函数，可以通过每个数据返回不同的时长实现更戏剧的初始动画效果：</p>\n<pre><code class="lang-ts">animationDuration: function (idx) {\n    // 越往后的数据时长越大\n    return idx * 100;\n}\n</code></pre>\n',
    uiControl: { type: "number", min: "0", default: "300", step: "20", clean: "true" },
  },
  animationEasing: {
    desc: '\n\n<p>初始动画的缓动效果。不同的缓动效果可以参考 <a href="https://echarts.apache.org/examples/zh/editor.html?c=line-easing" target="_blank">缓动示例</a>。</p>\n',
    uiControl: {
