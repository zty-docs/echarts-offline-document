window.__EC_DOC_option_series_sunburst = {
  ...
  radius: {
    ...
    uiControl: { type: "percentvector", dims: "inner,outer", default: "0%, 75%" },
  },
  data: {
  ...
  "data.name": { desc: "<p>显示在扇形块中的描述文字。</p>\n" },
  "data.link": {
  ...
  "data.label.align": {
    ...
    uiControl: { type: "enum", options: "left,center,right", default: "center" },
  },
  "data.label.minAngle": {
    desc: "\n\n<p>当某个扇形块的角度小于该值（角度制）时，扇形块对应的文字不显示。该值用以隐藏过小扇形块中的文字。</p>\n",
    uiControl: { type: "angle", min: "0", step: "1", max: "360" },
  },
  ...
  "data.itemStyle.borderRadius": {
    ...
    uiControl: { type: "percentvector", min: "0", dims: "InnerStart,InnerEnd,OuterStart,OuterEnd", default: "0,0,0,0" },
  },
  ...
  "data.children": { desc: '<p>子节点，递归定义，格式同 <a href="#series-sunburst.data">series-sunburst.data</a>。</p>\n' },
  ...
  nodeClick: {
    ...
    uiControl: { type: "enum", default: "rootToNode", options: "rootToNode,link" },
  },
  sort: {
    ...
    uiControl: { type: "enum", default: "desc", options: "desc,asc" },
  },
  ...
  startAngle: {
    desc: "\n\n<p>起始角度，支持范围[0, 360]。</p>\n",
    uiControl: { type: "angle", step: "1", min: "0", max: "360", default: "90" },
  },
  label: {
    desc: '<p><code class="codespan">label</code> 描述了每个扇形块中，文本标签的样式。</p>\n<p><strong>优先级：<a href="#series-sunburst.data.label">series.data.label</a> &gt; <a href="#series-sunburst.levels.label">series.levels.label</a> &gt; <a href="#series-sunburst.label">series.label</a>。</strong></p>\n<p>图形上的文本标签，可用于说明图形的一些数据信息，比如值，名称等。</p>\n',
  },
  ...
  "label.align": {
    desc: '\n\n<p>文字对齐方式，可取值为：<code class="codespan">&#39;left&#39;</code>、 <code class="codespan">&#39;center&#39;</code>、 <code class="codespan">&#39;right&#39;</code>。注意，<code class="codespan">&#39;left&#39;</code> 是指靠近内圈，而 <code class="codespan">&#39;right&#39;</code> 是指靠近外圈。</p>\n<iframe  data-src="../../examples/zh/view.html?c=doc-example/sunburst-label-align&edit=1&reset=1" width="700" height="400"></iframe>\n\n\n',
    uiControl: { type: "enum", options: "left,center,right", default: "center" },
  },
  "label.minAngle": {
    desc: "\n\n<p>当某个扇形块的角度小于该值（角度制）时，扇形块对应的文字不显示。该值用以隐藏过小扇形块中的文字。</p>\n",
  ...
  blur: { desc: '<p>淡出状态配置。开启 <a href="#series-sunburst.emphasis.focus">emphasis.focus</a> 后有效。</p>\n' },
  "blur.label": {
    desc: '<p><code class="codespan">label</code> 描述了每个扇形块中，文本标签的样式。</p>\n<p><strong>优先级：<a href="#series-sunburst.data.label">series.data.label</a> &gt; <a href="#series-sunburst.levels.label">series.levels.label</a> &gt; <a href="#series-sunburst.label">series.label</a>。</strong></p>\n<p>图形上的文本标签，可用于说明图形的一些数据信息，比如值，名称等。</p>\n',
  },
  "blur.label.rotate": {
  ...
  select: { desc: '<p>选中状态配置。开启 <a href="#series-sunburst.selectedMode">selectedMode</a> 后有效。</p>\n' },
  "select.label": {
    desc: '<p><code class="codespan">label</code> 描述了每个扇形块中，文本标签的样式。</p>\n<p><strong>优先级：<a href="#series-sunburst.data.label">series.data.label</a> &gt; <a href="#series-sunburst.levels.label">series.levels.label</a> &gt; <a href="#series-sunburst.label">series.label</a>。</strong></p>\n<p>图形上的文本标签，可用于说明图形的一些数据信息，比如值，名称等。</p>\n',
  },
  "select.label.rotate": {
  ...
  "levels.labelLine.show": { desc: "\n\n<p>是否显示视觉引导线。</p>\n", uiControl: { type: "boolean" } },
  "levels.labelLine.lineStyle.color": {
    desc: '\n\n<p>线的颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  "levels.labelLine.lineStyle.width": { desc: "\n\n<p>线宽。</p>\n", uiControl: { type: "number", value: "1", min: "0", step: "0.5" } },
