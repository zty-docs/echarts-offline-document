window.__EC_DOC_option_axisPointer = {
  ...
  "label.margin": { desc: "<p>label 距离轴的距离。</p>\n" },
  ...
  "label.borderColor": { desc: "<p>文本标签的边框颜色。</p>\n" },
  "label.borderWidth": { desc: "<p>文本标签的边框宽度。</p>\n" },
  "label.shadowBlur": {
  ...
  triggerOn: {
    ...
    uiControl: { type: "enum", options: "mousemove,click,none" },
  },
};
