window.__EC_DOC_option_parallel = {
  ...
  "parallelAxisDefault.nameTextStyle": { desc: "<p>坐标轴名称的文字样式。</p>\n" },
  ...
  "parallelAxisDefault.nameTextStyle.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "parallelAxisDefault.nameTextStyle.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "parallelAxisDefault.nameTextStyle.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "parallelAxisDefault.nameTruncate": { desc: "<p>坐标轴名字的截断。</p>\n" },
  "parallelAxisDefault.nameTruncate.maxWidth": { desc: "<p>截断文本的最大长度，超过此长度会被截断。</p>\n" },
  "parallelAxisDefault.nameTruncate.ellipsis": { desc: "<p>截断后文字末尾显示的内容。</p>\n" },
  "parallelAxisDefault.inverse": { desc: "\n\n<p>是否是反向坐标轴。</p>\n", uiControl: { type: "boolean" } },
  ...
  "parallelAxisDefault.silent": { desc: "<p>坐标轴是否是静态无法交互。</p>\n" },
  "parallelAxisDefault.triggerEvent": {
    desc: '<p>坐标轴的标签是否响应和触发鼠标事件，默认不响应。</p>\n<p>事件参数如下：</p>\n<pre><code class="lang-ts">{\n    // 组件类型，xAxis, yAxis, radiusAxis, angleAxis\n    // 对应组件类型都会有一个属性表示组件的 index，例如 xAxis 就是 xAxisIndex\n    componentType: string,\n    // 未格式化过的刻度值, 点击刻度标签有效\n    value: &#39;&#39;,\n    // 坐标轴名称, 点击坐标轴名称有效\n    name: &#39;&#39;\n}\n</code></pre>\n',
  },
  "parallelAxisDefault.axisLine": { desc: "<p>坐标轴轴线相关设置。</p>\n" },
  "parallelAxisDefault.axisLine.show": { desc: "\n\n<p>是否显示坐标轴轴线。</p>\n", uiControl: { type: "boolean", default: "true" } },
  ...
  "parallelAxisDefault.axisTick": { desc: "<p>坐标轴刻度相关设置。</p>\n" },
  "parallelAxisDefault.axisTick.show": { desc: "\n\n<p>是否显示坐标轴刻度。</p>\n", uiControl: { type: "boolean", default: "true" } },
  ...
  "parallelAxisDefault.axisTick.inside": { desc: "\n\n<p>坐标轴刻度是否朝内，默认朝外。</p>\n", uiControl: { type: "boolean" } },
  "parallelAxisDefault.axisTick.length": {
    desc: "\n\n<p>坐标轴刻度的长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5", default: "5" },
  },
  "parallelAxisDefault.axisTick.lineStyle": { desc: "<p>刻度线的样式设置。</p>\n" },
  ...
  "parallelAxisDefault.minorTick.show": { desc: "\n\n<p>是否显示次刻度线。</p>\n", uiControl: { type: "boolean", default: "true" } },
  ...
  "parallelAxisDefault.axisLabel": { desc: "<p>坐标轴刻度标签的相关设置。</p>\n" },
  "parallelAxisDefault.axisLabel.show": { desc: "\n\n<p>是否显示刻度标签。</p>\n", uiControl: { type: "boolean", default: "true" } },
  "parallelAxisDefault.axisLabel.interval": {
    desc: '\n\n\n\n<p>坐标轴刻度标签的显示间隔，在类目轴中有效。</p>\n<p>默认会采用标签不重叠的策略间隔显示标签。</p>\n<p>可以设置成 0 强制显示所有标签。</p>\n<p>如果设置为 <code class="codespan">1</code>，表示『隔一个标签显示一个标签』，如果值为 <code class="codespan">2</code>，表示隔两个标签显示一个标签，以此类推。</p>\n<p>可以用数值表示间隔的数据，也可以通过回调函数控制。回调函数格式如下：</p>\n<pre><code class="lang-ts">(index:number, value: string) =&gt; boolean\n</code></pre>\n<p>第一个参数是类目的 index，第二个值是类目名称，如果跳过则返回 <code class="codespan">false</code>。</p>\n',
    uiControl: { type: "number", min: "0", step: "1" },
  },
  "parallelAxisDefault.axisLabel.inside": { desc: "\n\n<p>刻度标签是否朝内，默认朝外。</p>\n", uiControl: { type: "boolean" } },
  ...
  "parallelAxisDefault.axisLabel.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "parallelAxisDefault.axisLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "parallelAxisDefault.axisLabel.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "parallelAxisDefault.data.value": { desc: "<p>单个类目名称。</p>\n" },
  "parallelAxisDefault.data.textStyle": { desc: "<p>类目标签的文字样式。</p>\n" },
  "parallelAxisDefault.data.textStyle.color": { desc: "\n\n<p>文字的颜色。</p>\n", uiControl: { type: "color", default: "null" } },
  ...
  "parallelAxisDefault.data.textStyle.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "parallelAxisDefault.data.textStyle.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "parallelAxisDefault.animation": { desc: "\n\n<p>是否开启动画。</p>\n", uiControl: { type: "boolean", default: "true", clean: "true" } },
  "parallelAxisDefault.animationThreshold": { desc: "<p>是否开启动画的阈值，当单个系列显示的图形数量大于这个阈值时会关闭动画。</p>\n" },
