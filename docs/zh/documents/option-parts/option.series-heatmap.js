window.__EC_DOC_option_series_heatmap = {
  ...
  label: { desc: '<p>在直角坐标系(<a href="#series-heatmap.coordinateSystem">coordinateSystem</a>: &#39;cartesian2d&#39;)上有效。</p>\n' },
  ...
  "markPoint.data.name": {
    desc: '<p>标注名称。定义后可在 <a href="#series-heatmap.markPoint.data.label.formatter">label formatter</a> 中作为<strong>数据名</strong> <code class="codespan">{b}</code> 模板变量使用。</p>\n',
  },
  ...
  "markLine.data.0.name": {
    desc: '<p>标注名称。定义后可在 <a href="#series-heatmap.markLine.data.label.formatter">label formatter</a> 中作为<strong>数据名</strong> <code class="codespan">{b}</code> 模板变量使用。</p>\n',
  },
  ...
  "markArea.data.0.name": {
    desc: '<p>标注名称，将会作为文字显示。定义后可在 <a href="#series-heatmap.markArea.data.label.formatter">label formatter</a> 中作为<strong>数据名</strong> <code class="codespan">{b}</code> 模板变量使用。</p>\n',
  },
  "markArea.data.0.x": {
