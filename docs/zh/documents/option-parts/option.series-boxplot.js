window.__EC_DOC_option_series_boxplot = {
  ...
  coordinateSystem: {
    desc: '<p>该系列使用的坐标系，可选：</p>\n<ul>\n<li><p><code class="codespan">&#39;cartesian2d&#39;</code></p>\n<p>  使用二维的直角坐标系（也称笛卡尔坐标系），通过 <a href="#series-boxplot.xAxisIndex">xAxisIndex</a>, <a href="#series-boxplot.yAxisIndex">yAxisIndex</a>指定相应的坐标轴组件。</p>\n</li>\n</ul>\n',
  },
  ...
  boxWidth: {
    ...
    uiControl: { type: "percentvector", default: "7,50", min: "0", dims: "min,max" },
  },
  itemStyle: { desc: "<p>盒须图样式。</p>\n" },
  "itemStyle.color": {
  ...
  "emphasis.itemStyle.color": {
    desc: '\n\n<p>boxplot图形的颜色。从 v5.2.0 开始支持在 <code class="codespan">emphasis</code> 状态中支持设置为 <code class="codespan">&#39;inherit&#39;</code> 取消高亮颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  ...
  "emphasis.itemStyle.borderWidth": {
    desc: "\n\n<p>boxplot描边线宽。为 0 时无描边。</p>\n",
    uiControl: { type: "number", value: "2", min: "0", step: "0.5" },
  },
  ...
  "emphasis.itemStyle.shadowColor": {
    desc: '\n\n<p>阴影颜色。支持的格式同<code class="codespan">color</code>。</p>\n',
    uiControl: { type: "color", default: "rgba(0,0,0,0.2)" },
  },
  "emphasis.itemStyle.shadowOffsetX": {
    desc: "\n\n<p>阴影水平方向上的偏移距离。</p>\n",
    uiControl: { type: "number", default: "1", step: "0.5" },
  },
  ...
  select: {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>数据选中时的图形样式和标签样式。开启 <a href="#series-boxplot.selectedMode">selectedMode</a> 后有效。</p>\n',
  },
  "select.disabled": {
  ...
  "data.itemStyle": { desc: "<p>盒须图单个数据样式。</p>\n" },
  ...
  "data.emphasis": { desc: "<p>盒须图单个数据高亮状态配置。</p>\n" },
  ...
  "markPoint.data.name": {
    desc: '<p>标注名称。定义后可在 <a href="#series-boxplot.markPoint.data.label.formatter">label formatter</a> 中作为<strong>数据名</strong> <code class="codespan">{b}</code> 模板变量使用。</p>\n',
  },
  "markPoint.data.type": {
    ...
    uiControl: { type: "enum", options: "min,max,average" },
  },
  "markPoint.data.valueIndex": {
    ...
    uiControl: { type: "number", min: "0", max: "1", step: "1" },
  },
  ...
  "markLine.data.0.name": {
    desc: '<p>标注名称。定义后可在 <a href="#series-boxplot.markLine.data.label.formatter">label formatter</a> 中作为<strong>数据名</strong> <code class="codespan">{b}</code> 模板变量使用。</p>\n',
  },
  ...
  "markArea.data.0.name": {
    desc: '<p>标注名称，将会作为文字显示。定义后可在 <a href="#series-boxplot.markArea.data.label.formatter">label formatter</a> 中作为<strong>数据名</strong> <code class="codespan">{b}</code> 模板变量使用。</p>\n',
  },
  "markArea.data.0.x": {
  ...
  animationDuration: {
    desc: '\n\n<p>初始动画的时长，支持回调函数，可以通过每个数据返回不同的时长实现更戏剧的初始动画效果：</p>\n<pre><code class="lang-ts">animationDuration: function (idx) {\n    // 越往后的数据时长越大\n    return idx * 100;\n}\n</code></pre>\n',
    uiControl: { type: "number", min: "0", default: "800", step: "20", clean: "true" },
  },
  animationEasing: {
    desc: '\n\n<p>初始动画的缓动效果。不同的缓动效果可以参考 <a href="https://echarts.apache.org/examples/zh/editor.html?c=line-easing" target="_blank">缓动示例</a>。</p>\n',
    uiControl: {
