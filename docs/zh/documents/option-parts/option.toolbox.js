window.__EC_DOC_option_toolbox = {
  ...
  orient: {
    desc: "\n\n<p>工具栏 icon 的布局朝向。</p>\n<p>可选：</p>\n<ul>\n<li>&#39;horizontal&#39;</li>\n<li>&#39;vertical&#39;</li>\n</ul>\n",
    uiControl: { type: "enum", options: "vertical,horizontal" },
  },
  itemSize: { desc: "\n\n<p>工具栏 icon 的大小。</p>\n", uiControl: { type: "number", min: "0", default: "15" } },
  itemGap: {
    desc: "\n\n<p>工具栏 icon 每项之间的间隔。横向布局时为水平间隔，纵向布局时为纵向间隔。</p>\n",
    uiControl: { type: "number", min: "0", default: "8" },
  },
  ...
  "feature.saveAsImage.type": {
    ...
    uiControl: { type: "enum", options: "png,jpg" },
  },
  ...
  "feature.saveAsImage.excludeComponents": { desc: "<p>保存为图片时忽略的组件列表，默认忽略工具栏。</p>\n" },
  ...
  "feature.saveAsImage.emphasis.iconStyle.textBackgroundColor": { desc: "\n\n<p>文本区域填充色。</p>\n", uiControl: { type: "color" } },
  ...
  "feature.saveAsImage.pixelRatio": {
    ...
    uiControl: { type: "number", min: "0.5", max: "5", step: "0.5" },
  },
  "feature.restore": { desc: "<p>配置项还原。</p>\n" },
  ...
  "feature.restore.emphasis.iconStyle.textBackgroundColor": { desc: "\n\n<p>文本区域填充色。</p>\n", uiControl: { type: "color" } },
  ...
  "feature.dataView": { desc: "<p>数据视图工具，可以展现当前图表所用的数据，编辑后可以动态更新。</p>\n" },
  ...
  "feature.dataView.emphasis.iconStyle.textBackgroundColor": { desc: "\n\n<p>文本区域填充色。</p>\n", uiControl: { type: "color" } },
  ...
  "feature.dataView.readOnly": { desc: "\n\n<p>是否不可编辑（只读）。</p>\n", uiControl: { type: "boolean" } },
  ...
  "feature.dataView.textareaColor": { desc: "\n\n<p>数据视图浮层文本输入区背景色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  "feature.dataView.textareaBorderColor": {
    desc: "\n\n<p>数据视图浮层文本输入区边框颜色。</p>\n",
    uiControl: { type: "color", default: "#333" },
  },
  "feature.dataView.textColor": { desc: "\n\n<p>文本颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "feature.dataView.buttonColor": { desc: "\n\n<p>按钮颜色。</p>\n", uiControl: { type: "color", default: "#c23531" } },
  "feature.dataView.buttonTextColor": { desc: "\n\n<p>按钮文本颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  "feature.dataZoom": { desc: "<p>数据区域缩放。目前只支持直角坐标系的缩放。</p>\n" },
  ...
  "feature.dataZoom.emphasis.iconStyle.textBackgroundColor": { desc: "\n\n<p>文本区域填充色。</p>\n", uiControl: { type: "color" } },
  ...
  "feature.dataZoom.filterMode": { desc: '<p>与 <a href="#dataZoom.filterMode">dataZoom.filterMode</a> 含义和取值相同。</p>\n' },
  ...
  "feature.magicType.emphasis.iconStyle.textBackgroundColor": { desc: "\n\n<p>文本区域填充色。</p>\n", uiControl: { type: "color" } },
  ...
  "feature.magicType.option": { desc: "<p>各个类型的专有配置项。在切换到某类型的时候会合并相应的配置项。</p>\n" },
  ...
  "feature.brush.title": { desc: "<p>标题文本。</p>\n" },
  iconStyle: {
  ...
  "iconStyle.shadowOffsetX": { desc: "\n\n<p>阴影水平方向上的偏移距离。</p>\n", uiControl: { type: "number", default: "0", step: "0.5" } },
  "iconStyle.shadowOffsetY": { desc: "\n\n<p>阴影垂直方向上的偏移距离。</p>\n", uiControl: { type: "number", default: "0", step: "0.5" } },
  "iconStyle.opacity": {
    desc: "\n\n<p>图形透明度。支持从 0 到 1 的数字，为 0 时不绘制该图形。</p>\n",
    uiControl: { type: "number", default: "1", min: "0", max: "1", step: "0.01" },
  },
  ...
  "emphasis.iconStyle.textBackgroundColor": { desc: "\n\n<p>文本区域填充色。</p>\n", uiControl: { type: "color" } },
  "emphasis.iconStyle.textBorderRadius": {
    desc: "\n\n<p>文本区域圆角大小。</p>\n",
    uiControl: { type: "vector", min: "0", dims: "LT,RT,RB,LB" },
  },
  "emphasis.iconStyle.textPadding": { desc: "\n\n<p>文本区域内边距。</p>\n", uiControl: { type: "vector", min: "0", dims: "T,R,B,L" } },
  zlevel: {
