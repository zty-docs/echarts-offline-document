window.__EC_DOC_option_dataZoom_slider = {
  ...
  backgroundColor: { desc: "\n\n<p>组件的背景颜色。</p>\n", uiControl: { type: "color", default: "rgba(47,69,84,0)" } },
  dataBackground: { desc: "<p>数据阴影的样式。</p>\n" },
  ...
  "dataBackground.lineStyle.width": { desc: "\n\n<p>线宽。</p>\n", uiControl: { type: "number", value: "0.5", min: "0", step: "0.5" } },
  ...
  "dataBackground.areaStyle": { desc: "<p>阴影的填充样式</p>\n" },
  ...
  "dataBackground.areaStyle.opacity": {
    desc: "\n\n<p>图形透明度。支持从 0 到 1 的数字，为 0 时不绘制该图形。</p>\n",
    uiControl: { type: "number", default: "0.2", min: "0", max: "1", step: "0.01" },
  },
  ...
  "selectedDataBackground.areaStyle": { desc: "<p>选中部分阴影的填充样式</p>\n" },
  ...
  fillerColor: { desc: "\n\n<p>选中范围的填充颜色。</p>\n", uiControl: { type: "color", default: "rgba(167,183,204,0.4)" } },
  borderColor: { desc: "\n\n<p>边框颜色。</p>\n", uiControl: { type: "color", default: "#d2dbee" } },
  borderRadius: {
  ...
  handleSize: {
    ...
    uiControl: { type: "percent", min: "0", step: "1", default: "100%" },
  },
  handleStyle: { desc: "<p>两侧缩放手柄的样式配置。</p>\n" },
  "handleStyle.color": {
    desc: '\n\n<p>图形的颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  ...
  moveHandleSize: {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>移动手柄的尺寸高度。</p>\n',
    uiControl: { type: "number", min: "0", step: "1", default: "7" },
  },
  moveHandleStyle: {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>移动手柄的样式配置。</p>\n',
  },
  ...
  start: {
    ...
    uiControl: { type: "number", min: "0", max: "100", step: "0.5" },
  },
  end: {
    ...
    uiControl: { type: "number", min: "0", max: "100", default: "100", step: "0.5" },
  },
  startValue: {
  ...
  throttle: {
    ...
    uiControl: { type: "number", default: "100", min: "0", step: "20" },
  },
  rangeMode: {
  ...
  width: {
    ...
    uiControl: { type: "number", default: "30" },
  },
  height: {
  ...
  "brushStyle.shadowOffsetX": { desc: "\n\n<p>阴影水平方向上的偏移距离。</p>\n", uiControl: { type: "number", default: "0", step: "0.5" } },
  "brushStyle.shadowOffsetY": { desc: "\n\n<p>阴影垂直方向上的偏移距离。</p>\n", uiControl: { type: "number", default: "0", step: "0.5" } },
  "brushStyle.opacity": {
    desc: "\n\n<p>图形透明度。支持从 0 到 1 的数字，为 0 时不绘制该图形。</p>\n",
    uiControl: { type: "number", default: "1", min: "0", max: "1", step: "0.01" },
  },
  emphasis: { desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>高亮样式设置。</p>\n' },
