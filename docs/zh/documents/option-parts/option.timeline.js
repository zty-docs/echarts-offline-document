window.__EC_DOC_option_timeline = {
  ...
  type: { desc: '<p>这个属性目前只支持为 <code class="codespan">slider</code>，不需要更改。</p>\n' },
  axisType: {
  ...
  playInterval: {
    ...
    uiControl: { type: "number", min: "0", step: "20", default: "2000" },
  },
  ...
  controlPosition: {
    ...
    uiControl: { type: "enum", options: "left,right" },
  },
  zlevel: {
  ...
  orient: {
    ...
    uiControl: { type: "enum", options: "horizontal,vertical", default: "horizontal" },
  },
  inverse: {
  ...
  "label.position": {
    ...
    uiControl: { type: "enum", options: "auto,left,right,top,bottom" },
  },
  "label.show": { desc: "\n\n<p>是否显示 label。</p>\n", uiControl: { type: "boolean", default: "true" } },
  "label.interval": {
  ...
  "label.color": { desc: "\n\n<p>timeline.lable文字的颜色。</p>\n", uiControl: { type: "color", default: "'#A4B1D7'" } },
  "label.fontStyle": {
  ...
  "label.rich.<style_name>.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  itemStyle: { desc: "<p>timeline  图形样式。</p>\n" },
  "itemStyle.color": {
    desc: '\n\n<p>timeline 图形的颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  ...
  checkpointStyle: { desc: '<p>『当前项』（<code class="codespan">checkpoint</code>）的图形样式。</p>\n' },
  ...
  "checkpointStyle.shadowBlur": {
    desc: '\n\n<p>图形阴影的模糊大小。该属性配合 <code class="codespan">shadowColor</code>,<code class="codespan">shadowOffsetX</code>, <code class="codespan">shadowOffsetY</code> 一起设置图形的阴影效果。</p>\n<p>示例：</p>\n<pre><code class="lang-ts">{\n    shadowColor: &#39;rgba(0, 0, 0, 0.5)&#39;,\n    shadowBlur: 10\n}\n</code></pre>\n',
    uiControl: { type: "number", default: "2", min: "0", step: "0.5" },
  },
  "checkpointStyle.shadowColor": {
    desc: '\n\n<p>阴影颜色。支持的格式同<code class="codespan">color</code>。</p>\n',
    uiControl: { type: "color", default: "&#39;rgba(0, 0, 0, 0.3)&#39;" },
  },
  ...
  "checkpointStyle.animationDuration": {
    ...
    uiControl: { type: "number", min: "0", step: "20", default: "300" },
  },
  ...
  controlStyle: { desc: "<p>『控制按钮』的样式。『控制按钮』包括：『播放按钮』、『前进按钮』、『后退按钮』。</p>\n" },
  "controlStyle.show": {
    desc: '\n\n<p>是否显示『控制按钮』。设置为 <code class="codespan">false</code> 则全不显示。</p>\n',
    uiControl: { type: "boolean", default: "true" },
  },
  "controlStyle.showPlayBtn": { desc: "\n\n<p>是否显示『播放按钮』。</p>\n", uiControl: { type: "boolean", default: "true" } },
  "controlStyle.showPrevBtn": { desc: "\n\n<p>是否显示『后退按钮』。</p>\n", uiControl: { type: "boolean", default: "true" } },
  "controlStyle.showNextBtn": { desc: "\n\n<p>是否显示『前进按钮』。</p>\n", uiControl: { type: "boolean", default: "true" } },
  "controlStyle.itemSize": {
    desc: "\n\n<p>『控制按钮』的尺寸，单位为像素（px）。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5", default: "22" },
  },
  "controlStyle.itemGap": {
    desc: "\n\n<p>『控制按钮』的间隔，单位为像素（px）。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5", default: "12" },
  },
  "controlStyle.position": {
    ...
    uiControl: { type: "enum", options: "left,right,top,bottom" },
  },
  ...
  progress: { desc: "<p>进度条中的线条，拐点，标签的样式。</p>\n" },
  "progress.lineStyle.color": {
    desc: '\n\n<p>线的颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  "progress.lineStyle.width": { desc: "\n\n<p>线宽。</p>\n", uiControl: { type: "number", value: "1", min: "0", step: "0.5" } },
  ...
  "progress.label.color": { desc: "\n\n<p>timeline.lable文字的颜色。</p>\n", uiControl: { type: "color", default: "'#6f778d'" } },
  ...
  "progress.label.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  "progress.label.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "progress.label.borderRadius": { desc: "\n\n<p>文字块的圆角。</p>\n", uiControl: { type: "vector", min: "0", dims: "LT,RT, RB, LB" } },
  "progress.label.padding": {
    desc: '\n\n<p>文字块的内边距。例如：</p>\n<ul>\n<li><code class="codespan">padding: [3, 4, 5, 6]</code>：表示 <code class="codespan">[上, 右, 下, 左]</code> 的边距。</li>\n<li><code class="codespan">padding: 4</code>：表示 <code class="codespan">padding: [4, 4, 4, 4]</code>。</li>\n<li><code class="codespan">padding: [3, 4]</code>：表示 <code class="codespan">padding: [3, 4, 3, 4]</code>。</li>\n</ul>\n<p>注意，文字块的 <code class="codespan">width</code> 和 <code class="codespan">height</code> 指定的是内容高宽，不包含 <code class="codespan">padding</code>。</p>\n',
    uiControl: { type: "vector", min: "0", dims: "T,R,B,L" },
  },
  "progress.label.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "progress.label.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "progress.label.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "progress.label.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "progress.label.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  "progress.label.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "progress.label.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "progress.label.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "progress.label.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "progress.label.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "progress.label.rich.<style_name>.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "progress.label.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "emphasis.label.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "emphasis.label.rich.<style_name>.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "emphasis.checkpointStyle": { desc: "<p>当前项『高亮状态』的样式（hover时）。</p>\n" },
