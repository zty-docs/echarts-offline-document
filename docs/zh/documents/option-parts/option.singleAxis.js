window.__EC_DOC_option_singleAxis = {
  ...
  nameLocation: {
    ...
    uiControl: { type: "enum", options: "start,middle,end", default: "end" },
  },
  ...
  "nameTextStyle.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  "nameTextStyle.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "nameTextStyle.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "nameTextStyle.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "nameTextStyle.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "nameTextStyle.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "nameTextStyle.width": {
    desc: "\n\n<p>文本显示宽度。</p>\n",
  ...
  "nameTextStyle.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  "nameTextStyle.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "nameTextStyle.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "nameTextStyle.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "nameTextStyle.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "nameTextStyle.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "nameTextStyle.rich.<style_name>.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "nameTextStyle.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  nameGap: { desc: "\n\n<p>坐标轴名称与轴线之间的距离。</p>\n", uiControl: { type: "number", step: "0.5", default: "15" } },
  nameRotate: { desc: "\n\n<p>坐标轴名字旋转，角度值。</p>\n", uiControl: { type: "angle", min: "-360", max: "360", step: "1" } },
  nameTruncate: { desc: "<p>坐标轴名字的截断。</p>\n" },
  "nameTruncate.maxWidth": { desc: "<p>截断文本的最大长度，超过此长度会被截断。</p>\n" },
  "nameTruncate.ellipsis": { desc: "<p>截断后文字末尾显示的内容。</p>\n" },
  ...
  splitNumber: {
    ...
    uiControl: { type: "number", min: "1", step: "1", default: "5" },
  },
  minInterval: {
  ...
  logBase: {
    ...
    uiControl: { type: "number", default: "10" },
  },
  startValue: {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.5.1</code> 开始支持</p>\n</blockquote>\n<p>用于指定轴的起始值。</p>\n',
    uiControl: { type: "number" },
  },
  silent: { desc: "<p>坐标轴是否是静态无法交互。</p>\n" },
  triggerEvent: {
  ...
  "axisTick.interval": {
    ...
    uiControl: { type: "number", min: "0", step: "1" },
  },
  "axisTick.inside": { desc: "\n\n<p>坐标轴刻度是否朝内，默认朝外。</p>\n", uiControl: { type: "boolean" } },
  "axisTick.length": { desc: "\n\n<p>坐标轴刻度的长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5", default: "5" } },
  "axisTick.lineStyle": { desc: "<p>刻度线的样式设置。</p>\n" },
  ...
  "axisTick.customValues": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.5.1</code> 开始支持</p>\n</blockquote>\n<p>自定义要显示的坐标轴刻度位置。例如：</p>\n<pre><code class="lang-ts">axisTick: {\n    alignWithLabel: true,\n    customValues: [0, 0.5, 1, 1.5, 2, 8, 9]\n}\n</code></pre>\n<p><img width="600" height="auto" src="documents/asset/img/axis-tick-label-custom-values.png"></p>\n',
  },
  minorTick: {
    desc: '<blockquote>\n<p>从 <code class="codespan">v4.6.0</code> 开始支持</p>\n</blockquote>\n<p>坐标轴次刻度线相关设置。</p>\n<p>注意：次刻度线无法在类目轴（<a href="#singleAxis.type">type</a>: <code class="codespan">&#39;category&#39;</code>）中使用。</p>\n<p>示例：</p>\n<p>1) 函数绘图中使用次刻度线</p>\n<iframe  data-src="../../examples/zh/view.html?c=line-function&edit=1&reset=1" width="600" height="350"></iframe>\n\n\n<p>2) 在对数轴中使用次刻度线</p>\n<iframe  data-src="../../examples/zh/view.html?c=line-log&edit=1&reset=1" width="600" height="350"></iframe>\n\n',
  },
  "minorTick.show": { desc: "\n\n<p>是否显示次刻度线。</p>\n", uiControl: { type: "boolean", default: "true" } },
  ...
  "axisLabel.inside": { desc: "\n\n<p>刻度标签是否朝内，默认朝外。</p>\n", uiControl: { type: "boolean" } },
  "axisLabel.rotate": {
    desc: "\n\n<p>刻度标签旋转的角度，在类目轴的类目标签显示不下的时候可以通过旋转防止标签之间重叠。</p>\n<p>旋转的角度从 -90 度到 90 度。</p>\n",
    uiControl: { type: "angle", min: "-90", max: "90", step: "1" },
  },
  "axisLabel.margin": { desc: "\n\n<p>刻度标签与轴线之间的距离。</p>\n", uiControl: { type: "number", default: "8", step: "0.5" } },
  "axisLabel.formatter": {
  ...
  "axisLabel.customValues": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.5.1</code> 开始支持</p>\n</blockquote>\n<p>自定义要显示的标签位置。例如：</p>\n<pre><code class="lang-ts">axisLabel: {\n    customValues: [0, 4, 7, 8, 9]\n}\n</code></pre>\n<p><img width="600" height="auto" src="documents/asset/img/axis-tick-label-custom-values.png"></p>\n',
  },
  "axisLabel.color": {
  ...
  splitLine: { desc: '<p>坐标轴在 <a href="#grid">grid</a> 区域中的分隔线。</p>\n' },
  "splitLine.show": {
  ...
  splitArea: { desc: '<p>坐标轴在 <a href="#grid">grid</a> 区域中的分隔区域，默认不显示。</p>\n' },
  "splitArea.interval": {
  ...
  "data.textStyle.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  "data.textStyle.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "data.textStyle.borderRadius": { desc: "\n\n<p>文字块的圆角。</p>\n", uiControl: { type: "vector", min: "0", dims: "LT,RT, RB, LB" } },
  "data.textStyle.padding": {
    desc: '\n\n<p>文字块的内边距。例如：</p>\n<ul>\n<li><code class="codespan">padding: [3, 4, 5, 6]</code>：表示 <code class="codespan">[上, 右, 下, 左]</code> 的边距。</li>\n<li><code class="codespan">padding: 4</code>：表示 <code class="codespan">padding: [4, 4, 4, 4]</code>。</li>\n<li><code class="codespan">padding: [3, 4]</code>：表示 <code class="codespan">padding: [3, 4, 3, 4]</code>。</li>\n</ul>\n<p>注意，文字块的 <code class="codespan">width</code> 和 <code class="codespan">height</code> 指定的是内容高宽，不包含 <code class="codespan">padding</code>。</p>\n',
    uiControl: { type: "vector", min: "0", dims: "T,R,B,L" },
  },
  "data.textStyle.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "data.textStyle.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "data.textStyle.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "data.textStyle.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "data.textStyle.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  "data.textStyle.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "data.textStyle.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "data.textStyle.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "data.textStyle.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "data.textStyle.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "data.textStyle.rich.<style_name>.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "data.textStyle.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  axisPointer: { desc: "<p>坐标轴指示器配置项。</p>\n" },
  "axisPointer.show": {
  ...
  "axisPointer.type": {
    ...
    uiControl: { type: "enum", options: "line,shadow,none" },
  },
  "axisPointer.snap": {
  ...
  "axisPointer.label.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  "axisPointer.label.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "axisPointer.label.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "axisPointer.label.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "axisPointer.label.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "axisPointer.label.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "axisPointer.label.shadowBlur": {
    desc: '\n\n<p>图形阴影的模糊大小。该属性配合 <code class="codespan">shadowColor</code>,<code class="codespan">shadowOffsetX</code>, <code class="codespan">shadowOffsetY</code> 一起设置图形的阴影效果。</p>\n<p>示例：</p>\n<pre><code class="lang-ts">{\n    shadowColor: &#39;rgba(0, 0, 0, 0.5)&#39;,\n    shadowBlur: 10\n}\n</code></pre>\n',
    uiControl: { type: "number", default: "3", min: "0", step: "0.5" },
  },
  "axisPointer.label.shadowColor": {
    desc: '\n\n<p>阴影颜色。支持的格式同<code class="codespan">color</code>。</p>\n',
    uiControl: { type: "color", default: "#aaa" },
  },
  ...
  "axisPointer.lineStyle.width": { desc: "\n\n<p>线宽。</p>\n", uiControl: { type: "number", value: "1", min: "0", step: "0.5" } },
  ...
  "axisPointer.triggerEmphasis": {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.4.3</code> 开始支持</p>\n</blockquote>\n<p>是否触发系列强调功能。</p>\n',
    uiControl: { type: "boolean", default: "true" },
  },
  ...
  "axisPointer.status": {
    ...
    uiControl: { type: "enum", options: "show,hide" },
  },
  "axisPointer.handle": {
  ...
  "axisPointer.handle.shadowOffsetX": {
    desc: "\n\n<p>阴影水平方向上的偏移距离。</p>\n",
    uiControl: { type: "number", default: "2", step: "0.5" },
  },
  ...
  "tooltip.axisPointer.label.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "tooltip.axisPointer.label.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  ...
  "tooltip.axisPointer.lineStyle.width": { desc: "\n\n<p>线宽。</p>\n", uiControl: { type: "number", value: "1", min: "0", step: "0.5" } },
  ...
  "tooltip.axisPointer.crossStyle.width": { desc: "\n\n<p>线宽。</p>\n", uiControl: { type: "number", value: "1", min: "0", step: "0.5" } },
  ...
  "tooltip.axisPointer.animation": { desc: "\n\n<p>是否开启动画。</p>\n", uiControl: { type: "boolean", default: "true", clean: "true" } },
  "tooltip.axisPointer.animationThreshold": { desc: "<p>是否开启动画的阈值，当单个系列显示的图形数量大于这个阈值时会关闭动画。</p>\n" },
  ...
  "tooltip.textStyle": { desc: "<p>提示框浮层的文本样式。</p>\n" },
