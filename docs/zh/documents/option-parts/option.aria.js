window.__EC_DOC_option_aria = {
  ...
  "label.general": { desc: "<p>对于图表的整体性描述。</p>\n" },
  ...
  "label.series": { desc: "<p>系列相关的配置项。</p>\n" },
  "label.series.maxCount": { desc: "<p>描述中最多出现的系列个数。</p>\n" },
  "label.series.single": { desc: "<p>当图表只包含一个系列时，采用的描述。</p>\n" },
  ...
  "label.series.multiple": { desc: "<p>当图表只包含多个系列时，采用的描述。</p>\n" },
  ...
  "label.series.multiple.separator": { desc: "<p>系列与系列之间描述的分隔符。</p>\n" },
  "label.series.multiple.separator.middle": { desc: "<p>除了最后一个系列后的分隔符。</p>\n" },
  "label.series.multiple.separator.end": { desc: "<p>最后一个系列后的分隔符。</p>\n" },
  "label.data": { desc: "<p>数据相关的配置项。</p>\n" },
  "label.data.maxCount": { desc: "<p>描述中每个系列最多出现的数据个数。</p>\n" },
  "label.data.allData": {
  ...
  "label.data.separator": { desc: "<p>数据与数据之间描述的分隔符。</p>\n" },
  "label.data.separator.middle": { desc: "<p>除了最后一个数据后的分隔符。</p>\n" },
  ...
  "decal.decals.symbolKeepAspect": { desc: "<p>是否保持图案的长宽比。</p>\n" },
  "decal.decals.color": { desc: "<p>贴花图案的颜色，建议使用半透明色，这样能叠加在系列本身的颜色上。</p>\n" },
  "decal.decals.backgroundColor": { desc: "<p>贴花的背景色，将会覆盖在系列本身颜色之上，贴花图案之下。</p>\n" },
