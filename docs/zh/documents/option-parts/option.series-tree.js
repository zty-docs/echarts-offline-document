window.__EC_DOC_option_series_tree = {
  ...
  height: { desc: "\n\n<p>tree组件的高度。</p>\n", uiControl: { type: "percent", default: "50%" } },
  center: {
    desc: '<p>当前视角的中心点。可以是包含两个 <code class="codespan">number</code> 类型（表示像素值）或 <code class="codespan">string</code> 类型（表示相对容器的百分比）的数组。\n从 <code class="codespan">5.3.3</code> 版本开始支持 <code class="codespan">string</code> 类型。</p>\n<p>例如：</p>\n<pre><code class="lang-ts">center: [115.97, &#39;30%&#39;]\n</code></pre>\n',
  },
  zoom: { desc: "<p>当前视角的缩放比例。</p>\n" },
  layout: {
    desc: '\n\n<p>树图的布局，有 <code class="codespan">正交</code> 和 <code class="codespan">径向</code> 两种。这里的 <code class="codespan">正交布局</code> 就是我们通常所说的 <code class="codespan">水平</code> 和 <code class="codespan">垂直</code> 方向，对应的参数取值为 <code class="codespan">&#39;orthogonal&#39;</code> 。而 <code class="codespan">径向布局</code> 是指以根节点为圆心，每一层节点为环，一层层向外发散绘制而成的布局，对应的参数取值为 <code class="codespan">&#39;radial&#39;</code> 。</p>\n<p><strong>正交布局示例：</strong></p>\n<iframe  data-src="../../examples/zh/view.html?c=tree-basic&edit=1&reset=1" width="780" height="900"></iframe>\n\n\n\n<p><strong>径向布局示例：</strong></p>\n<iframe  data-src="../../examples/zh/view.html?c=tree-radial&edit=1&reset=1" width="800" height="800"></iframe>\n\n',
    uiControl: { type: "enum", options: "orthogonal,radial", default: "orthogonal" },
  },
  orient: {
    ...
    uiControl: { type: "enum", options: "LR,RL,TB,BT", default: "LR" },
  },
  symbol: {
  ...
  edgeShape: {
    ...
    uiControl: { type: "enum", options: "curve,polyline", default: "curve" },
  },
  edgeForkPosition: {
  ...
  initialTreeDepth: {
    ...
    uiControl: { type: "number", default: "2", min: "0", step: "1" },
  },
  itemStyle: {
  ...
  "itemStyle.borderWidth": {
    desc: "\n\n<p>描边线宽。为 0 时无描边。</p>\n",
    uiControl: { type: "number", value: "1.5", min: "0", step: "0.5" },
  },
  ...
  label: { desc: '<p><code class="codespan">label</code> 描述了每个节点所对应的文本标签的样式。</p>\n' },
  "label.show": { desc: "\n\n<p>是否显示标签。</p>\n", uiControl: { type: "boolean", default: "true" } },
  "label.position": {
  ...
  lineStyle: { desc: "<p>定义树图边的样式。</p>\n" },
  "lineStyle.color": { desc: "\n\n<p>树图边的颜色。</p>\n", uiControl: { type: "color", default: "#ccc" } },
  "lineStyle.width": { desc: "\n\n<p>树图边的宽度。</p>\n", uiControl: { type: "number", default: "1.5", min: "0" } },
  "lineStyle.curveness": { desc: "\n\n<p>树图边的曲度。</p>\n", uiControl: { type: "number", default: "0.5", min: "0" } },
  ...
  emphasis: { desc: "<p>树图中个图形和标签高亮的样式。</p>\n" },
  "emphasis.disabled": {
  ...
  "emphasis.lineStyle": { desc: "<p>定义树图边的样式。</p>\n" },
  "emphasis.lineStyle.color": { desc: "\n\n<p>树图边的颜色。</p>\n", uiControl: { type: "color", default: "#ccc" } },
  "emphasis.lineStyle.width": { desc: "\n\n<p>树图边的宽度。</p>\n", uiControl: { type: "number", default: "1.5", min: "0" } },
  "emphasis.lineStyle.curveness": { desc: "\n\n<p>树图边的曲度。</p>\n", uiControl: { type: "number", default: "0.5", min: "0" } },
  ...
  "blur.lineStyle": { desc: "<p>定义树图边的样式。</p>\n" },
  "blur.lineStyle.color": { desc: "\n\n<p>树图边的颜色。</p>\n", uiControl: { type: "color", default: "#ccc" } },
  "blur.lineStyle.width": { desc: "\n\n<p>树图边的宽度。</p>\n", uiControl: { type: "number", default: "1.5", min: "0" } },
  "blur.lineStyle.curveness": { desc: "\n\n<p>树图边的曲度。</p>\n", uiControl: { type: "number", default: "0.5", min: "0" } },
  ...
  "select.itemStyle": { desc: "<p>该节点的样式。</p>\n" },
  ...
  "select.lineStyle": { desc: "<p>定义树图边的样式。</p>\n" },
  "select.lineStyle.color": { desc: "\n\n<p>树图边的颜色。</p>\n", uiControl: { type: "color", default: "#ccc" } },
  "select.lineStyle.width": { desc: "\n\n<p>树图边的宽度。</p>\n", uiControl: { type: "number", default: "1.5", min: "0" } },
  "select.lineStyle.curveness": { desc: "\n\n<p>树图边的曲度。</p>\n", uiControl: { type: "number", default: "0.5", min: "0" } },
  ...
  leaves: { desc: "<p>叶子节点的特殊配置，如上面的树图实例中，叶子节点和非叶子节点的标签位置不同。</p>\n" },
  "leaves.label": { desc: "<p>描述了叶子节点所对应的文本标签的样式。</p>\n" },
  ...
  "leaves.label.borderRadius": { desc: "\n\n<p>文字块的圆角。</p>\n", uiControl: { type: "vector", min: "0", dims: "LT,RT, RB, LB" } },
  "leaves.label.padding": {
    desc: '\n\n<p>文字块的内边距。例如：</p>\n<ul>\n<li><code class="codespan">padding: [3, 4, 5, 6]</code>：表示 <code class="codespan">[上, 右, 下, 左]</code> 的边距。</li>\n<li><code class="codespan">padding: 4</code>：表示 <code class="codespan">padding: [4, 4, 4, 4]</code>。</li>\n<li><code class="codespan">padding: [3, 4]</code>：表示 <code class="codespan">padding: [3, 4, 3, 4]</code>。</li>\n</ul>\n<p>注意，文字块的 <code class="codespan">width</code> 和 <code class="codespan">height</code> 指定的是内容高宽，不包含 <code class="codespan">padding</code>。</p>\n',
    uiControl: { type: "vector", min: "0", dims: "T,R,B,L" },
  },
  "leaves.label.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "leaves.label.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "leaves.label.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "leaves.label.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "leaves.label.width": {
    desc: "\n\n<p>文本显示宽度。</p>\n",
    uiControl: { type: "number", default: "100", min: "1", max: "500", step: "1" },
  },
  ...
  "leaves.label.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "leaves.label.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "leaves.label.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "leaves.label.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "leaves.label.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "leaves.label.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "leaves.itemStyle": { desc: "<p>树图中叶子节点的样式。</p>\n" },
  ...
  "leaves.emphasis": { desc: "<p>叶子节点高亮状态的配置。</p>\n" },
  "leaves.emphasis.disabled": {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.3.0</code> 开始支持</p>\n</blockquote>\n<p>是否关闭高亮状态。</p>\n<p>关闭高亮状态可以在鼠标移到图形上，tooltip 触发，或者图例联动的时候不再触发高亮效果。在图形非常多的时候可以关闭以提升交互流畅性。</p>\n',
    uiControl: { type: "boolean", default: "false" },
  },
  "leaves.emphasis.itemStyle": { desc: "<p>该节点的样式。</p>\n" },
  ...
  "leaves.emphasis.lineStyle": { desc: "<p>定义树图边的样式。</p>\n" },
  "leaves.emphasis.lineStyle.color": { desc: "\n\n<p>树图边的颜色。</p>\n", uiControl: { type: "color", default: "#ccc" } },
  "leaves.emphasis.lineStyle.width": { desc: "\n\n<p>树图边的宽度。</p>\n", uiControl: { type: "number", default: "1.5", min: "0" } },
  "leaves.emphasis.lineStyle.curveness": { desc: "\n\n<p>树图边的曲度。</p>\n", uiControl: { type: "number", default: "0.5", min: "0" } },
  ...
  "leaves.emphasis.label.show": { desc: "\n\n<p>是否显示标签。</p>\n", uiControl: { type: "boolean", default: "false" } },
  ...
  "leaves.emphasis.label.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "leaves.emphasis.label.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "leaves.emphasis.label.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "leaves.emphasis.label.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "leaves.emphasis.label.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "leaves.emphasis.label.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "leaves.emphasis.label.textShadowBlur": {
    desc: "\n\n<p>文字本身的阴影长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  "leaves.emphasis.label.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "leaves.emphasis.label.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "leaves.emphasis.label.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "leaves.blur.lineStyle": { desc: "<p>定义树图边的样式。</p>\n" },
  "leaves.blur.lineStyle.color": { desc: "\n\n<p>树图边的颜色。</p>\n", uiControl: { type: "color", default: "#ccc" } },
  "leaves.blur.lineStyle.width": { desc: "\n\n<p>树图边的宽度。</p>\n", uiControl: { type: "number", default: "1.5", min: "0" } },
  "leaves.blur.lineStyle.curveness": { desc: "\n\n<p>树图边的曲度。</p>\n", uiControl: { type: "number", default: "0.5", min: "0" } },
  ...
  "leaves.blur.label.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "leaves.blur.label.borderRadius": { desc: "\n\n<p>文字块的圆角。</p>\n", uiControl: { type: "vector", min: "0", dims: "LT,RT, RB, LB" } },
  "leaves.blur.label.padding": {
    desc: '\n\n<p>文字块的内边距。例如：</p>\n<ul>\n<li><code class="codespan">padding: [3, 4, 5, 6]</code>：表示 <code class="codespan">[上, 右, 下, 左]</code> 的边距。</li>\n<li><code class="codespan">padding: 4</code>：表示 <code class="codespan">padding: [4, 4, 4, 4]</code>。</li>\n<li><code class="codespan">padding: [3, 4]</code>：表示 <code class="codespan">padding: [3, 4, 3, 4]</code>。</li>\n</ul>\n<p>注意，文字块的 <code class="codespan">width</code> 和 <code class="codespan">height</code> 指定的是内容高宽，不包含 <code class="codespan">padding</code>。</p>\n',
    uiControl: { type: "vector", min: "0", dims: "T,R,B,L" },
  },
  "leaves.blur.label.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "leaves.blur.label.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "leaves.blur.label.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "leaves.blur.label.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "leaves.blur.label.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "leaves.blur.label.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "leaves.blur.label.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "leaves.blur.label.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "leaves.blur.label.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "leaves.blur.label.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "leaves.select.itemStyle": { desc: "<p>该节点的样式。</p>\n" },
  ...
  "leaves.select.lineStyle": { desc: "<p>定义树图边的样式。</p>\n" },
  "leaves.select.lineStyle.color": { desc: "\n\n<p>树图边的颜色。</p>\n", uiControl: { type: "color", default: "#ccc" } },
  "leaves.select.lineStyle.width": { desc: "\n\n<p>树图边的宽度。</p>\n", uiControl: { type: "number", default: "1.5", min: "0" } },
  "leaves.select.lineStyle.curveness": { desc: "\n\n<p>树图边的曲度。</p>\n", uiControl: { type: "number", default: "0.5", min: "0" } },
  ...
  "leaves.select.label.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "leaves.select.label.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "leaves.select.label.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "leaves.select.label.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "leaves.select.label.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "leaves.select.label.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "leaves.select.label.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "leaves.select.label.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "leaves.select.label.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "leaves.select.label.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "data.name": { desc: "<p>树节点的名称，用来标识每一个节点。</p>\n" },
  "data.value": { desc: "<p>节点的值，在 tooltip 中显示。</p>\n" },
  "data.collapsed": { desc: "<p>节点初始化是否折叠。</p>\n" },
  ...
  "data.lineStyle": { desc: "<p>该节点对应的边的样式。</p>\n" },
  "data.lineStyle.color": { desc: "\n\n<p>树图边的颜色。</p>\n", uiControl: { type: "color", default: "#ccc" } },
  "data.lineStyle.width": { desc: "\n\n<p>树图边的宽度。</p>\n", uiControl: { type: "number", default: "1.5", min: "0" } },
  "data.lineStyle.curveness": { desc: "\n\n<p>树图边的曲度。</p>\n", uiControl: { type: "number", default: "0.5", min: "0" } },
  ...
  "data.emphasis": { desc: "<p>节点高亮状态的配置。</p>\n" },
  "data.emphasis.disabled": {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v5.3.0</code> 开始支持</p>\n</blockquote>\n<p>是否关闭高亮状态。</p>\n<p>关闭高亮状态可以在鼠标移到图形上，tooltip 触发，或者图例联动的时候不再触发高亮效果。在图形非常多的时候可以关闭以提升交互流畅性。</p>\n',
    uiControl: { type: "boolean", default: "false" },
  },
  "data.emphasis.itemStyle": { desc: "<p>该节点的样式。</p>\n" },
  ...
  "data.emphasis.lineStyle": { desc: "<p>定义树图边的样式。</p>\n" },
  "data.emphasis.lineStyle.color": { desc: "\n\n<p>树图边的颜色。</p>\n", uiControl: { type: "color", default: "#ccc" } },
  "data.emphasis.lineStyle.width": { desc: "\n\n<p>树图边的宽度。</p>\n", uiControl: { type: "number", default: "1.5", min: "0" } },
  "data.emphasis.lineStyle.curveness": { desc: "\n\n<p>树图边的曲度。</p>\n", uiControl: { type: "number", default: "0.5", min: "0" } },
  ...
  "data.blur.lineStyle": { desc: "<p>定义树图边的样式。</p>\n" },
  "data.blur.lineStyle.color": { desc: "\n\n<p>树图边的颜色。</p>\n", uiControl: { type: "color", default: "#ccc" } },
  "data.blur.lineStyle.width": { desc: "\n\n<p>树图边的宽度。</p>\n", uiControl: { type: "number", default: "1.5", min: "0" } },
  "data.blur.lineStyle.curveness": { desc: "\n\n<p>树图边的曲度。</p>\n", uiControl: { type: "number", default: "0.5", min: "0" } },
  ...
  "data.select.itemStyle": { desc: "<p>该节点的样式。</p>\n" },
  ...
  "data.select.lineStyle": { desc: "<p>定义树图边的样式。</p>\n" },
  "data.select.lineStyle.color": { desc: "\n\n<p>树图边的颜色。</p>\n", uiControl: { type: "color", default: "#ccc" } },
  "data.select.lineStyle.width": { desc: "\n\n<p>树图边的宽度。</p>\n", uiControl: { type: "number", default: "1.5", min: "0" } },
  "data.select.lineStyle.curveness": { desc: "\n\n<p>树图边的曲度。</p>\n", uiControl: { type: "number", default: "0.5", min: "0" } },
  ...
  "data.animationThreshold": { desc: "<p>是否开启动画的阈值，当单个系列显示的图形数量大于这个阈值时会关闭动画。</p>\n" },
