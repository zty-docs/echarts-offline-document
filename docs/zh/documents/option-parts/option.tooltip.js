window.__EC_DOC_option_tooltip = {
  ...
  "axisPointer.crossStyle.width": { desc: "\n\n<p>线宽。</p>\n", uiControl: { type: "number", value: "1", min: "0", step: "0.5" } },
  ...
  "axisPointer.animation": { desc: "\n\n<p>是否开启动画。</p>\n", uiControl: { type: "boolean", default: "true", clean: "true" } },
  "axisPointer.animationThreshold": { desc: "<p>是否开启动画的阈值，当单个系列显示的图形数量大于这个阈值时会关闭动画。</p>\n" },
  ...
  renderMode: {
    ...
    uiControl: { type: "enum", options: "html,richText", default: "html" },
  },
  confine: {
  ...
  transitionDuration: {
    ...
    uiControl: { type: "number", min: "0", step: "0.1", default: "0.4" },
  },
  position: {
  ...
  order: {
    ...
    uiControl: { type: "enum", options: "seriesAsc,seriesDesc,valueAsc,valueDesc", default: "seriesAsc" },
  },
};
