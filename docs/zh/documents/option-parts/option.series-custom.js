window.__EC_DOC_option_series_custom = {
  ...
  colorBy: {
    ...
    uiControl: { type: "enum", options: "series,data" },
  },
  legendHoverLink: {
  ...
  geoIndex: { desc: '<p>使用的<a href="#geo">地理坐标系</a>的 index，在单个图表实例中存在多个地理坐标系的时候有用。</p>\n' },
  calendarIndex: { desc: '<p>使用的<a href="#calendar">日历坐标系</a>的 index，在单个图表实例中存在多个日历坐标系的时候有用。</p>\n' },
  renderItem: {
  ...
  "renderItem.arguments": { desc: "<p>renderItem 函数的参数。</p>\n" },
  ...
  "renderItem.arguments.api": { desc: "<p>renderItem 函数的第二个参数。</p>\n" },
  ...
  "renderItem.arguments.api.getWidth": { desc: "<pre><code>@return {number} echarts 容器的宽度。\n</code></pre>" },
  "renderItem.arguments.api.getHeight": { desc: "<pre><code>@return {number} echarts 容器的高度。\n</code></pre>" },
  "renderItem.arguments.api.getZr": { desc: "<pre><code>@return {module:zrender} zrender 实例。\n</code></pre>" },
  "renderItem.arguments.api.getDevicePixelRatio": { desc: "<pre><code>@return {number} 得到当前 devicePixelRatio。\n</code></pre>" },
  "renderItem.return": {
  ...
  "renderItem.return_group": {
    desc: '<p>group 是唯一的可以有子节点的容器。group 可以用来整体定位一组图形元素。</p>\n<p>注意，如果其任意子节点是 <code class="codespan">null</code>，这表示该子节点不再存在。所以，如果再次调用 <code class="codespan">setOption</code> 时，一个子节点被设为 <code class="codespan">null</code>，这意味着它之前对应序号的元素会被删除。如果希望一个子节点保持不变，应在新的配置项中使用 <code class="codespan">{}</code> 表示。并且，仅当 group 的子节点在之前的 <code class="codespan">setOption</code> 中存在时，才可以使用 <code class="codespan">null/undefined/{}</code> 作为子节点。</p>\n',
  },
  ...
  "renderItem.return_group.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_group.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_group.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_group.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_group.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_group.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_group.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_group.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_group.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_group.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_group.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_group.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  ...
  "renderItem.return_group.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_group.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_group.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_group.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_group.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  "renderItem.return_group.textConfig.local": { desc: '<p>如果 <code class="codespan">true</code> 的话，会采用节点的 transform。</p>\n' },
  ...
  "renderItem.return_group.children": { desc: "<p>子节点列表，其中项都是一个图形元素定义。</p>\n" },
  ...
  "renderItem.return_path.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_path.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_path.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_path.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_path.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_path.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_path.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_path.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_path.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_path.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_path.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_path.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  ...
  "renderItem.return_path.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_path.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_path.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_path.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_path.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_path.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  "renderItem.return_path.textConfig.local": { desc: '<p>如果 <code class="codespan">true</code> 的话，会采用节点的 transform。</p>\n' },
  ...
  "renderItem.return_path.shape.x": { desc: "<p>图形元素的左上角在父节点坐标系（以父节点左上角为原点）中的横坐标值。</p>\n" },
  "renderItem.return_path.shape.y": { desc: "<p>图形元素的左上角在父节点坐标系（以父节点左上角为原点）中的纵坐标值。</p>\n" },
  "renderItem.return_path.shape.width": { desc: "<p>图形元素的宽度。</p>\n" },
  "renderItem.return_path.shape.height": { desc: "<p>图形元素的高度。</p>\n" },
  ...
  "renderItem.return_path.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_path.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_path.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_path.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_path.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_path.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_path.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_path.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_path.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_path.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  "renderItem.return_path.emphasis.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_path.blur": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的淡出状态，配置<code class="codespan">focus</code>时有效。</p>\n',
  },
  "renderItem.return_path.blur.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_path.select": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的选中状态，配置自定义系列的 <a href="#series-custom.selectedMode">selectedMode</a> 时有效。</p>\n',
  },
  "renderItem.return_path.select.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_image.type": {
    desc: '<p>用 setOption 首次设定图形元素时必须指定。\n可取值：</p>\n<p><a href="#series-custom.renderItem.return_image">image</a>,\n<a href="#series-custom.renderItem.return_text">text</a>,\n<a href="#series-custom.renderItem.return_circle">circle</a>,\n<a href="#series-custom.renderItem.return_sector">sector</a>,\n<a href="#series-custom.renderItem.return_ring">ring</a>,\n<a href="#series-custom.renderItem.return_polygon">polygon</a>,\n<a href="#series-custom.renderItem.return_polyline">polyline</a>,\n<a href="#series-custom.renderItem.return_rect">rect</a>,\n<a href="#series-custom.renderItem.return_line">line</a>,\n<a href="#series-custom.renderItem.return_bezierCurve">bezierCurve</a>,\n<a href="#series-custom.renderItem.return_arc">arc</a>,\n<a href="#series-custom.renderItem.return_group">group</a>,</p>\n',
  },
  "renderItem.return_image.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_image.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_image.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_image.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_image.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_image.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_image.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_image.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_image.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_image.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_image.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_image.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  "renderItem.return_image.keyframeAnimation.keyframes": {
    desc: '<p>动画的关键帧。数组中每一项为一个关键帧，格式如下：</p>\n<pre><code class="lang-ts">interface Keyframe {\n    // 关键帧位置。0 为第一帧，1 为最后一帧\n    // 关键帧时间为 percent * duration + delay\n    percent: number\n    // 上一个关键帧到这个关键帧运行时的缓动函数。可选\n    easing?: number\n\n    // 其它属性为图形在这个关键帧的属性，例如 x, y, style, shape 等\n}\n</code></pre>\n',
  },
  "renderItem.return_image.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_image.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_image.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_image.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_image.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_image.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  "renderItem.return_image.textConfig.local": { desc: '<p>如果 <code class="codespan">true</code> 的话，会采用节点的 transform。</p>\n' },
  ...
  "renderItem.return_image.style.x": { desc: "<p>图形元素的左上角在父节点坐标系（以父节点左上角为原点）中的横坐标值。</p>\n" },
  "renderItem.return_image.style.y": { desc: "<p>图形元素的左上角在父节点坐标系（以父节点左上角为原点）中的纵坐标值。</p>\n" },
  "renderItem.return_image.style.width": { desc: "<p>图形元素的宽度。</p>\n" },
  ...
  "renderItem.return_image.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_image.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_image.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_image.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_image.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_image.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_image.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_image.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_image.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_image.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  ...
  "renderItem.return_image.blur.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_image.select": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的选中状态，配置自定义系列的 <a href="#series-custom.selectedMode">selectedMode</a> 时有效。</p>\n',
  },
  "renderItem.return_image.select.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_text": { desc: "<p>文本块。</p>\n" },
  "renderItem.return_text.type": {
    desc: '<p>用 setOption 首次设定图形元素时必须指定。\n可取值：</p>\n<p><a href="#series-custom.renderItem.return_image">image</a>,\n<a href="#series-custom.renderItem.return_text">text</a>,\n<a href="#series-custom.renderItem.return_circle">circle</a>,\n<a href="#series-custom.renderItem.return_sector">sector</a>,\n<a href="#series-custom.renderItem.return_ring">ring</a>,\n<a href="#series-custom.renderItem.return_polygon">polygon</a>,\n<a href="#series-custom.renderItem.return_polyline">polyline</a>,\n<a href="#series-custom.renderItem.return_rect">rect</a>,\n<a href="#series-custom.renderItem.return_line">line</a>,\n<a href="#series-custom.renderItem.return_bezierCurve">bezierCurve</a>,\n<a href="#series-custom.renderItem.return_arc">arc</a>,\n<a href="#series-custom.renderItem.return_group">group</a>,</p>\n',
  },
  "renderItem.return_text.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_text.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_text.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_text.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_text.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_text.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_text.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_text.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_text.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_text.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_text.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_text.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  "renderItem.return_text.keyframeAnimation.keyframes": {
    desc: '<p>动画的关键帧。数组中每一项为一个关键帧，格式如下：</p>\n<pre><code class="lang-ts">interface Keyframe {\n    // 关键帧位置。0 为第一帧，1 为最后一帧\n    // 关键帧时间为 percent * duration + delay\n    percent: number\n    // 上一个关键帧到这个关键帧运行时的缓动函数。可选\n    easing?: number\n\n    // 其它属性为图形在这个关键帧的属性，例如 x, y, style, shape 等\n}\n</code></pre>\n',
  },
  "renderItem.return_text.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_text.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_text.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_text.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_text.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_text.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  "renderItem.return_text.textConfig.local": { desc: '<p>如果 <code class="codespan">true</code> 的话，会采用节点的 transform。</p>\n' },
  ...
  "renderItem.return_text.style.text": { desc: '<p>文本块文字。可以使用 <code class="codespan">\\n</code> 来换行。</p>\n' },
  "renderItem.return_text.style.x": { desc: "<p>图形元素的左上角在父节点坐标系（以父节点左上角为原点）中的横坐标值。</p>\n" },
  "renderItem.return_text.style.y": { desc: "<p>图形元素的左上角在父节点坐标系（以父节点左上角为原点）中的纵坐标值。</p>\n" },
  ...
  "renderItem.return_text.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_text.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_text.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_text.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_text.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_text.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_text.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_text.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_text.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_text.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  "renderItem.return_text.emphasis.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_text.blur": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的淡出状态，配置<code class="codespan">focus</code>时有效。</p>\n',
  },
  "renderItem.return_text.blur.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_text.select": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的选中状态，配置自定义系列的 <a href="#series-custom.selectedMode">selectedMode</a> 时有效。</p>\n',
  },
  "renderItem.return_text.select.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_rect": { desc: "<p>矩形。</p>\n" },
  "renderItem.return_rect.type": {
    desc: '<p>用 setOption 首次设定图形元素时必须指定。\n可取值：</p>\n<p><a href="#series-custom.renderItem.return_image">image</a>,\n<a href="#series-custom.renderItem.return_text">text</a>,\n<a href="#series-custom.renderItem.return_circle">circle</a>,\n<a href="#series-custom.renderItem.return_sector">sector</a>,\n<a href="#series-custom.renderItem.return_ring">ring</a>,\n<a href="#series-custom.renderItem.return_polygon">polygon</a>,\n<a href="#series-custom.renderItem.return_polyline">polyline</a>,\n<a href="#series-custom.renderItem.return_rect">rect</a>,\n<a href="#series-custom.renderItem.return_line">line</a>,\n<a href="#series-custom.renderItem.return_bezierCurve">bezierCurve</a>,\n<a href="#series-custom.renderItem.return_arc">arc</a>,\n<a href="#series-custom.renderItem.return_group">group</a>,</p>\n',
  },
  "renderItem.return_rect.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_rect.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_rect.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_rect.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_rect.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_rect.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_rect.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_rect.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_rect.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_rect.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_rect.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_rect.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  ...
  "renderItem.return_rect.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_rect.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_rect.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_rect.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_rect.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_rect.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  "renderItem.return_rect.textConfig.local": { desc: '<p>如果 <code class="codespan">true</code> 的话，会采用节点的 transform。</p>\n' },
  ...
  "renderItem.return_rect.shape.x": { desc: "<p>图形元素的左上角在父节点坐标系（以父节点左上角为原点）中的横坐标值。</p>\n" },
  "renderItem.return_rect.shape.y": { desc: "<p>图形元素的左上角在父节点坐标系（以父节点左上角为原点）中的纵坐标值。</p>\n" },
  "renderItem.return_rect.shape.width": { desc: "<p>图形元素的宽度。</p>\n" },
  "renderItem.return_rect.shape.height": { desc: "<p>图形元素的高度。</p>\n" },
  ...
  "renderItem.return_rect.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_rect.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_rect.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_rect.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_rect.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_rect.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_rect.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_rect.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_rect.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_rect.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  "renderItem.return_rect.emphasis.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_rect.blur": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的淡出状态，配置<code class="codespan">focus</code>时有效。</p>\n',
  },
  "renderItem.return_rect.blur.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_rect.select": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的选中状态，配置自定义系列的 <a href="#series-custom.selectedMode">selectedMode</a> 时有效。</p>\n',
  },
  "renderItem.return_rect.select.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_circle": { desc: "<p>圆。</p>\n" },
  "renderItem.return_circle.type": {
    desc: '<p>用 setOption 首次设定图形元素时必须指定。\n可取值：</p>\n<p><a href="#series-custom.renderItem.return_image">image</a>,\n<a href="#series-custom.renderItem.return_text">text</a>,\n<a href="#series-custom.renderItem.return_circle">circle</a>,\n<a href="#series-custom.renderItem.return_sector">sector</a>,\n<a href="#series-custom.renderItem.return_ring">ring</a>,\n<a href="#series-custom.renderItem.return_polygon">polygon</a>,\n<a href="#series-custom.renderItem.return_polyline">polyline</a>,\n<a href="#series-custom.renderItem.return_rect">rect</a>,\n<a href="#series-custom.renderItem.return_line">line</a>,\n<a href="#series-custom.renderItem.return_bezierCurve">bezierCurve</a>,\n<a href="#series-custom.renderItem.return_arc">arc</a>,\n<a href="#series-custom.renderItem.return_group">group</a>,</p>\n',
  },
  "renderItem.return_circle.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_circle.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_circle.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_circle.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_circle.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_circle.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_circle.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_circle.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_circle.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_circle.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_circle.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_circle.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  ...
  "renderItem.return_circle.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_circle.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_circle.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_circle.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_circle.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_circle.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  "renderItem.return_circle.textConfig.local": { desc: '<p>如果 <code class="codespan">true</code> 的话，会采用节点的 transform。</p>\n' },
  ...
  "renderItem.return_circle.shape.cx": { desc: "<p>图形元素的中心在父节点坐标系（以父节点左上角为原点）中的横坐标值。</p>\n" },
  "renderItem.return_circle.shape.cy": { desc: "<p>图形元素的中心在父节点坐标系（以父节点左上角为原点）中的纵坐标值。</p>\n" },
  "renderItem.return_circle.shape.r": { desc: "<p>外半径。</p>\n" },
  ...
  "renderItem.return_circle.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_circle.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_circle.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_circle.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_circle.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_circle.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_circle.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_circle.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_circle.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_circle.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  ...
  "renderItem.return_circle.blur.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_circle.select": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的选中状态，配置自定义系列的 <a href="#series-custom.selectedMode">selectedMode</a> 时有效。</p>\n',
  },
  "renderItem.return_circle.select.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_ring": { desc: "<p>圆环。</p>\n" },
  "renderItem.return_ring.type": {
    desc: '<p>用 setOption 首次设定图形元素时必须指定。\n可取值：</p>\n<p><a href="#series-custom.renderItem.return_image">image</a>,\n<a href="#series-custom.renderItem.return_text">text</a>,\n<a href="#series-custom.renderItem.return_circle">circle</a>,\n<a href="#series-custom.renderItem.return_sector">sector</a>,\n<a href="#series-custom.renderItem.return_ring">ring</a>,\n<a href="#series-custom.renderItem.return_polygon">polygon</a>,\n<a href="#series-custom.renderItem.return_polyline">polyline</a>,\n<a href="#series-custom.renderItem.return_rect">rect</a>,\n<a href="#series-custom.renderItem.return_line">line</a>,\n<a href="#series-custom.renderItem.return_bezierCurve">bezierCurve</a>,\n<a href="#series-custom.renderItem.return_arc">arc</a>,\n<a href="#series-custom.renderItem.return_group">group</a>,</p>\n',
  },
  "renderItem.return_ring.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_ring.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_ring.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_ring.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_ring.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_ring.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_ring.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_ring.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_ring.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_ring.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_ring.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_ring.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  ...
  "renderItem.return_ring.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_ring.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_ring.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_ring.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_ring.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_ring.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  "renderItem.return_ring.textConfig.local": { desc: '<p>如果 <code class="codespan">true</code> 的话，会采用节点的 transform。</p>\n' },
  ...
  "renderItem.return_ring.shape.cx": { desc: "<p>图形元素的中心在父节点坐标系（以父节点左上角为原点）中的横坐标值。</p>\n" },
  "renderItem.return_ring.shape.cy": { desc: "<p>图形元素的中心在父节点坐标系（以父节点左上角为原点）中的纵坐标值。</p>\n" },
  "renderItem.return_ring.shape.r": { desc: "<p>外半径。</p>\n" },
  "renderItem.return_ring.shape.r0": { desc: "<p>内半径。</p>\n" },
  ...
  "renderItem.return_ring.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_ring.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_ring.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_ring.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_ring.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_ring.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_ring.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_ring.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_ring.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_ring.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  "renderItem.return_ring.emphasis.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_ring.blur": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的淡出状态，配置<code class="codespan">focus</code>时有效。</p>\n',
  },
  "renderItem.return_ring.blur.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_ring.select": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的选中状态，配置自定义系列的 <a href="#series-custom.selectedMode">selectedMode</a> 时有效。</p>\n',
  },
  "renderItem.return_ring.select.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_sector": { desc: "<p>扇形。</p>\n" },
  "renderItem.return_sector.type": {
    desc: '<p>用 setOption 首次设定图形元素时必须指定。\n可取值：</p>\n<p><a href="#series-custom.renderItem.return_image">image</a>,\n<a href="#series-custom.renderItem.return_text">text</a>,\n<a href="#series-custom.renderItem.return_circle">circle</a>,\n<a href="#series-custom.renderItem.return_sector">sector</a>,\n<a href="#series-custom.renderItem.return_ring">ring</a>,\n<a href="#series-custom.renderItem.return_polygon">polygon</a>,\n<a href="#series-custom.renderItem.return_polyline">polyline</a>,\n<a href="#series-custom.renderItem.return_rect">rect</a>,\n<a href="#series-custom.renderItem.return_line">line</a>,\n<a href="#series-custom.renderItem.return_bezierCurve">bezierCurve</a>,\n<a href="#series-custom.renderItem.return_arc">arc</a>,\n<a href="#series-custom.renderItem.return_group">group</a>,</p>\n',
  },
  "renderItem.return_sector.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_sector.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_sector.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_sector.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_sector.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_sector.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_sector.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_sector.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_sector.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_sector.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_sector.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_sector.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  ...
  "renderItem.return_sector.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_sector.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_sector.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_sector.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_sector.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_sector.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  "renderItem.return_sector.textConfig.local": { desc: '<p>如果 <code class="codespan">true</code> 的话，会采用节点的 transform。</p>\n' },
  ...
  "renderItem.return_sector.shape.cx": { desc: "<p>图形元素的中心在父节点坐标系（以父节点左上角为原点）中的横坐标值。</p>\n" },
  "renderItem.return_sector.shape.cy": { desc: "<p>图形元素的中心在父节点坐标系（以父节点左上角为原点）中的纵坐标值。</p>\n" },
  "renderItem.return_sector.shape.r": { desc: "<p>外半径。</p>\n" },
  "renderItem.return_sector.shape.r0": { desc: "<p>内半径。</p>\n" },
  "renderItem.return_sector.shape.startAngle": { desc: "<p>开始弧度。</p>\n" },
  "renderItem.return_sector.shape.endAngle": { desc: "<p>结束弧度。</p>\n" },
  "renderItem.return_sector.shape.clockwise": { desc: "<p>是否顺时针。</p>\n" },
  ...
  "renderItem.return_sector.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_sector.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_sector.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_sector.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_sector.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_sector.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_sector.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_sector.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_sector.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_sector.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  ...
  "renderItem.return_sector.blur.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_sector.select": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的选中状态，配置自定义系列的 <a href="#series-custom.selectedMode">selectedMode</a> 时有效。</p>\n',
  },
  "renderItem.return_sector.select.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_arc": { desc: "<p>圆弧。</p>\n" },
  "renderItem.return_arc.type": {
    desc: '<p>用 setOption 首次设定图形元素时必须指定。\n可取值：</p>\n<p><a href="#series-custom.renderItem.return_image">image</a>,\n<a href="#series-custom.renderItem.return_text">text</a>,\n<a href="#series-custom.renderItem.return_circle">circle</a>,\n<a href="#series-custom.renderItem.return_sector">sector</a>,\n<a href="#series-custom.renderItem.return_ring">ring</a>,\n<a href="#series-custom.renderItem.return_polygon">polygon</a>,\n<a href="#series-custom.renderItem.return_polyline">polyline</a>,\n<a href="#series-custom.renderItem.return_rect">rect</a>,\n<a href="#series-custom.renderItem.return_line">line</a>,\n<a href="#series-custom.renderItem.return_bezierCurve">bezierCurve</a>,\n<a href="#series-custom.renderItem.return_arc">arc</a>,\n<a href="#series-custom.renderItem.return_group">group</a>,</p>\n',
  },
  "renderItem.return_arc.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_arc.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_arc.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_arc.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_arc.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_arc.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_arc.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_arc.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_arc.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_arc.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_arc.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_arc.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  ...
  "renderItem.return_arc.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_arc.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_arc.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_arc.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_arc.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_arc.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  "renderItem.return_arc.textConfig.local": { desc: '<p>如果 <code class="codespan">true</code> 的话，会采用节点的 transform。</p>\n' },
  ...
  "renderItem.return_arc.shape.cx": { desc: "<p>图形元素的中心在父节点坐标系（以父节点左上角为原点）中的横坐标值。</p>\n" },
  "renderItem.return_arc.shape.cy": { desc: "<p>图形元素的中心在父节点坐标系（以父节点左上角为原点）中的纵坐标值。</p>\n" },
  "renderItem.return_arc.shape.r": { desc: "<p>外半径。</p>\n" },
  "renderItem.return_arc.shape.r0": { desc: "<p>内半径。</p>\n" },
  "renderItem.return_arc.shape.startAngle": { desc: "<p>开始弧度。</p>\n" },
  "renderItem.return_arc.shape.endAngle": { desc: "<p>结束弧度。</p>\n" },
  "renderItem.return_arc.shape.clockwise": { desc: "<p>是否顺时针。</p>\n" },
  ...
  "renderItem.return_arc.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_arc.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_arc.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_arc.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_arc.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_arc.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_arc.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_arc.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_arc.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_arc.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  "renderItem.return_arc.emphasis.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_arc.blur": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的淡出状态，配置<code class="codespan">focus</code>时有效。</p>\n',
  },
  "renderItem.return_arc.blur.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_arc.select": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的选中状态，配置自定义系列的 <a href="#series-custom.selectedMode">selectedMode</a> 时有效。</p>\n',
  },
  "renderItem.return_arc.select.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_polygon": { desc: "<p>多边形。</p>\n" },
  "renderItem.return_polygon.type": {
    desc: '<p>用 setOption 首次设定图形元素时必须指定。\n可取值：</p>\n<p><a href="#series-custom.renderItem.return_image">image</a>,\n<a href="#series-custom.renderItem.return_text">text</a>,\n<a href="#series-custom.renderItem.return_circle">circle</a>,\n<a href="#series-custom.renderItem.return_sector">sector</a>,\n<a href="#series-custom.renderItem.return_ring">ring</a>,\n<a href="#series-custom.renderItem.return_polygon">polygon</a>,\n<a href="#series-custom.renderItem.return_polyline">polyline</a>,\n<a href="#series-custom.renderItem.return_rect">rect</a>,\n<a href="#series-custom.renderItem.return_line">line</a>,\n<a href="#series-custom.renderItem.return_bezierCurve">bezierCurve</a>,\n<a href="#series-custom.renderItem.return_arc">arc</a>,\n<a href="#series-custom.renderItem.return_group">group</a>,</p>\n',
  },
  "renderItem.return_polygon.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_polygon.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_polygon.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_polygon.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_polygon.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_polygon.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_polygon.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_polygon.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_polygon.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_polygon.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_polygon.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_polygon.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  ...
  "renderItem.return_polygon.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_polygon.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_polygon.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_polygon.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_polygon.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_polygon.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  "renderItem.return_polygon.textConfig.local": { desc: '<p>如果 <code class="codespan">true</code> 的话，会采用节点的 transform。</p>\n' },
  ...
  "renderItem.return_polygon.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_polygon.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_polygon.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_polygon.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_polygon.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_polygon.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_polygon.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_polygon.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_polygon.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_polygon.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  ...
  "renderItem.return_polygon.blur.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  ...
  "renderItem.return_polyline": { desc: "<p>折线。</p>\n" },
  "renderItem.return_polyline.type": {
    desc: '<p>用 setOption 首次设定图形元素时必须指定。\n可取值：</p>\n<p><a href="#series-custom.renderItem.return_image">image</a>,\n<a href="#series-custom.renderItem.return_text">text</a>,\n<a href="#series-custom.renderItem.return_circle">circle</a>,\n<a href="#series-custom.renderItem.return_sector">sector</a>,\n<a href="#series-custom.renderItem.return_ring">ring</a>,\n<a href="#series-custom.renderItem.return_polygon">polygon</a>,\n<a href="#series-custom.renderItem.return_polyline">polyline</a>,\n<a href="#series-custom.renderItem.return_rect">rect</a>,\n<a href="#series-custom.renderItem.return_line">line</a>,\n<a href="#series-custom.renderItem.return_bezierCurve">bezierCurve</a>,\n<a href="#series-custom.renderItem.return_arc">arc</a>,\n<a href="#series-custom.renderItem.return_group">group</a>,</p>\n',
  },
  "renderItem.return_polyline.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_polyline.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_polyline.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_polyline.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_polyline.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_polyline.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_polyline.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_polyline.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_polyline.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_polyline.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_polyline.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_polyline.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  ...
  "renderItem.return_polyline.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_polyline.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_polyline.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_polyline.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_polyline.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_polyline.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  ...
  "renderItem.return_polyline.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_polyline.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_polyline.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_polyline.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_polyline.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_polyline.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_polyline.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_polyline.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_polyline.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_polyline.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  ...
  "renderItem.return_polyline.blur.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  ...
  "renderItem.return_line": { desc: "<p>直线。</p>\n" },
  "renderItem.return_line.type": {
    desc: '<p>用 setOption 首次设定图形元素时必须指定。\n可取值：</p>\n<p><a href="#series-custom.renderItem.return_image">image</a>,\n<a href="#series-custom.renderItem.return_text">text</a>,\n<a href="#series-custom.renderItem.return_circle">circle</a>,\n<a href="#series-custom.renderItem.return_sector">sector</a>,\n<a href="#series-custom.renderItem.return_ring">ring</a>,\n<a href="#series-custom.renderItem.return_polygon">polygon</a>,\n<a href="#series-custom.renderItem.return_polyline">polyline</a>,\n<a href="#series-custom.renderItem.return_rect">rect</a>,\n<a href="#series-custom.renderItem.return_line">line</a>,\n<a href="#series-custom.renderItem.return_bezierCurve">bezierCurve</a>,\n<a href="#series-custom.renderItem.return_arc">arc</a>,\n<a href="#series-custom.renderItem.return_group">group</a>,</p>\n',
  },
  "renderItem.return_line.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_line.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_line.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_line.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_line.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_line.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_line.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_line.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_line.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_line.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_line.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_line.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  ...
  "renderItem.return_line.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_line.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_line.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_line.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_line.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_line.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  "renderItem.return_line.textConfig.local": { desc: '<p>如果 <code class="codespan">true</code> 的话，会采用节点的 transform。</p>\n' },
  ...
  "renderItem.return_line.shape.x1": { desc: "<p>开始点的 x 值。</p>\n" },
  "renderItem.return_line.shape.y1": { desc: "<p>开始点的 y 值。</p>\n" },
  "renderItem.return_line.shape.x2": { desc: "<p>结束点的 x 值。</p>\n" },
  "renderItem.return_line.shape.y2": { desc: "<p>结束点的 y 值。</p>\n" },
  "renderItem.return_line.shape.percent": { desc: "<p>线画到百分之多少就不画了。值的范围：[0, 1]。</p>\n" },
  ...
  "renderItem.return_line.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_line.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_line.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_line.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_line.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_line.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_line.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_line.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_line.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_line.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  "renderItem.return_line.emphasis.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_line.blur": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的淡出状态，配置<code class="codespan">focus</code>时有效。</p>\n',
  },
  "renderItem.return_line.blur.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_line.select": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.0.0</code> 开始支持</p>\n</blockquote>\n<p>图形元素的选中状态，配置自定义系列的 <a href="#series-custom.selectedMode">selectedMode</a> 时有效。</p>\n',
  },
  "renderItem.return_line.select.style": { desc: '<p>结构同 <a href="#series-custom.renderItem.return_polygon.style">style</a>。</p>\n' },
  "renderItem.return_bezierCurve": { desc: "<p>二次或三次贝塞尔曲线。</p>\n" },
  "renderItem.return_bezierCurve.type": {
    desc: '<p>用 setOption 首次设定图形元素时必须指定。\n可取值：</p>\n<p><a href="#series-custom.renderItem.return_image">image</a>,\n<a href="#series-custom.renderItem.return_text">text</a>,\n<a href="#series-custom.renderItem.return_circle">circle</a>,\n<a href="#series-custom.renderItem.return_sector">sector</a>,\n<a href="#series-custom.renderItem.return_ring">ring</a>,\n<a href="#series-custom.renderItem.return_polygon">polygon</a>,\n<a href="#series-custom.renderItem.return_polyline">polyline</a>,\n<a href="#series-custom.renderItem.return_rect">rect</a>,\n<a href="#series-custom.renderItem.return_line">line</a>,\n<a href="#series-custom.renderItem.return_bezierCurve">bezierCurve</a>,\n<a href="#series-custom.renderItem.return_arc">arc</a>,\n<a href="#series-custom.renderItem.return_group">group</a>,</p>\n',
  },
  "renderItem.return_bezierCurve.id": { desc: "<p>id 用于在更新或删除图形元素时指定更新哪个图形元素，如果不需要用可以忽略。</p>\n" },
  "renderItem.return_bezierCurve.x": { desc: "<p>元素的 x 像素位置。</p>\n" },
  "renderItem.return_bezierCurve.y": { desc: "<p>元素的 y 像素位置。</p>\n" },
  "renderItem.return_bezierCurve.rotation": { desc: "<p>元素的旋转</p>\n" },
  "renderItem.return_bezierCurve.scaleX": { desc: "<p>元素在 x 方向上的缩放。</p>\n" },
  "renderItem.return_bezierCurve.scaleY": { desc: "<p>元素在 y 方向上的缩放。</p>\n" },
  "renderItem.return_bezierCurve.originX": { desc: "<p>元素旋转和缩放原点的 x 像素位置。</p>\n" },
  "renderItem.return_bezierCurve.originY": { desc: "<p>元素旋转和缩放原点的 y 像素位置。</p>\n" },
  ...
  "renderItem.return_bezierCurve.enterAnimation": { desc: "<p>入场动画配置。</p>\n" },
  ...
  "renderItem.return_bezierCurve.updateAnimation": { desc: "<p>更新属性的动画配置。</p>\n" },
  ...
  "renderItem.return_bezierCurve.leaveAnimation": { desc: "<p>退场动画配置。</p>\n" },
  ...
  "renderItem.return_bezierCurve.keyframeAnimation.loop": { desc: "<p>是否循环播放动画。</p>\n" },
  ...
  "renderItem.return_bezierCurve.z2": { desc: "<p>用于决定图形元素的覆盖关系。</p>\n" },
  ...
  "renderItem.return_bezierCurve.silent": { desc: "<p>是否不响应鼠标以及触摸事件。</p>\n" },
  "renderItem.return_bezierCurve.invisible": { desc: "<p>节点是否可见。</p>\n" },
  "renderItem.return_bezierCurve.ignore": { desc: "<p>节点是否完全被忽略（既不渲染，也不响应事件）。</p>\n" },
  ...
  "renderItem.return_bezierCurve.textConfig.rotation": { desc: '<p><code class="codespan">textContent</code> 的旋转弧度。</p>\n' },
  ...
  "renderItem.return_bezierCurve.textConfig.distance": { desc: '<p>距离 <code class="codespan">layoutRect</code> 的距离。</p>\n' },
  ...
  "renderItem.return_bezierCurve.shape.x1": { desc: "<p>开始点的 x 值。</p>\n" },
  "renderItem.return_bezierCurve.shape.y1": { desc: "<p>开始点的 y 值。</p>\n" },
  "renderItem.return_bezierCurve.shape.x2": { desc: "<p>结束点的 x 值。</p>\n" },
  "renderItem.return_bezierCurve.shape.y2": { desc: "<p>结束点的 y 值。</p>\n" },
  "renderItem.return_bezierCurve.shape.cpx1": { desc: "<p>控制点 x 值。</p>\n" },
  "renderItem.return_bezierCurve.shape.cpy1": { desc: "<p>控制点 y 值。</p>\n" },
  "renderItem.return_bezierCurve.shape.cpx2": { desc: "<p>第二个控制点 x 值。如果设置则开启三阶贝塞尔曲线。</p>\n" },
  "renderItem.return_bezierCurve.shape.cpy2": { desc: "<p>第二个控制点 y 值。如果设置则开启三阶贝塞尔曲线。</p>\n" },
  "renderItem.return_bezierCurve.shape.percent": { desc: "<p>画到百分之多少就不画了。值的范围：[0, 1]。</p>\n" },
  ...
  "renderItem.return_bezierCurve.style.fill": { desc: "<p>填充色。</p>\n" },
  "renderItem.return_bezierCurve.style.stroke": { desc: "<p>线条颜色。</p>\n" },
  "renderItem.return_bezierCurve.style.lineWidth": { desc: "<p>线条宽度。</p>\n" },
  ...
  "renderItem.return_bezierCurve.style.shadowBlur": { desc: "<p>阴影宽度。</p>\n" },
  "renderItem.return_bezierCurve.style.shadowOffsetX": { desc: "<p>阴影 X 方向偏移。</p>\n" },
  "renderItem.return_bezierCurve.style.shadowOffsetY": { desc: "<p>阴影 Y 方向偏移。</p>\n" },
  "renderItem.return_bezierCurve.style.shadowColor": { desc: "<p>阴影颜色。</p>\n" },
  "renderItem.return_bezierCurve.style.opacity": { desc: "<p>不透明度。</p>\n" },
  ...
  "renderItem.return_bezierCurve.emphasisDisabled": { desc: "<p>是否关闭高亮状态。</p>\n" },
  "renderItem.return_bezierCurve.emphasis": { desc: "<p>图形元素的高亮状态</p>\n" },
  ...
  "itemStyle.borderWidth": {
    desc: "\n\n<p>描边线宽。为 0 时无描边。</p>\n",
    uiControl: { type: "number", value: "0", min: "0", step: "0.5" },
  },
  "itemStyle.borderType": {
    ...
    uiControl: { type: "enum", default: "solid", options: "solid,dashed,dotted" },
  },
  "itemStyle.borderDashOffset": {
    ...
    uiControl: { type: "number", min: "0", step: "1", default: "0" },
  },
  "itemStyle.borderCap": {
    ...
    uiControl: { type: "enum", default: "butt", options: "butt,round,square" },
  },
  "itemStyle.borderJoin": {
    ...
    uiControl: { type: "enum", default: "bevel", options: "bevel,round,miter" },
  },
  "itemStyle.borderMiterLimit": {
    ...
    uiControl: { type: "number", min: "0", step: "1", default: "10" },
  },
  "itemStyle.shadowBlur": {
    desc: '\n\n<p>图形阴影的模糊大小。该属性配合 <code class="codespan">shadowColor</code>,<code class="codespan">shadowOffsetX</code>, <code class="codespan">shadowOffsetY</code> 一起设置图形的阴影效果。</p>\n<p>示例：</p>\n<pre><code class="lang-ts">{\n    shadowColor: &#39;rgba(0, 0, 0, 0.5)&#39;,\n    shadowBlur: 10\n}\n</code></pre>\n',
    uiControl: { type: "number", default: "", min: "0", step: "0.5" },
  },
  "itemStyle.shadowColor": {
    desc: '\n\n<p>阴影颜色。支持的格式同<code class="codespan">color</code>。</p>\n',
    uiControl: { type: "color", default: "" },
  },
  "itemStyle.shadowOffsetX": { desc: "\n\n<p>阴影水平方向上的偏移距离。</p>\n", uiControl: { type: "number", default: "0", step: "0.5" } },
  "itemStyle.shadowOffsetY": { desc: "\n\n<p>阴影垂直方向上的偏移距离。</p>\n", uiControl: { type: "number", default: "0", step: "0.5" } },
  "itemStyle.opacity": {
  ...
  "labelLine.length2": { desc: "\n\n<p>视觉引导项第二段的长度。</p>\n", uiControl: { type: "number", default: "15", min: "0", step: "1" } },
  "labelLine.smooth": {
  ...
  "labelLine.lineStyle.width": { desc: "\n\n<p>线宽。</p>\n", uiControl: { type: "number", value: "1", min: "0", step: "0.5" } },
  ...
  "labelLayout.height": { desc: "<p>标签显示的高度。</p>\n" },
  "labelLayout.align": {
  ...
  selectedMode: {
    ...
    uiControl: { type: "enum", options: "false,true,single,multiple,series" },
  },
  dimensions: {
  ...
  "data.groupId": {
    desc: '<p>该数据项的组 ID。当全局过渡动画功能开启时，<code class="codespan">setOption</code> 前后拥有相同组 ID 的数据项会进行动画过渡。</p>\n<p>若没有指定<code class="codespan">groupId</code> ，会尝试用<code class="codespan">series.dataGroupId</code>作为该数据项的组 ID；若<code class="codespan">series.dataGroupId</code>也没有指定，则会使用数据项的 ID 作为组 ID。</p>\n<p>如果你使用了<a href="#dataset">dataset</a>组件来表达数据，推荐使用<code class="codespan">encode.itemGroupId</code>来指定哪个维度被编码为组 ID。</p>\n',
  },
  "data.childGroupId": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.5.0</code> 开始支持</p>\n</blockquote>\n<p>该数据项对应的子数据组 ID，用于实现多层下钻和聚合。</p>\n<iframe  data-src="../../examples/zh/view.html?c=doc-example/bar-multi-drilldown&edit=1&reset=1" width="700" height="300"></iframe>\n\n\n<p>通过<code class="codespan">groupId</code>已经可以达到数据下钻和聚合的效果，但只支持一层的下钻和聚合。为了实现多层下钻和聚合，我们又引入了<code class="codespan">childGroupId</code>。</p>\n<p>引入<code class="codespan">childGroupId</code>后，不同<code class="codespan">option</code>的数据项之间就能形成逻辑上的父子关系，例如：</p>\n<pre><code class="lang-text">data: [                        data: [                        data: [\n  {                              {                              {\n    name: &#39;Animals&#39;,               name: &#39;Dogs&#39;,                  name: &#39;Corgi&#39;,\n    value: 3,                      value: 3,                      value: 5,\n    groupId: &#39;things&#39;,             groupId: &#39;animals&#39;,            groupId: &#39;dogs&#39;\n    childGroupId: &#39;animals&#39;        childGroupId: &#39;dogs&#39;         },\n  },                             },                             {\n  {                              {                                name: &#39;Bulldog&#39;,\n    name: &#39;Fruits&#39;,                name: &#39;Cats&#39;,                  value: 6,\n    value: 3,                      value: 4,                      groupId: &#39;dogs&#39;\n    groupId: &#39;things&#39;,             groupId: &#39;animals&#39;,          },\n    childGroupId: &#39;fruits&#39;         childGroupId: &#39;cats&#39;,        {\n  },                             },                               name: &#39;Shiba Inu&#39;,\n  {                              {                                value: 7,\n    name: &#39;Cars&#39;,                  name: &#39;Birds&#39;,                 groupId: &#39;dogs&#39;\n    value: 2,                      value: 3,                    }\n    groupId: &#39;things&#39;,             groupId: &#39;animals&#39;,        ]\n    childGroupId: &#39;cars&#39;           childGroupId: &#39;birds&#39;\n  }                              }\n]                              ]\n</code></pre>\n<p>上面 3 组 data 分别来自 3 个 option ，通过<code class="codespan">groupId</code>和<code class="codespan">childGroupId</code>，它们之间存在了“父-子-孙”的关系。在<code class="codespan">setOption</code>时，Apache ECharts 会尝试寻找前后<code class="codespan">option</code>数据项间的父子关系，若存在父子关系，则会对相关数据项进行下钻或聚合动画的过渡。</p>\n<p>没有对应子数据组的数据项不需要指定<code class="codespan">childGroupId</code>。</p>\n<p>如果你使用了<a href="#dataset">dataset</a>组件来表达数据，推荐使用<code class="codespan">encode.itemChildGroupId</code>来指定哪个维度被编码为子数据组 ID。</p>\n',
  },
  ...
  "data.itemStyle.decal.symbolKeepAspect": { desc: "<p>是否保持图案的长宽比。</p>\n" },
  "data.itemStyle.decal.color": { desc: "<p>贴花图案的颜色，建议使用半透明色，这样能叠加在系列本身的颜色上。</p>\n" },
  "data.itemStyle.decal.backgroundColor": { desc: "<p>贴花的背景色，将会覆盖在系列本身颜色之上，贴花图案之下。</p>\n" },
  ...
  "data.tooltip": { desc: "<p>本系列每个数据项中特定的 tooltip 设定。</p>\n" },
  ...
  "data.tooltip.borderColor": {
    desc: '\n\n\n\n\n<blockquote>\n<p><strong>注意：</strong><code class="codespan">series.data.tooltip</code> 仅在 <a href="#tooltip.trigger">tooltip.trigger</a> 为 <code class="codespan">&#39;item&#39;</code> 时有效。<br></p>\n</blockquote>\n<p>提示框浮层的边框颜色。</p>\n',
    uiControl: { type: "color", default: "#333" },
  },
  ...
  "data.tooltip.padding": {
    ...
    uiControl: { type: "vector", min: "0", dims: "T,R,B,L" },
  },
  "data.tooltip.textStyle": {
    desc: '<blockquote>\n<p><strong>注意：</strong><code class="codespan">series.data.tooltip</code> 仅在 <a href="#tooltip.trigger">tooltip.trigger</a> 为 <code class="codespan">&#39;item&#39;</code> 时有效。<br></p>\n</blockquote>\n<p>提示框浮层的文本样式。</p>\n',
  },
  "data.tooltip.textStyle.color": { desc: "\n\n<p>文字的颜色。</p>\n", uiControl: { type: "color", default: "'#fff'" } },
  "data.tooltip.textStyle.fontStyle": {
    desc: '\n\n<p>文字字体的风格。</p>\n<p>可选：</p>\n<ul>\n<li><code class="codespan">&#39;normal&#39;</code></li>\n<li><code class="codespan">&#39;italic&#39;</code></li>\n<li><code class="codespan">&#39;oblique&#39;</code></li>\n</ul>\n',
    uiControl: { type: "enum", default: "normal", options: "normal,italic,oblique" },
  },
  "data.tooltip.textStyle.fontWeight": {
    desc: '\n\n<p>文字字体的粗细。</p>\n<p>可选：</p>\n<ul>\n<li><code class="codespan">&#39;normal&#39;</code></li>\n<li><code class="codespan">&#39;bold&#39;</code></li>\n<li><code class="codespan">&#39;bolder&#39;</code></li>\n<li><code class="codespan">&#39;lighter&#39;</code></li>\n<li>100 | 200 | 300 | 400...</li>\n</ul>\n',
    uiControl: { type: "enum", default: "normal", options: "normal,bold,bolder,lighter" },
  },
  "data.tooltip.textStyle.fontFamily": {
    desc: "\n\n<p>文字的字体系列。</p>\n<p>还可以是 &#39;serif&#39; , &#39;monospace&#39;, &#39;Arial&#39;, &#39;Courier New&#39;, &#39;Microsoft YaHei&#39;, ...</p>\n",
    uiControl: { type: "enum", default: "sans-serif", options: "sans-serif,serif,monospace,Arial,Courier New" },
  },
  "data.tooltip.textStyle.fontSize": {
    desc: "\n\n<p>文字的字体大小。</p>\n",
    uiControl: { type: "number", default: "14", min: "1", step: "1" },
  },
  "data.tooltip.textStyle.lineHeight": {
    desc: '\n\n<p>行高。</p>\n<p><code class="codespan">rich</code> 中如果没有设置 <code class="codespan">lineHeight</code>，则会取父层级的 <code class="codespan">lineHeight</code>。例如：</p>\n<pre><code class="lang-ts">{\n    lineHeight: 56,\n    rich: {\n        a: {\n            // 没有设置 `lineHeight`，则 `lineHeight` 为 56\n        }\n    }\n}\n</code></pre>\n',
    uiControl: { type: "number", min: "0", step: "1", default: "12" },
  },
  "data.tooltip.textStyle.width": {
    desc: "\n\n<p>文本显示宽度。</p>\n",
    uiControl: { type: "number", default: "100", min: "1", max: "500", step: "1" },
  },
  "data.tooltip.textStyle.height": {
    desc: "\n\n<p>文本显示高度。</p>\n",
    uiControl: { type: "number", default: "50", min: "1", max: "500", step: "1" },
  },
  "data.tooltip.textStyle.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  "data.tooltip.textStyle.textBorderWidth": {
    desc: "\n\n<p>文字本身的描边宽度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  ...
  "data.tooltip.textStyle.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "data.tooltip.textStyle.textShadowBlur": {
    desc: "\n\n<p>文字本身的阴影长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  "data.tooltip.textStyle.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "data.tooltip.textStyle.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "data.tooltip.textStyle.overflow": {
    desc: '\n\n<p>文字超出宽度是否截断或者换行。配置<code class="codespan">width</code>时有效</p>\n<ul>\n<li><code class="codespan">&#39;truncate&#39;</code> 截断，并在末尾显示<code class="codespan">ellipsis</code>配置的文本，默认为<code class="codespan">...</code></li>\n<li><code class="codespan">&#39;break&#39;</code> 换行</li>\n<li><code class="codespan">&#39;breakAll&#39;</code> 换行，跟<code class="codespan">&#39;break&#39;</code>不同的是，在英语等拉丁文中，<code class="codespan">&#39;breakAll&#39;</code>还会强制单词内换行</li>\n</ul>\n',
    uiControl: { type: "enum", options: "truncate,break,breakAll" },
  },
  ...
  clip: {
    ...
    uiControl: { type: "boolean", default: "false" },
  },
  zlevel: {
  ...
  animation: { desc: "\n\n<p>是否开启动画。</p>\n", uiControl: { type: "boolean", default: "true", clean: "true" } },
  animationThreshold: { desc: "<p>是否开启动画的阈值，当单个系列显示的图形数量大于这个阈值时会关闭动画。</p>\n" },
  animationDuration: {
    desc: '\n\n<p>初始动画的时长，支持回调函数，可以通过每个数据返回不同的时长实现更戏剧的初始动画效果：</p>\n<pre><code class="lang-ts">animationDuration: function (idx) {\n    // 越往后的数据时长越大\n    return idx * 100;\n}\n</code></pre>\n',
    uiControl: { type: "number", min: "0", default: "1000", step: "20", clean: "true" },
  },
  animationEasing: {
  ...
  animationDurationUpdate: {
    ...
    uiControl: { type: "number", min: "0", default: "1000", step: "20" },
  },
  ...
  "tooltip.textStyle.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  "tooltip.textStyle.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "tooltip.textStyle.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "tooltip.textStyle.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "tooltip.textStyle.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "tooltip.textStyle.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
