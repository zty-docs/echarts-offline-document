window.__EC_DOC_option_parallelAxis = {
  ...
  areaSelectStyle: { desc: "<p>在坐标轴上可以进行框选，这里是一些框选的设置。</p>\n" },
  "areaSelectStyle.width": { desc: "\n\n<p>框选范围的宽度。</p>\n", uiControl: { type: "number", min: "0", default: "20", step: "1" } },
  "areaSelectStyle.borderWidth": {
    desc: "\n\n<p>选框的边框宽度。</p>\n",
    uiControl: { type: "number", min: "0", default: "1", step: "0.5" },
  },
  "areaSelectStyle.borderColor": { desc: "\n\n<p>选框的边框颜色。</p>\n", uiControl: { type: "color", default: "rgba(160,197,232)" } },
  "areaSelectStyle.color": { desc: "\n\n<p>选框的填充色。</p>\n", uiControl: { type: "color", default: "rgba(160,197,232)" } },
  "areaSelectStyle.opacity": { desc: "\n\n<p>选框的透明度。</p>\n", uiControl: { type: "number", min: "0", max: "1", default: "0.3" } },
  type: {
