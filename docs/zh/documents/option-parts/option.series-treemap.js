window.__EC_DOC_option_series_treemap = {
  ...
  squareRatio: {
    ...
    uiControl: { type: "number", min: "0.1", default: "0.75", step: "0.1" },
  },
  leafDepth: {
    ...
    uiControl: { type: "number", min: "1", step: "1" },
  },
  drillDownIcon: { desc: "<p>当节点可以下钻时的提示符。只能是字符。</p>\n" },
  roam: {
    ...
    uiControl: { type: "enum", options: "true,false,scale,move" },
  },
  scaleLimit: {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.5.1</code> 开始支持</p>\n</blockquote>\n<p>滚轮缩放的极限控制，通过 <code class="codespan">min</code> 和 <code class="codespan">max</code> 限制最小和最大的缩放值。</p>\n',
  },
  "scaleLimit.min": { desc: "<p>最小的缩放值</p>\n" },
  "scaleLimit.max": { desc: "<p>最大的缩放值</p>\n" },
  nodeClick: {
  ...
  zoomToNodeRatio: {
    ...
    uiControl: { type: "number", min: "0", default: "0.1", step: "0.01" },
  },
  visualDimension: {
  ...
  visualMin: {
    ...
    uiControl: { type: "number", default: "0" },
  },
  visualMax: {
    desc: '\n\n<p>当前层级的最大 value 值。如果不设置则自动统计。</p>\n<p>手动指定 <code class="codespan">visualMin</code>、<code class="codespan">visualMax</code> ，即手动控制了 visual mapping 的值域（当 <a href="#series-treemap.levels.colorMappingBy">colorMappingBy</a> 为 <code class="codespan">&#39;value&#39;</code> 时有意义）。</p>\n',
    uiControl: { type: "number", default: "100" },
  },
  colorAlpha: {
  ...
  colorMappingBy: {
    ...
    uiControl: { type: "enum", options: "index,value,id" },
  },
  visibleMin: {
    ...
    uiControl: { type: "number", default: "10", min: "0" },
  },
  childrenVisibleMin: {
    ...
    uiControl: { type: "number", default: "10", min: "0", step: "0.5" },
  },
  label: {
  ...
  "upperLabel.borderRadius": { desc: "\n\n<p>文字块的圆角。</p>\n", uiControl: { type: "vector", min: "0", dims: "LT,RT, RB, LB" } },
  "upperLabel.padding": {
    desc: '\n\n<p>文字块的内边距。例如：</p>\n<ul>\n<li><code class="codespan">padding: [3, 4, 5, 6]</code>：表示 <code class="codespan">[上, 右, 下, 左]</code> 的边距。</li>\n<li><code class="codespan">padding: 4</code>：表示 <code class="codespan">padding: [4, 4, 4, 4]</code>。</li>\n<li><code class="codespan">padding: [3, 4]</code>：表示 <code class="codespan">padding: [3, 4, 3, 4]</code>。</li>\n</ul>\n<p>注意，文字块的 <code class="codespan">width</code> 和 <code class="codespan">height</code> 指定的是内容高宽，不包含 <code class="codespan">padding</code>。</p>\n',
    uiControl: { type: "vector", min: "0", dims: "T,R,B,L" },
  },
  "upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "upperLabel.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "upperLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "upperLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "upperLabel.width": {
    desc: "\n\n<p>文本显示宽度。</p>\n",
    uiControl: { type: "number", default: "100", min: "1", max: "500", step: "1" },
  },
  "upperLabel.height": { desc: "\n\n<p>父节点标签区的高度。</p>\n", uiControl: { type: "number", default: "20", min: "0", step: "0.5" } },
  "upperLabel.textBorderColor": {
    desc: '\n\n<p>文字本身的描边颜色。</p>\n<p>如果设置为 <code class="codespan">&#39;inherit&#39;</code>，则为视觉映射得到的颜色，如系列色。</p>\n',
    uiControl: { type: "color" },
  },
  "upperLabel.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "upperLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "upperLabel.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "upperLabel.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "upperLabel.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "upperLabel.overflow": {
    desc: '\n\n<p>文字超出宽度是否截断或者换行。配置<code class="codespan">width</code>时有效</p>\n<ul>\n<li><code class="codespan">&#39;truncate&#39;</code> 截断，并在末尾显示<code class="codespan">ellipsis</code>配置的文本，默认为<code class="codespan">...</code></li>\n<li><code class="codespan">&#39;break&#39;</code> 换行</li>\n<li><code class="codespan">&#39;breakAll&#39;</code> 换行，跟<code class="codespan">&#39;break&#39;</code>不同的是，在英语等拉丁文中，<code class="codespan">&#39;breakAll&#39;</code>还会强制单词内换行</li>\n</ul>\n',
    uiControl: { type: "enum", options: "truncate,break,breakAll" },
  },
  ...
  "upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "itemStyle.borderColorSaturation": {
    ...
    uiControl: { type: "number", step: "0.01", min: "0", max: "1", default: "0.5" },
  },
  ...
  "emphasis.upperLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "emphasis.upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "emphasis.upperLabel.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "emphasis.upperLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "emphasis.upperLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "emphasis.upperLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "emphasis.upperLabel.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "emphasis.upperLabel.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "emphasis.upperLabel.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "emphasis.upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "blur.labelLine.lineStyle.width": { desc: "\n\n<p>线宽。</p>\n", uiControl: { type: "number", value: "1", min: "0", step: "0.5" } },
  ...
  "blur.upperLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "blur.upperLabel.borderRadius": { desc: "\n\n<p>文字块的圆角。</p>\n", uiControl: { type: "vector", min: "0", dims: "LT,RT, RB, LB" } },
  "blur.upperLabel.padding": {
    desc: '\n\n<p>文字块的内边距。例如：</p>\n<ul>\n<li><code class="codespan">padding: [3, 4, 5, 6]</code>：表示 <code class="codespan">[上, 右, 下, 左]</code> 的边距。</li>\n<li><code class="codespan">padding: 4</code>：表示 <code class="codespan">padding: [4, 4, 4, 4]</code>。</li>\n<li><code class="codespan">padding: [3, 4]</code>：表示 <code class="codespan">padding: [3, 4, 3, 4]</code>。</li>\n</ul>\n<p>注意，文字块的 <code class="codespan">width</code> 和 <code class="codespan">height</code> 指定的是内容高宽，不包含 <code class="codespan">padding</code>。</p>\n',
    uiControl: { type: "vector", min: "0", dims: "T,R,B,L" },
  },
  "blur.upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "blur.upperLabel.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "blur.upperLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "blur.upperLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "blur.upperLabel.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "blur.upperLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "blur.upperLabel.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "blur.upperLabel.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "blur.upperLabel.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "blur.upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "select.labelLine.lineStyle.width": { desc: "\n\n<p>线宽。</p>\n", uiControl: { type: "number", value: "1", min: "0", step: "0.5" } },
  ...
  "select.upperLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "select.upperLabel.borderRadius": { desc: "\n\n<p>文字块的圆角。</p>\n", uiControl: { type: "vector", min: "0", dims: "LT,RT, RB, LB" } },
  "select.upperLabel.padding": {
    desc: '\n\n<p>文字块的内边距。例如：</p>\n<ul>\n<li><code class="codespan">padding: [3, 4, 5, 6]</code>：表示 <code class="codespan">[上, 右, 下, 左]</code> 的边距。</li>\n<li><code class="codespan">padding: 4</code>：表示 <code class="codespan">padding: [4, 4, 4, 4]</code>。</li>\n<li><code class="codespan">padding: [3, 4]</code>：表示 <code class="codespan">padding: [3, 4, 3, 4]</code>。</li>\n</ul>\n<p>注意，文字块的 <code class="codespan">width</code> 和 <code class="codespan">height</code> 指定的是内容高宽，不包含 <code class="codespan">padding</code>。</p>\n',
    uiControl: { type: "vector", min: "0", dims: "T,R,B,L" },
  },
  "select.upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "select.upperLabel.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "select.upperLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "select.upperLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "select.upperLabel.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "select.upperLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "select.upperLabel.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "select.upperLabel.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "select.upperLabel.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "select.upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  breadcrumb: { desc: "<p>面包屑，能够显示当前节点的路径。</p>\n" },
  "breadcrumb.show": { desc: "\n\n<p>是否显示面包屑。</p>\n", uiControl: { type: "boolean", default: "true" } },
  "breadcrumb.left": {
    desc: '\n\n<p>面包屑组件离容器左侧的距离。</p>\n<p><code class="codespan">left</code> 的值可以是像 <code class="codespan">20</code> 这样的具体像素值，可以是像 <code class="codespan">&#39;20%&#39;</code> 这样相对于容器高宽的百分比，也可以是 <code class="codespan">&#39;left&#39;</code>, <code class="codespan">&#39;center&#39;</code>, <code class="codespan">&#39;right&#39;</code>。</p>\n<p>如果 <code class="codespan">left</code> 的值为 <code class="codespan">&#39;left&#39;</code>, <code class="codespan">&#39;center&#39;</code>, <code class="codespan">&#39;right&#39;</code>，组件会根据相应的位置自动对齐。</p>\n',
    uiControl: { type: "percent", default: "0%" },
  },
  ...
  "breadcrumb.height": { desc: "\n\n<p>面包屑的高度。</p>\n", uiControl: { type: "number", min: "0", default: "22", step: "1" } },
  "breadcrumb.emptyItemWidth": {
    desc: "\n\n<p>当面包屑没有内容时候，设个最小宽度。</p>\n",
    uiControl: { type: "number", min: "0", default: "25", step: "1" },
  },
  "breadcrumb.itemStyle": { desc: "<p> 图形样式。</p>\n" },
  ...
  "breadcrumb.itemStyle.textStyle.color": { desc: "\n\n<p>文字的颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "breadcrumb.itemStyle.textStyle.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "breadcrumb.itemStyle.textStyle.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "breadcrumb.itemStyle.textStyle.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "breadcrumb.emphasis": { desc: '<blockquote>\n<p>从 <code class="codespan">v5.4.0</code> 开始支持</p>\n</blockquote>\n' },
  "breadcrumb.emphasis.itemStyle.color": {
    desc: '\n\n<p>面包屑图形的颜色。从 v5.2.0 开始支持在 <code class="codespan">emphasis</code> 状态中支持设置为 <code class="codespan">&#39;inherit&#39;</code> 取消高亮颜色。</p>\n<blockquote>\n<p>支持使用<code class="codespan">rgb(255,255,255)</code>，<code class="codespan">rgba(255,255,255,1)</code>，<code class="codespan">#fff</code>等方式设置为纯色，也支持设置为渐变色和纹理填充，具体见<a href="#color">option.color</a></p>\n</blockquote>\n',
    uiControl: { type: "color" },
  },
  ...
  "breadcrumb.emphasis.itemStyle.textStyle.color": { desc: "\n\n<p>文字的颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "breadcrumb.emphasis.itemStyle.textStyle.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "breadcrumb.emphasis.itemStyle.textStyle.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "levels.upperLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "levels.upperLabel.borderRadius": { desc: "\n\n<p>文字块的圆角。</p>\n", uiControl: { type: "vector", min: "0", dims: "LT,RT, RB, LB" } },
  "levels.upperLabel.padding": {
    desc: '\n\n<p>文字块的内边距。例如：</p>\n<ul>\n<li><code class="codespan">padding: [3, 4, 5, 6]</code>：表示 <code class="codespan">[上, 右, 下, 左]</code> 的边距。</li>\n<li><code class="codespan">padding: 4</code>：表示 <code class="codespan">padding: [4, 4, 4, 4]</code>。</li>\n<li><code class="codespan">padding: [3, 4]</code>：表示 <code class="codespan">padding: [3, 4, 3, 4]</code>。</li>\n</ul>\n<p>注意，文字块的 <code class="codespan">width</code> 和 <code class="codespan">height</code> 指定的是内容高宽，不包含 <code class="codespan">padding</code>。</p>\n',
    uiControl: { type: "vector", min: "0", dims: "T,R,B,L" },
  },
  "levels.upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "levels.upperLabel.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "levels.upperLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "levels.upperLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "levels.upperLabel.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "levels.upperLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "levels.upperLabel.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "levels.upperLabel.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "levels.upperLabel.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "levels.upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "levels.itemStyle.decal.symbolKeepAspect": { desc: "<p>是否保持图案的长宽比。</p>\n" },
  "levels.itemStyle.decal.color": { desc: "<p>贴花图案的颜色，建议使用半透明色，这样能叠加在系列本身的颜色上。</p>\n" },
  "levels.itemStyle.decal.backgroundColor": { desc: "<p>贴花的背景色，将会覆盖在系列本身颜色之上，贴花图案之下。</p>\n" },
  ...
  "levels.emphasis": { desc: "<p>高亮状态配置。</p>\n" },
  ...
  "levels.emphasis.labelLine.show": { desc: "\n\n<p>是否显示视觉引导线。</p>\n", uiControl: { type: "boolean" } },
  ...
  "levels.emphasis.upperLabel.show": { desc: "\n\n<p>是否显示标签。</p>\n", uiControl: { type: "boolean", default: "false" } },
  ...
  "levels.emphasis.upperLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "levels.emphasis.upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "levels.emphasis.upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "levels.blur.labelLine.show": { desc: "\n\n<p>是否显示视觉引导线。</p>\n", uiControl: { type: "boolean" } },
  ...
  "levels.blur.upperLabel.show": { desc: "\n\n<p>是否显示标签。</p>\n", uiControl: { type: "boolean", default: "false" } },
  ...
  "levels.blur.upperLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "levels.blur.upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "levels.blur.upperLabel.shadowBlur": {
    desc: "\n\n<p>文字块的背景阴影长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  "levels.blur.upperLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "levels.blur.upperLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "levels.blur.upperLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "levels.blur.upperLabel.textShadowBlur": {
    desc: "\n\n<p>文字本身的阴影长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  "levels.blur.upperLabel.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "levels.blur.upperLabel.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "levels.blur.upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "levels.select.labelLine.show": { desc: "\n\n<p>是否显示视觉引导线。</p>\n", uiControl: { type: "boolean" } },
  ...
  "levels.select.upperLabel.show": { desc: "\n\n<p>是否显示标签。</p>\n", uiControl: { type: "boolean", default: "false" } },
  ...
  "levels.select.upperLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "levels.select.upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "levels.select.upperLabel.shadowBlur": {
    desc: "\n\n<p>文字块的背景阴影长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  "levels.select.upperLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "levels.select.upperLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "levels.select.upperLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  ...
  "levels.select.upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "data.id": { desc: "<p>每个树节点的id。id 不是必须设置的。但是如果想使用 API 来改变某个节点，需要用 id 来定位。</p>\n" },
  "data.name": { desc: "<p>显示在矩形中的描述文字。</p>\n" },
  ...
  "data.upperLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "data.upperLabel.borderRadius": { desc: "\n\n<p>文字块的圆角。</p>\n", uiControl: { type: "vector", min: "0", dims: "LT,RT, RB, LB" } },
  "data.upperLabel.padding": {
    desc: '\n\n<p>文字块的内边距。例如：</p>\n<ul>\n<li><code class="codespan">padding: [3, 4, 5, 6]</code>：表示 <code class="codespan">[上, 右, 下, 左]</code> 的边距。</li>\n<li><code class="codespan">padding: 4</code>：表示 <code class="codespan">padding: [4, 4, 4, 4]</code>。</li>\n<li><code class="codespan">padding: [3, 4]</code>：表示 <code class="codespan">padding: [3, 4, 3, 4]</code>。</li>\n</ul>\n<p>注意，文字块的 <code class="codespan">width</code> 和 <code class="codespan">height</code> 指定的是内容高宽，不包含 <code class="codespan">padding</code>。</p>\n',
    uiControl: { type: "vector", min: "0", dims: "T,R,B,L" },
  },
  "data.upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "data.upperLabel.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "data.upperLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "data.upperLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "data.upperLabel.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "data.upperLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "data.upperLabel.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "data.upperLabel.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "data.upperLabel.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "data.upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "data.itemStyle.borderColor": { desc: "\n\n<p>矩形边框 和 矩形间隔（gap）的颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "data.emphasis.upperLabel.show": { desc: "\n\n<p>是否显示标签。</p>\n", uiControl: { type: "boolean", default: "false" } },
  ...
  "data.emphasis.upperLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "data.emphasis.upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "data.emphasis.upperLabel.shadowBlur": {
    desc: "\n\n<p>文字块的背景阴影长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  "data.emphasis.upperLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "data.emphasis.upperLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "data.emphasis.upperLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  ...
  "data.emphasis.upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "data.blur.labelLine.lineStyle.width": { desc: "\n\n<p>线宽。</p>\n", uiControl: { type: "number", value: "1", min: "0", step: "0.5" } },
  ...
  "data.blur.upperLabel.show": { desc: "\n\n<p>是否显示标签。</p>\n", uiControl: { type: "boolean", default: "false" } },
  ...
  "data.blur.upperLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "data.blur.upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "data.blur.upperLabel.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "data.blur.upperLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "data.blur.upperLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "data.blur.upperLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "data.blur.upperLabel.textShadowBlur": {
    desc: "\n\n<p>文字本身的阴影长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  "data.blur.upperLabel.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "data.blur.upperLabel.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "data.blur.upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "data.select.upperLabel.show": { desc: "\n\n<p>是否显示标签。</p>\n", uiControl: { type: "boolean", default: "false" } },
  ...
  "data.select.upperLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "data.select.upperLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "data.select.upperLabel.shadowBlur": {
    desc: "\n\n<p>文字块的背景阴影长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  "data.select.upperLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "data.select.upperLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "data.select.upperLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "data.select.upperLabel.textShadowBlur": {
    desc: "\n\n<p>文字本身的阴影长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  "data.select.upperLabel.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "data.select.upperLabel.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "data.select.upperLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "data.children": { desc: '<p>子节点，递归定义，格式同 <a href="#series-treemap.data">series-treemap.data</a>。</p>\n' },
  ...
  animationDuration: {
    ...
    uiControl: { type: "number", min: "0", default: "1500", step: "20", clean: "true" },
  },
  animationEasing: {
