window.__EC_DOC_option_angleAxis = {
  ...
  startAngle: {
    desc: '\n\n<p>起始刻度的角度，默认为 90 度，即圆心的正上方。0 度为圆心的正右方。</p>\n<p>如下示例是 startAngle 为 45 的效果：</p>\n<iframe  data-src="../../examples/zh/view.html?c=doc-example/polar-start-angle&edit=1&reset=1" width="400" height="400"></iframe>\n\n',
    uiControl: { type: "angle", default: "90", min: "-360", max: "360", step: "1" },
  },
  endAngle: {
    desc: '\n\n<p>结束刻度的角度，默认为 <code class="codespan">null</code>，表示一整个圆。</p>\n<blockquote>\n<p>从 <code class="codespan">v5.5.0</code> 开始支持</p>\n</blockquote>\n<p>如下示例是 endAngle 为 -180 的效果：</p>\n<iframe  data-src="../../examples/zh/view.html?c=doc-example/polar-end-angle&edit=1&reset=1" width="400" height="400"></iframe>\n\n',
    uiControl: { type: "angle", default: "null", min: "-360", max: "360", step: "1" },
  },
  clockwise: {
    desc: '\n\n<p>刻度增长是否按顺时针，默认顺时针。</p>\n<p>如下示例是 clockwise 为 <code class="codespan">false</code> （逆时针）的效果：</p>\n<iframe  data-src="../../examples/zh/view.html?c=doc-example/polar-anticlockwise&edit=1&reset=1" width="400" height="400"></iframe>\n\n\n\n',
