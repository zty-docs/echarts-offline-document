window.__EC_DOC_option_legend = {
  type: {
    ...
    uiControl: { type: "enum", options: "plain,scroll" },
  },
  ...
  orient: {
    ...
    uiControl: { type: "enum", options: "vertical,horizontal", default: "horizontal" },
  },
  align: {
    ...
    uiControl: { type: "enum", options: "auto,left,right", default: "auto" },
  },
  padding: {
  ...
  itemWidth: { desc: "\n\n<p>图例标记的图形宽度。</p>\n", uiControl: { type: "number", default: "25", min: "0", step: "0.5" } },
  itemHeight: { desc: "\n\n<p>图例标记的图形高度。</p>\n", uiControl: { type: "number", default: "14", min: "0", step: "0.5" } },
  itemStyle: {
  ...
  "itemStyle.borderWidth": {
    desc: '\n\n<p>当其值为 <code class="codespan">&quot;auto&quot;</code> 时，如果系列有 <code class="codespan">borderWidth</code> 取 2，如果系列没有 <code class="codespan">borderWidth</code> 则取 0。当其值为 <code class="codespan">&quot;inherit&quot;</code> 时，始终取系列的 <code class="codespan">borderWidth</code>。</p>\n',
    uiControl: { type: "number", value: "auto", min: "0", step: "0.5" },
  },
  ...
  "itemStyle.shadowBlur": {
    ...
    uiControl: { type: "number", default: "0", min: "0", step: "0.5" },
  },
  ...
  "itemStyle.opacity": {
    ...
    uiControl: { type: "number", default: "inherit", min: "0", max: "1", step: "0.01" },
  },
  "itemStyle.decal": {
  ...
  "lineStyle.shadowBlur": {
    desc: '\n\n<p>图形阴影的模糊大小。该属性配合 <code class="codespan">shadowColor</code>,<code class="codespan">shadowOffsetX</code>, <code class="codespan">shadowOffsetY</code> 一起设置图形的阴影效果。</p>\n<p>示例：</p>\n<pre><code class="lang-ts">{\n    shadowColor: &#39;rgba(0, 0, 0, 0.5)&#39;,\n    shadowBlur: 10\n}\n</code></pre>\n',
    uiControl: { type: "number", default: "inherit", min: "0", step: "0.5" },
  },
  ...
  "lineStyle.inactiveColor": { desc: "<p>图例关闭时的线条描边颜色。</p>\n" },
  "lineStyle.inactiveWidth": { desc: "<p>图例关闭时的线条宽度。</p>\n" },
  symbolRotate: {
  ...
  selectedMode: {
    ...
    uiControl: { type: "boolean", options: "true,false,single,multiple" },
  },
  inactiveColor: { desc: "<p>图例关闭时的颜色。</p>\n" },
  inactiveBorderColor: { desc: "<p>图例关闭时的描边颜色。</p>\n" },
  inactiveBorderWidth: {
    desc: '<p>图例关闭时的描边粗细。</p>\n<p>如果为 <code class="codespan">&#39;auto&#39;</code> 表示：如果系列存在描边，则取 2，如果系列不存在描边，则取 0。</p>\n<p>如果为 <code class="codespan">&#39;inherit&#39;</code> 表示：始终取系列的描边粗细。</p>\n',
  },
  selected: {
    desc: "<p>图例选中状态表。</p>\n<p>示例：</p>\n<pre><code>selected: {\n    // 选中&#39;系列1&#39;\n    &#39;系列1&#39;: true,\n    // 不选中&#39;系列2&#39;\n    &#39;系列2&#39;: false\n}\n</code></pre>",
  },
  textStyle: { desc: "<p>图例的公用文本样式。</p>\n" },
  ...
  "textStyle.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  "textStyle.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "textStyle.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "textStyle.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "textStyle.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "textStyle.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "textStyle.width": {
    desc: "\n\n<p>文本显示宽度。</p>\n",
  ...
  "textStyle.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  "textStyle.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "textStyle.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "textStyle.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "textStyle.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "textStyle.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "textStyle.overflow": {
  ...
  "textStyle.rich.<style_name>.borderColor": { desc: "\n\n<p>文字块边框颜色。</p>\n", uiControl: { type: "color", default: "#fff" } },
  ...
  "textStyle.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  "data.lineStyle.inactiveColor": { desc: "<p>图例关闭时的线条描边颜色。</p>\n" },
  "data.lineStyle.inactiveWidth": { desc: "<p>图例关闭时的线条宽度。</p>\n" },
  "data.symbolRotate": {
    desc: '<p>图形旋转角度，类型为 <code class="codespan">number | &#39;inherit&#39;</code>。如果为 <code class="codespan">&#39;inherit&#39;</code>，表示取系列的 <code class="codespan">symbolRotate</code>。</p>\n',
  },
  "data.inactiveColor": { desc: "<p>图例关闭时的颜色。</p>\n" },
  "data.inactiveBorderColor": { desc: "<p>图例关闭时的描边颜色。</p>\n" },
  "data.inactiveBorderWidth": {
    desc: '<p>图例关闭时的描边粗细。</p>\n<p>如果为 <code class="codespan">&#39;auto&#39;</code> 表示：如果系列存在描边，则取 2，如果系列不存在描边，则取 0。</p>\n<p>如果为 <code class="codespan">&#39;inherit&#39;</code> 表示：始终取系列的描边粗细。</p>\n',
  },
  "data.textStyle": { desc: "<p>图例项的文本样式。</p>\n" },
  ...
  borderWidth: { desc: "\n\n<p>图例的边框线宽。</p>\n", uiControl: { type: "number", default: "1", min: "0", step: "0.5" } },
  borderRadius: {
  ...
  pageIconColor: {
    ...
    uiControl: { type: "color", default: "#2f4554" },
  },
  ...
  pageIconSize: {
    ...
    uiControl: { type: "vector", default: "15,15", dims: "w,h" },
  },
  pageTextStyle: {
    desc: '<p><a href="#legend.type">legend.type</a> 为 <code class="codespan">&#39;scroll&#39;</code> 时有效。</p>\n<p>图例页信息的文字样式。</p>\n',
  },
  ...
  "pageTextStyle.textBorderColor": { desc: "\n\n<p>文字本身的描边颜色。</p>\n", uiControl: { type: "color" } },
  "pageTextStyle.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "pageTextStyle.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "pageTextStyle.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "pageTextStyle.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "pageTextStyle.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  animationDurationUpdate: {
    desc: "\n\n<p>图例翻页时的动画时长。</p>\n",
    uiControl: { type: "number", min: "0", default: "800", step: "20" },
  },
  "emphasis.selectorLabel": { desc: '<blockquote>\n<p>从 <code class="codespan">v4.4.0</code> 开始支持</p>\n</blockquote>\n' },
  ...
  "emphasis.selectorLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "emphasis.selectorLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "emphasis.selectorLabel.shadowBlur": {
    desc: "\n\n<p>文字块的背景阴影长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  "emphasis.selectorLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "emphasis.selectorLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "emphasis.selectorLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "emphasis.selectorLabel.textShadowBlur": {
    desc: "\n\n<p>文字本身的阴影长度。</p>\n",
    uiControl: { type: "number", min: "0", step: "0.5" },
  },
  "emphasis.selectorLabel.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "emphasis.selectorLabel.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "emphasis.selectorLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  selector: {
    desc: '<blockquote>\n<p>从 <code class="codespan">v4.4.0</code> 开始支持</p>\n</blockquote>\n<p>图例组件中的选择器按钮，目前包括“全选”和“反选”两种功能。默认不显示，用户可手动开启，也可以手动配置每个按钮的标题。</p>\n<p>使用方式如下：</p>\n<pre><code class="lang-ts">selector: [\n    {\n        // 全选\n        type: &#39;all&#39;,\n        // 可以是任意你喜欢的标题\n        title: &#39;全选&#39;\n    },\n    {\n        // 反选\n        type: &#39;inverse&#39;,\n        // 可以是任意你喜欢的标题\n        title: &#39;反选&#39;\n    }\n]\n\n// 或\nselector: true\n\n// 或\nselector: [&#39;all&#39;, &#39;inverse&#39;]\n</code></pre>\n',
  },
  selectorLabel: {
  ...
  "selectorLabel.borderWidth": { desc: "\n\n<p>文字块边框宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "selectorLabel.borderRadius": { desc: "\n\n<p>文字块的圆角。</p>\n", uiControl: { type: "vector", min: "0", dims: "LT,RT, RB, LB" } },
  "selectorLabel.padding": {
    desc: '\n\n<p>文字块的内边距。例如：</p>\n<ul>\n<li><code class="codespan">padding: [3, 4, 5, 6]</code>：表示 <code class="codespan">[上, 右, 下, 左]</code> 的边距。</li>\n<li><code class="codespan">padding: 4</code>：表示 <code class="codespan">padding: [4, 4, 4, 4]</code>。</li>\n<li><code class="codespan">padding: [3, 4]</code>：表示 <code class="codespan">padding: [3, 4, 3, 4]</code>。</li>\n</ul>\n<p>注意，文字块的 <code class="codespan">width</code> 和 <code class="codespan">height</code> 指定的是内容高宽，不包含 <code class="codespan">padding</code>。</p>\n',
    uiControl: { type: "vector", min: "0", dims: "T,R,B,L" },
  },
  "selectorLabel.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  "selectorLabel.shadowBlur": { desc: "\n\n<p>文字块的背景阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "selectorLabel.shadowOffsetX": { desc: "\n\n<p>文字块的背景阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "selectorLabel.shadowOffsetY": { desc: "\n\n<p>文字块的背景阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "selectorLabel.width": {
    desc: "\n\n<p>文本显示宽度。</p>\n",
    uiControl: { type: "number", default: "100", min: "1", max: "500", step: "1" },
  },
  ...
  "selectorLabel.textBorderWidth": { desc: "\n\n<p>文字本身的描边宽度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  ...
  "selectorLabel.textShadowColor": { desc: "\n\n<p>文字本身的阴影颜色。</p>\n", uiControl: { type: "color", default: "#000" } },
  "selectorLabel.textShadowBlur": { desc: "\n\n<p>文字本身的阴影长度。</p>\n", uiControl: { type: "number", min: "0", step: "0.5" } },
  "selectorLabel.textShadowOffsetX": { desc: "\n\n<p>文字本身的阴影 X 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  "selectorLabel.textShadowOffsetY": { desc: "\n\n<p>文字本身的阴影 Y 偏移。</p>\n", uiControl: { type: "number", step: "0.5" } },
  ...
  "selectorLabel.rich.<style_name>.shadowColor": { desc: "\n\n<p>文字块的背景阴影颜色。</p>\n", uiControl: { type: "color" } },
  ...
  selectorPosition: {
    ...
    uiControl: { type: "enum", options: "auto,start,end" },
  },
  selectorItemGap: {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v4.4.0</code> 开始支持</p>\n</blockquote>\n<p>选择器按钮之间的间隔。</p>\n',
    uiControl: { type: "number", min: "0", default: "7", step: "0.5" },
  },
  selectorButtonGap: {
    desc: '\n\n\n\n<blockquote>\n<p>从 <code class="codespan">v4.4.0</code> 开始支持</p>\n</blockquote>\n<p>选择器按钮与图例组件之间的间隔。</p>\n',
