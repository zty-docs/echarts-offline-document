window.__EC_DOC_option_yAxis = {
  ...
  gridIndex: { desc: "<p>y 轴所在的 grid 的索引，默认位于第一个 grid。</p>\n" },
  alignTicks: {
  ...
  position: {
    desc: '\n\n<p>y 轴的位置。</p>\n<p>可选：</p>\n<ul>\n<li><code class="codespan">&#39;left&#39;</code></li>\n<li><code class="codespan">&#39;right&#39;</code></li>\n</ul>\n<p>默认 grid 中的第一个 y 轴在 grid 的左侧（<code class="codespan">&#39;left&#39;</code>），第二个 y 轴视第一个 y 轴的位置放在另一侧。<br>注：若未将 <code class="codespan">yAxis.axisLine.onZero</code> 设为 <code class="codespan">false</code> , 则该项无法生效</p>\n',
  ...
  "axisLabel.verticalAlignMinLabel": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.5.0</code> 开始支持</p>\n</blockquote>\n<p>最小的坐标刻度标签的对齐方式。如果设置为 <code class="codespan">null</code>，则和其他标签一致。参见 <a href="#yAxis.axisLabel.verticalAlign">align</a>。</p>\n<p>可选：</p>\n<ul>\n<li><code class="codespan">&#39;top&#39;</code></li>\n<li><code class="codespan">&#39;middle&#39;</code></li>\n<li><code class="codespan">&#39;bottom&#39;</code></li>\n<li><code class="codespan">null</code> (default)</li>\n</ul>\n',
  },
  "axisLabel.verticalAlignMaxLabel": {
    desc: '<blockquote>\n<p>从 <code class="codespan">v5.5.0</code> 开始支持</p>\n</blockquote>\n<p>最大的坐标刻度标签的对齐方式。如果设置为 <code class="codespan">null</code>，则和其他标签一致。参见 <a href="#yAxis.axisLabel.verticalAlign">align</a>。</p>\n<p>可选：</p>\n<ul>\n<li><code class="codespan">&#39;top&#39;</code></li>\n<li><code class="codespan">&#39;middle&#39;</code></li>\n<li><code class="codespan">&#39;bottom&#39;</code></li>\n<li><code class="codespan">null</code> (default)</li>\n</ul>\n',
  },
