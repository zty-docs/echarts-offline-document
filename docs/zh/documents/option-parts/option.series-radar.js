window.__EC_DOC_option_series_radar = {
  ...
  label: { desc: "<p>图形上的文本标签，可用于说明图形的一些数据信息，比如值，名称等。</p>\n" },
  ...
  "areaStyle.shadowOffsetX": { desc: "\n\n<p>阴影水平方向上的偏移距离。</p>\n", uiControl: { type: "number", default: "0", step: "0.5" } },
  "areaStyle.shadowOffsetY": { desc: "\n\n<p>阴影垂直方向上的偏移距离。</p>\n", uiControl: { type: "number", default: "0", step: "0.5" } },
  "areaStyle.opacity": {
    desc: "\n\n<p>图形透明度。支持从 0 到 1 的数字，为 0 时不绘制该图形。</p>\n",
    uiControl: { type: "number", default: "0.7", min: "0", max: "1", step: "0.01" },
  },
  emphasis: { desc: "<p>高亮状态的配置。</p>\n" },
  "emphasis.disabled": {
  ...
  "data.label": { desc: "<p>单个拐点文本的样式设置。</p>\n" },
  ...
  "data.itemStyle": { desc: "<p>单个拐点标志的样式设置。</p>\n" },
  ...
  "data.lineStyle": { desc: "<p>单项线条样式。</p>\n" },
  ...
  "data.areaStyle": { desc: "<p>单项区域填充样式。</p>\n" },
  ...
  "data.emphasis": { desc: "<p>单个数据项样式的高亮状态。</p>\n" },
